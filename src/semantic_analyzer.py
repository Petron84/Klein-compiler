    ...
    def analyze(self):
        ...
        for f_name, expressionlist in body.items():
            ...
            for expression in expressionlist:
                traverser = Traverser(f_name, self.symbol_table,self.reject)
...
class Traverser():
    def __init__(self, f_name, symbol_table,reject):
        self.f_name = f_name
