def parsetable():
    ...
    rulemap = {
        ...
        "4": "def := function identifier MakeIdentifier ( parmlist ) : type MakeType body MakeExpList MakeDef",
        "5": "parmlist := ε",
        "6": "parmlist := FP",
