...
11 : JEQ 1, 15(0) ; If condition is false, jump to ELSE
12 : LDC 1, 42(0) ; Load integer-literal into R1
13 : ST 1, 1(5) ; Store result into current frame's return slot
14 : LDA 7, 17(0) ; Skip ELSE block
15 : LDC 1, 42(0) ; Load integer-literal into R1
16 : ST 1, 1(5) ; Store result into current frame's return slot
17 : LD 1, 1(5) ; Load main return value into R1
18 : LD 6, 0(5) ; Load main return address
