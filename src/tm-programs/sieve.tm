...
18 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
48 : ST 1, 1(4) ; Store argument 0 in callee param slot
49 : LD 1, 2(5) ; Load parameter 'den' into R1
50 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
51 : ST 1, 2(4) ; Store argument 1 in callee param slot
52 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
65 : ST 1, 1(4) ; Store argument 0 in callee param slot
66 : LD 1, 1(5) ; Load parameter 'a' into R1
67 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
68 : ST 1, 2(4) ; Store argument 1 in callee param slot
69 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
100 : ST 1, 1(4) ; Store argument 0 in callee param slot
101 : LD 1, 2(5) ; Load parameter 'n' into R1
102 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
103 : ST 1, 2(4) ; Store argument 1 in callee param slot
104 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
119 : ST 1, 1(4) ; Store argument 0 in callee param slot
120 : LD 1, 2(5) ; Load parameter 'n' into R1
121 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
122 : ST 1, 2(4) ; Store argument 1 in callee param slot
123 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
129 : LDC 2, 6(0) ; Caller frame size
...
142 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
143 : ST 1, 2(4) ; Store argument 1 in callee param slot
144 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
158 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
159 : ST 1, 1(4) ; Store argument 0 in callee param slot
160 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
166 : LDC 2, 5(0) ; Caller frame size
...
172 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
187 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
188 : ST 1, 2(4) ; Store argument 1 in callee param slot
189 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
213 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
214 : ST 1, 1(4) ; Store argument 0 in callee param slot
215 : LD 1, 2(5) ; Load parameter 'max' into R1
216 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
217 : ST 1, 2(4) ; Store argument 1 in callee param slot
218 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
224 : LDC 2, 5(0) ; Caller frame size
