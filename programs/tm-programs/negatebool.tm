...
14 : LDC  5, 1021(0) ;  Store the memory location of main return value
15 : ST   1, 0(5) ;  Store return value of into DMEM
16 : LDC  5, 1021(0) ;  Store the memory location of main return value
17 : ST   1, 0(5) ;  Store return value of into DMEM
18 : LD   1, 0(5) ;  Load Return Value from DMEM
19 : OUT  1, 0, 0 ;  Output value from register 1.
20 : HALT 0, 0, 0 ;  Terminate program execution.
