...
28 : LDC  3, 0(1) ; Store left operand into temporary register
29 : LD   1, 1(5) ;  Load parameter 'a' into R1
30 : LDC  2, 0(3) ;  Restore left operand
...
52 : LDC  3, 0(1) ; Store left operand into temporary register
53 : LD   1, 1(5) ;  Load parameter 'a' into R1
54 : LDC  3, 0(1) ; Store left operand into temporary register
55 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
56 : LDC  2, 0(3) ;  Restore left operand
...
96 : LDC  3, 0(1) ; Store left operand into temporary register
...
110 : LDC  2, 0(3) ;  Restore left operand
...
150 : LDC  3, 0(1) ; Store left operand into temporary register
...
165 : LDC  2, 0(3) ;  Restore left operand
...
175 : LDC  3, 0(1) ; Store left operand into temporary register
176 : LD   1, 2(5) ;  Load parameter 'y' into R1
177 : LDC  2, 0(3) ;  Restore left operand
178 : DIV  1, 2, 1 ;  R1 = left / right
179 : LDC  3, 0(1) ; Store left operand into temporary register
180 : LD   1, 2(5) ;  Load parameter 'y' into R1
181 : LDC  2, 0(3) ;  Restore left operand
182 : MUL  1, 2, 1 ;  R1 = left * right
183 : LDC  3, 0(1) ; Store left operand into temporary register
184 : LD   1, 1(5) ;  Load parameter 'x' into R1
185 : LDC  2, 0(3) ;  Restore left operand
