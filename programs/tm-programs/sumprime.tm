...
11 : LDA 4, 2(4) ; Recompute callee base from callee size
12 : ST 1, 1(4) ; Store argument 0 in callee
13 : LDC 1, 20(0) ; Load integer-literal into R1
14 : LDA 4, 2(4) ; Recompute callee base from callee size
...
41 : LDA 4, 6(4) ; Recompute callee base from callee size
...
59 : LDA 4, 6(4) ; Recompute callee base from callee size
60 : ST 1, 1(4) ; Store argument 0 in callee
61 : LD 1, 2(5) ; Load parameter 'b' into R1
62 : LDA 4, 6(4) ; Recompute callee base from callee size
...
80 : LDA 4, 6(4) ; Recompute callee base from callee size
81 : ST 1, 1(4) ; Store argument 0 in callee
82 : LD 1, 2(5) ; Load parameter 'b' into R1
83 : LDA 4, 6(4) ; Recompute callee base from callee size
...
121 : LDA 4, 4(4) ; Recompute callee base from callee size
122 : ST 1, 1(4) ; Store argument 0 in callee
123 : LDC 1, 2(0) ; Load integer-literal into R1
124 : LDA 4, 4(4) ; Recompute callee base from callee size
...
139 : LDA 4, 4(4) ; Recompute callee base from callee size
...
153 : LDA 4, 4(4) ; Recompute callee base from callee size
154 : ST 1, 1(4) ; Store argument 0 in callee
155 : LDC 1, 5(0) ; Load integer-literal into R1
156 : LDA 4, 4(4) ; Recompute callee base from callee size
