...
41 : LDA 4, 6(5) ; Compute future callee base using caller_size
...
80 : LDA 4, 6(5) ; Compute future callee base using caller_size
...
121 : LDA 4, 4(5) ; Compute future callee base using caller_size
122 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
123 : LDC 1, 2(0) ; Load integer-literal into R1
124 : LDA 4, 4(5) ; Compute future callee base using caller_size
...
139 : LDA 4, 4(5) ; Compute future callee base using caller_size
...
153 : LDA 4, 4(5) ; Compute future callee base using caller_size
154 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
155 : LDC 1, 5(0) ; Load integer-literal into R1
156 : LDA 4, 4(5) ; Compute future callee base using caller_size
