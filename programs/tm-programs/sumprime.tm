...
7 : OUT 1, 0, 0 ; Built-in print: output R1
8 : LD 6, 0(5) ; Load return address from current frame
9 : LDA 7, 0(6) ; Return to caller
...
14 : LDA 4, 2(5) ; Compute future callee base (caller_size)
...
32 : SUB 1, 2, 1 ; Compute left - right for less-than
33 : JLT 1, 2(7) ; If < 0, jump to true
34 : LDC 1, 0(0) ; false
35 : LDA 7, 1(7) ; skip true assignment
36 : LDC 1, 1(0) ; true
37 : JEQ 1, 40(0) ; If condition false jump to ELSE
38 : LDC 1, 0(0) ; Load integer literal into R1
39 : LDA 7, 93(0) ; Skip ELSE block
40 : LD 1, 1(5) ; Load parameter 'a' into R1
41 : LDA 4, 6(5) ; Compute future callee base (caller_size)
42 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
43 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
51 : JEQ 1, 75(0) ; If condition false jump to ELSE
...
59 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
60 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
61 : LD 1, 2(5) ; Load parameter 'b' into R1
62 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
63 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
64 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
70 : LDC 2, 6(0) ; Callee frame size
...
80 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
81 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
82 : LD 1, 2(5) ; Load parameter 'b' into R1
83 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
84 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
85 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
100 : SUB 1, 2, 1 ; Compute left - right for less-than
101 : JLT 1, 2(7) ; If < 0, jump to true
102 : LDC 1, 0(0) ; false
103 : LDA 7, 1(7) ; skip true assignment
104 : LDC 1, 1(0) ; true
105 : JEQ 1, 108(0) ; If condition false jump to ELSE
...
112 : SUB 1, 2, 1 ; Compute left - right for equality
113 : JEQ 1, 2(7) ; If zero, jump to true
114 : LDC 1, 0(0) ; false
115 : LDA 7, 1(7) ; skip true assignment
116 : LDC 1, 1(0) ; true
117 : JEQ 1, 120(0) ; If condition false jump to ELSE
118 : LDC 1, 1(0) ; Load boolean literal into R1
119 : LDA 7, 172(0) ; Skip ELSE block
120 : LD 1, 1(5) ; Load parameter 'n' into R1
121 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
125 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
126 : LDA 4, 4(5) ; Compute future callee base (caller_size)
127 : LDA 6, 131(0) ; Return address
128 : ST 6, 0(4) ; Store return address in callee frame
...
139 : LDA 4, 4(5) ; Compute future callee base (caller_size)
140 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
141 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
153 : LDA 4, 4(5) ; Compute future callee base (caller_size)
154 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
155 : LDC 1, 5(0) ; Load integer literal into R1
156 : LDA 4, 4(5) ; Compute future callee base (caller_size)
157 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
158 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
187 : SUB 1, 2, 1 ; Compute left - right for equality
188 : JEQ 1, 2(7) ; If zero, jump to true
189 : LDC 1, 0(0) ; false
190 : LDA 7, 1(7) ; skip true assignment
191 : LDC 1, 1(0) ; true
192 : JEQ 1, 195(0) ; If condition false jump to ELSE
