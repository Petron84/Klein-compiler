...
47 : ST   1, 3(5) ;  Store left operand into temporary register
...
53 : ST   1, 3(5) ;  Store left operand into temporary register
...
63 : ST   1, 2(5) ;  Store left operand into temporary register
...
70 : LDC  1, 1(0) ;  true
71 : ST   1, 2(5) ;  Store left operand into temporary register
72 : LD   1, 1(5) ;  Load parameter 'diff' into R1
73 : ST   1, 2(5) ;  Store left operand into temporary register
...
83 : ST   1, 2(5) ;  Store left operand into temporary register
84 : LD   1, 1(5) ;  Load parameter 'diff' into R1
85 : ST   1, 2(5) ;  Store left operand into temporary register
...
98 : ST   1, 2(5) ;  Store left operand into temporary register
...
113 : ST   1, 2(5) ;  Store left operand into temporary register
...
139 : ST   1, 3(5) ;  Store left operand into temporary register
140 : LD   1, 2(5) ;  Load parameter 'right' into R1
141 : ST   1, 3(5) ;  Store left operand into temporary register
