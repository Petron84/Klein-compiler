...
17 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
21 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
25 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
33 : LDA 4, 4(5) ; Compute future callee base (caller_size)
34 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
35 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
42 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
43 : ST 1, 2(5) ; Store result into caller's frame return slot
...
67 : SUB 1, 2, 1 ; Compute left - right for equality
68 : JEQ 1, 2(7) ; If zero, jump to true
69 : LDC 1, 0(0) ; false
70 : LDA 7, 1(7) ; skip true assignment
71 : LDC 1, 1(0) ; true
...
90 : SUB 1, 2, 1 ; Compute left - right for equality
91 : JEQ 1, 2(7) ; If zero, jump to true
92 : LDC 1, 0(0) ; false
93 : LDA 7, 1(7) ; skip true assignment
94 : LDC 1, 1(0) ; true
...
103 : SUB 1, 2, 1 ; Compute left - right for equality
104 : JEQ 1, 2(7) ; If zero, jump to true
105 : LDC 1, 0(0) ; false
106 : LDA 7, 1(7) ; skip true assignment
107 : LDC 1, 1(0) ; true
108 : LD 2, 3(5) ; Restore left operand from depth 0
109 : ADD 1, 2, 1 ; R1 = left OR right
110 : JEQ 1, 113(0) ; If condition false jump to ELSE
...
117 : SUB 1, 2, 1 ; Compute left - right for less-than
118 : JLT 1, 2(7) ; If < 0, jump to true
119 : LDC 1, 0(0) ; false
120 : LDA 7, 1(7) ; skip true assignment
121 : LDC 1, 1(0) ; true
122 : JEQ 1, 125(0) ; If condition false jump to ELSE
...
127 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
128 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
135 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
148 : LDA 4, 6(5) ; Compute future callee base (caller_size)
149 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
150 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
157 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
