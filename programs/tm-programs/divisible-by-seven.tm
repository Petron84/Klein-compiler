...
17 : ST 1, 3(5) ; Stage arg 0 in caller temp (P+2+i)
18 : LD 1, 1(5) ; Load parameter 'n' into R1
19 : ST 1, 3(5) ; Stage arg 0 in caller temp (P+2+i)
20 : LDC 1, 10(0) ; Load integer-literal into R1
21 : ST 1, 4(5) ; Stage arg 1 in caller temp (P+2+i)
22 : LDA 4, 6(5) ; Callee base for arg copy
23 : LD 1, 3(5) ; Load staged arg 0 from caller temp
24 : ST 1, 1(4) ; Copy arg 0 into callee param slot 1
25 : LD 1, 4(5) ; Load staged arg 1 from caller temp
...
34 : ST 1, 4(5) ; Stage arg 1 in caller temp (P+2+i)
35 : LDA 4, 6(5) ; Callee base for arg copy
36 : LD 1, 3(5) ; Load staged arg 0 from caller temp
37 : ST 1, 1(4) ; Copy arg 0 into callee param slot 1
38 : LD 1, 4(5) ; Load staged arg 1 from caller temp
...
153 : ST 1, 4(5) ; Stage arg 0 in caller temp (P+2+i)
