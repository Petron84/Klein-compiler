...
11 : LDA 5, 3(5) ;  Advance DMEM pointer to callee frame 'divisibleByParts'
...
16 : ST 1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='/', children=[Tree Node('IDENTIFIER', value='n',line=2), Tree Node('INTEGER-LITERAL', value='10',line=2)],line=2) into callee frame
17 : LDA 5, 3(5) ;  Advance DMEM pointer to callee frame 'MOD'
18 : LD   1, 1(5) ;  Load parameter 'n' into R1
19 : ST 1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='n',line=2) into callee frame
20 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
21 : ST 1, 2(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='10',line=2) into callee frame
22 : LDA 6, 2(7) ;  Compute return address
23 : ST 6, 0(5) ;  Store return address in callee frame
24 : LDA 7, 37(0) ;  Call MOD
25 : LD 1, 3(5) ;  Load callee return value into R1
26 : LDA 5, -3(5) ;  Restore DMEM pointer to caller frame
27 : ST 1, 2(5) ;  Store argument Tree Node('FUNCTION-CALL', children=[Tree Node('IDENTIFIER', value='MOD',line=2), Tree Node('ARGUMENT-LIST', children=[Tree Node('IDENTIFIER', value='n',line=2), Tree Node('INTEGER-LITERAL', value='10',line=2)],line=2)],line=2) into callee frame
28 : LDA 6, 2(7) ;  Compute return address
29 : ST 6, 0(5) ;  Store return address in callee frame
30 : LDA 7, 115(0) ;  Call divisibleByParts
31 : LD 1, 3(5) ;  Load callee return value into R1
32 : LDA 5, -3(5) ;  Restore DMEM pointer to caller frame
...
104 : LDA 5, 3(5) ;  Advance DMEM pointer to callee frame 'main'
105 : LD   1, 1(5) ;  Load parameter 'diff' into R1
106 : ST 1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='diff',line=14) into callee frame
107 : LDA 6, 2(7) ;  Compute return address
108 : ST 6, 0(5) ;  Store return address in callee frame
109 : LDA 7, 11(0) ;  Call main
110 : LD 1, 2(5) ;  Load callee return value into R1
111 : LDA 5, -3(5) ;  Restore DMEM pointer to caller frame
112 : ST   1, 2(5) ;  Store function result into stack frame
113 : LD   6, 0(5) ;  Load return address
114 : LDA  7, 0(6) ;  Return to caller
115 : LDA 5, 4(5) ;  Advance DMEM pointer to callee frame 'divisibleByDifference'
116 : LD   1, 1(5) ;  Load parameter 'left' into R1
117 : ADD  2, 1, 0 ;  Move left operand from R1 to R2
118 : LD   1, 2(5) ;  Load parameter 'right' into R1
...
123 : ST 1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='-', children=[Tree Node('IDENTIFIER', value='left',line=5), Tree Node('BINARY-EXPRESSION', value='*', children=[Tree Node('IDENTIFIER', value='right',line=5), Tree Node('INTEGER-LITERAL', value='2',line=5)],line=5)],line=5) into callee frame
124 : LDA 6, 2(7) ;  Compute return address
125 : ST 6, 0(5) ;  Store return address in callee frame
126 : LDA 7, 50(0) ;  Call divisibleByDifference
127 : LD 1, 2(5) ;  Load callee return value into R1
128 : LDA 5, -4(5) ;  Restore DMEM pointer to caller frame
