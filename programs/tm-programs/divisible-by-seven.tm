...
30 : LDC 2, 3(0) ; Load caller frame size
...
34 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
40 : LDC 2, 3(0) ; Load caller frame size
41 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
127 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
133 : LDC 2, 3(0) ; Load caller frame size
134 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
147 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
148 : ST 1, 1(4) ; Store argument 0 into callee frame
149 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
155 : LDC 2, 4(0) ; Load caller frame size
156 : SUB 5, 5, 2 ; Restore pointer (pop callee)
