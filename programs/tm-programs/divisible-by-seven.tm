...
47 : LDC  3, 0(1) ; Store left operand into temporary register
...
53 : LDC  3, 0(1) ; Store left operand into temporary register
54 : LD   1, 2(5) ;  Load parameter 'n' into R1
55 : LDC  2, 0(3) ;  Restore left operand
56 : MUL  1, 2, 1 ;  R1 = left * right
57 : LDC  2, 0(3) ;  Restore left operand
...
63 : LDC  3, 0(1) ; Store left operand into temporary register
64 : LDC  1, 7(0) ;  Load boolean-literal value into register 1
65 : LDC  2, 0(3) ;  Restore left operand
...
83 : LDC  3, 0(1) ; Store left operand into temporary register
...
101 : LDC  2, 0(3) ;  Restore left operand
