...
17 : ST 1, 1(4) ; Store argument 0 in callee frame
18 : LD 1, 2(5) ; Load parameter 'n' into R1
19 : LDA 4, 6(5) ; Compute callee base
20 : ST 1, 1(4) ; Store argument 0 in callee frame
21 : LDC 1, 10(0) ; Load integer-literal into R1
22 : LDA 4, 6(5) ; Compute callee base
...
26 : ST 6, 0(4) ; Store return address into callee frame
27 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
28 : LDA 7, 46(0) ; Call MOD
29 : LD 1, 3(5) ; Load callee result into R1
30 : LDC 2, 6(0) ; Caller frame size
31 : SUB 5, 5, 2 ; Pop back to caller
32 : LDA 4, 6(5) ; Compute callee base
...
42 : ST 1, 2(5) ; Store result into caller’s return slot
...
124 : LDA 4, 4(5) ; Compute callee base
