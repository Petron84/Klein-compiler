...
89 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
97 : LDA 4, 5(5) ; Compute future callee base (caller_size)
98 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
104 : LDA 4, 5(5) ; Compute future callee base (caller_size)
105 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
106 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
131 : JEQ 1, 147(0) ; If condition false jump to ELSE
...
136 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
148 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
156 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
157 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
164 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
172 : SUB 1, 2, 1 ; Compute left - right for equality
173 : JEQ 1, 2(7) ; If zero, jump to true
174 : LDC 1, 0(0) ; false
175 : LDA 7, 1(7) ; skip true assignment
176 : LDC 1, 1(0) ; true
177 : JEQ 1, 180(0) ; If condition false jump to ELSE
...
182 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
183 : LD 1, 2(5) ; Load parameter 'current' into R1
184 : LDA 4, 5(5) ; Compute future callee base (caller_size)
185 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
186 : LDA 4, 5(5) ; Compute future callee base (caller_size)
187 : LDA 6, 191(0) ; Return address
188 : ST 6, 0(4) ; Store return address in callee frame
...
193 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
