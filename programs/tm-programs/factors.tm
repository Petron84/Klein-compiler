...
10 : ST   1, 0(5) ;  Store argument Tree Node('IDENTIFIER', value='n',line=4)
11 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
12 : ST   1, 1(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='1',line=4)
13 : LDC  5, 4(0) ;  Set DMEM pointer to callee frame 'loopToN'
14 : LDA  6, 2(7) ;  Compute return address
15 : ST   6, 0(5) ;  Store return address in frame
16 : LDA  7, -1(0) ;  Call loopToN
