...
16 : SUB 1, 0, 1 ;  Negate value in R1
17 : SUB 1, 0, 1 ;  Negate value in R1
18 : ST  1, 2(5) ;  Store result into current frame's return slot
19 : LD  1, 2(5) ;  Load return value into R1
20 : LD  6, 0(5) ;  Load return address for main function into R6
