...
12 : LDC 5, 1(0) ; Reset R5 to main frame base (DMEM[N+1])
13 : LD 1, 1(5) ; Load main return value into R1
14 : LD 6, 0(5) ; Load root return address from main frame
15 : LDA 7, 0(6) ; Return from main to runtime epilogue
