...
16 : LDC   3, 1022(0) ;  Load offset for parameter x into register 3
17 : LD  1, 0(3) ;  Load parameter x value into register 1
...
21 : LDC   3, 1021(0) ;  Load offset for parameter y into register 3
22 : LD  1, 0(3) ;  Load parameter y value into register 1
23 : LD   2, 0(5) ;  Load left expression value from memory into register 2
24 : ADD  5, 5, 4 ;  Increment memory offset
25 : MUL  1, 2, 1 ;  Multiply left and right expression values
