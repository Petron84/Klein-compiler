...
38 : LDA 4, 4(5) ; Compute future callee base (caller_size)
39 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
58 : SUB 1, 2, 1 ; Compute left - right for less-than
59 : JLT 1, 2(7) ; If < 0, jump to true
60 : LDC 1, 0(0) ; false
61 : LDA 7, 1(7) ; skip true assignment
62 : LDC 1, 1(0) ; true
...
67 : ST 1, 1(5) ; Store binary result into return slot
