...
15 : LDA 4, 4(4) ; Recompute callee base from caller size
...
23 : LDA 4, 4(4) ; Recompute callee base from callee size
...
44 : LDA 4, 4(4) ; Recompute callee base from callee size
45 : ST 1, 2(4) ; Store argument 1 in callee
46 : LDC 1, 0(0) ; Load integer-literal into R1
47 : LDA 4, 4(4) ; Recompute callee base from callee size
...
73 : LDA 4, 6(4) ; Recompute callee base from callee size
74 : ST 1, 1(4) ; Store argument 0 in callee
75 : LDC 1, 2(0) ; Load integer-literal into R1
76 : LDA 4, 6(4) ; Recompute callee base from callee size
...
100 : LDA 4, 6(4) ; Recompute callee base from callee size
...
107 : LDA 4, 6(4) ; Recompute callee base from callee size
...
114 : LDA 4, 6(4) ; Recompute callee base from callee size
...
130 : LDA 4, 6(4) ; Recompute callee base from callee size
...
137 : LDA 4, 6(4) ; Recompute callee base from callee size
138 : ST 1, 2(4) ; Store argument 1 in callee
139 : LD 1, 3(5) ; Load parameter 'accum' into R1
140 : LDA 4, 6(4) ; Recompute callee base from callee size
