...
14 : LDA  4, 4(5) ;  Update DMEM pointer
...
23 : ST 1, 1(5) ;  Store argument 0 into callee frame
24 : LD   1, 2(5) ;  Load parameter 'n' into R1
25 : LDA  4, 4(5) ; Restore Callee frame base
26 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
72 : LDA  4, 5(5) ; Restore Callee frame base
73 : ST 1, 1(5) ;  Store argument 0 into callee frame
74 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
75 : LDA  4, 5(5) ; Restore Callee frame base
76 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
100 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
107 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
114 : ST 1, 3(5) ;  Store argument 2 into callee frame
...
140 : ST 1, 3(5) ;  Store argument 2 into callee frame
