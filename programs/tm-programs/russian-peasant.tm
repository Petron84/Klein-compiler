...
41 : LDA 4, 7(5) ; Recompute callee base from callee size
42 : ST 1, 1(4) ; Store argument 0 in callee
43 : LD 1, 2(5) ; Load parameter 'n' into R1
44 : LDA 4, 7(5) ; Recompute callee base from callee size
45 : ST 1, 2(4) ; Store argument 1 in callee
46 : LDC 1, 0(0) ; Load integer-literal into R1
47 : LDA 4, 7(5) ; Recompute callee base from callee size
...
76 : LDA 4, 7(5) ; Recompute callee base from callee size
...
107 : LDA 4, 7(5) ; Recompute callee base from callee size
...
114 : LDA 4, 7(5) ; Recompute callee base from callee size
...
137 : LDA 4, 7(5) ; Recompute callee base from callee size
138 : ST 1, 2(4) ; Store argument 1 in callee
139 : LD 1, 3(5) ; Load parameter 'accum' into R1
140 : LDA 4, 7(5) ; Recompute callee base from callee size
