...
16 : LDA 4, 7(5) ; Recompute callee base from callee size
17 : ST 1, 2(4) ; Store argument 1 in callee
18 : LDC 1, 0(0) ; Load integer-literal into R1
19 : LDA 4, 7(5) ; Recompute callee base from callee size
...
108 : LDA 4, 5(5) ; Recompute callee base from callee size
...
124 : LDA 4, 7(5) ; Recompute callee base from callee size
...
129 : LDA 4, 7(5) ; Recompute callee base from callee size
130 : ST 1, 1(4) ; Store argument 0 in callee
131 : LDC 1, 10(0) ; Load integer-literal into R1
132 : LDA 4, 7(5) ; Recompute callee base from callee size
...
144 : LDA 4, 7(5) ; Recompute callee base from callee size
