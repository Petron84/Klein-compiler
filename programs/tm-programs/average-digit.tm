...
33 : LDC  3, 1(0) ;  Store left operand into temporary register
34 : LD   1, 1(5) ;  Load parameter 'm' into R1
35 : LDC  3, 1(0) ;  Store left operand into temporary register
36 : LD   1, 2(5) ;  Load parameter 'n' into R1
37 : LDC  2, 3(0) ;  Restore left operand
...
43 : LDC  2, 3(0) ;  Restore left operand
...
100 : LDC  2, 3(0) ;  Restore left operand
...
128 : LDC  3, 1(0) ;  Store left operand into temporary register
...
148 : LDC  3, 1(0) ;  Store left operand into temporary register
149 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
150 : LDC  2, 3(0) ;  Restore left operand
