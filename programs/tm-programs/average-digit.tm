...
19 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
23 : ST 6, 0(4) ; Store return address in callee frame
...
75 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
90 : SUB 1, 2, 1 ; Compute left - right for less-than
91 : JLT 1, 2(7) ; If < 0, jump to true
92 : LDC 1, 0(0) ; false
93 : LDA 7, 1(7) ; skip true assignment
94 : LDC 1, 1(0) ; true
95 : JEQ 1, 119(0) ; If condition false jump to ELSE
...
109 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
...
124 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
134 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
144 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
151 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
152 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
153 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
