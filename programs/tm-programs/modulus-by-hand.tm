...
41 : LDC 5, 3(0) ; Reset R5 to main frame base (DMEM[N+1])
42 : LD 1, 3(5) ; Load main return value into R1
43 : LD 6, 0(5) ; Load root return address from main frame
44 : LDA 7, 0(6) ; Return from main to runtime epilogue
