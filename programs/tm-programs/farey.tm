...
68 : LDC  1, 1(0) ;  true
69 : ST   1, 3(5) ;  Store left operand into temporary register
70 : LD   1, 1(5) ;  Load parameter 'x' into R1
71 : ST   1, 3(5) ;  Store left operand into temporary register
...
87 : ST   1, 5(5) ;  Store left operand into temporary register
...
94 : ST   1, 5(5) ;  Store left operand into temporary register
...
112 : ST   1, 5(5) ;  Store left operand into temporary register
113 : LD   1, 4(5) ;  Load parameter 'yd' into R1
114 : LD   2, 5(5) ; Restore left operand
115 : MUL  1, 2, 1 ;  R1 = left * right
116 : ST   1, 5(5) ;  Store left operand into temporary register
117 : LD   1, 3(5) ;  Load parameter 'y' into R1
118 : ST   1, 5(5) ;  Store left operand into temporary register
...
145 : ST   1, 9(5) ;  Store left operand into temporary register
...
164 : ST   1, 9(5) ;  Store left operand into temporary register
...
176 : ST   1, 9(5) ;  Store left operand into temporary register
...
188 : ST   1, 9(5) ;  Store left operand into temporary register
...
208 : ST   1, 9(5) ;  Store left operand into temporary register
...
215 : ST   1, 9(5) ;  Store left operand into temporary register
...
231 : ST   1, 9(5) ;  Store left operand into temporary register
...
241 : ST   1, 9(5) ;  Store left operand into temporary register
...
247 : ST   1, 9(5) ;  Store left operand into temporary register
...
257 : ST   1, 9(5) ;  Store left operand into temporary register
...
263 : ST   1, 9(5) ;  Store left operand into temporary register
...
273 : ST   1, 9(5) ;  Store left operand into temporary register
...
279 : ST   1, 9(5) ;  Store left operand into temporary register
...
291 : ST   1, 9(5) ;  Store left operand into temporary register
...
298 : ST   1, 9(5) ;  Store left operand into temporary register
...
326 : ST   1, 9(5) ;  Store left operand into temporary register
...
333 : ST   1, 9(5) ;  Store left operand into temporary register
...
373 : ST   1, 9(5) ;  Store left operand into temporary register
...
380 : ST   1, 9(5) ;  Store left operand into temporary register
