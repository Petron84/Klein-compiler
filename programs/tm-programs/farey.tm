...
92 : LDA 4, 7(5) ; Compute future callee base using caller_size
...
99 : LDA 4, 7(5) ; Compute future callee base using caller_size
...
133 : LDA 4, 11(5) ; Compute future callee base using caller_size
134 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
135 : LD 1, 4(5) ; Load parameter 'N' into R1
136 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
148 : LDA 4, 11(5) ; Compute future callee base using caller_size
149 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
150 : LD 1, 4(5) ; Load parameter 'N' into R1
151 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
206 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
213 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
220 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
286 : LDA 4, 11(5) ; Compute future callee base using caller_size
287 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
288 : LD 1, 3(5) ; Load parameter 'xDen' into R1
289 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
296 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
331 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
346 : LDA 4, 11(5) ; Compute future callee base (caller_size)
...
378 : LDA 4, 11(5) ; Compute future callee base using caller_size
...
385 : LDA 4, 11(5) ; Compute future callee base using caller_size
386 : ST 1, 8(4) ; Store argument 7 into callee's param slot (future frame)
387 : LDA 4, 11(5) ; Compute future callee base (caller_size)
...
402 : LDA 4, 7(5) ; Compute future callee base using caller_size
...
420 : LDA 4, 7(5) ; Compute future callee base using caller_size
421 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
422 : LD 1, 1(5) ; Load parameter 'N' into R1
423 : LDA 4, 7(5) ; Compute future callee base using caller_size
...
533 : LDA 4, 5(5) ; Compute future callee base using caller_size
...
577 : LDA 4, 5(5) ; Compute future callee base using caller_size
...
727 : LDA 4, 5(5) ; Compute future callee base using caller_size
