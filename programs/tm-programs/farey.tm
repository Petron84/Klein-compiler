...
7 : LD   2, 3(0) ;  Load CLI arg 3 into register
8 : ST   2, 3(5) ;  Store the argument into stack frame
...
46 : LD  6, 7(0) ;  Load return address for main function into register 6
