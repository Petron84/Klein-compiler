...
166 : LDA 4, 5(5) ; Base of callee frame
...
182 : LDA 4, 5(5) ; Base of callee frame
183 : ST 1, 3(4) ; Store argument 2 in callee
184 : LDA 4, 5(5) ; Base of callee frame
...
189 : LD   1, 4(5) ;  Load function result
