...
16 : LDC  3, 0(1) ; Store left operand into temporary register
17 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
18 : LDC  2, 0(3) ;  Restore left operand
...
54 : LDC  2, 0(3) ;  Restore left operand
...
66 : LDC  3, 0(1) ; Store left operand into temporary register
67 : LD   1, 1(5) ;  Load parameter 'a' into R1
68 : LDC  2, 0(3) ;  Restore left operand
...
85 : LDC  2, 0(3) ;  Restore left operand
...
106 : LDC  3, 0(1) ; Store left operand into temporary register
107 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
108 : LDC  2, 0(3) ;  Restore left operand
