...
10 : ST   1, 0(5) ;  Store argument Tree Node('IDENTIFIER', value='a',line=18)
11 : LD   1, 2(5) ;  Load parameter 'b' into R1
12 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=18)
13 : LDC  5, 5(0) ;  Set DMEM pointer to callee frame 'gcd'
14 : LDA  6, 2(7) ;  Compute return address
15 : ST   6, 0(5) ;  Store return address in frame
16 : LDA  7, -1(0) ;  Call gcd
