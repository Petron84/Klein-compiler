...
14 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='a',line=18)
15 : LD   1, 2(5) ;  Load parameter 'b' into R1
16 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=18)
17 : LDC  5, 7(0) ;  Set DMEM pointer to callee frame 'gcd'
...
39 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=15)
40 : LD   1, 1(5) ;  Load parameter 'a' into R1
41 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='a',line=15)
42 : LD   1, 2(5) ;  Load parameter 'b' into R1
43 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=15)
44 : LDC  5, 3(0) ;  Set DMEM pointer to callee frame 'remainder'
45 : LDA  6, 2(7) ;  Compute return address
46 : ST   6, 0(5) ;  Store return address in frame
47 : LDA  7, 60(0) ;  Call remainder
48 : LD   1, 3(5) ;  Load return value into R1
49 : LDC  5, 3(0) ;  Restore DMEM pointer to caller frame
50 : ST   1, 2(5) ;  Store argument Tree Node('FUNCTION-CALL', children=[Tree Node('IDENTIFIER', value='remainder',line=15), Tree Node('ARGUMENT-LIST', children=[Tree Node('IDENTIFIER', value='a',line=15), Tree Node('IDENTIFIER', value='b',line=15)],line=15)],line=15)
51 : LDC  5, 3(0) ;  Set DMEM pointer to callee frame 'gcd'
52 : LDA  6, 2(7) ;  Compute return address
53 : ST   6, 0(5) ;  Store return address in frame
54 : LDA  7, 27(0) ;  Call gcd
55 : LD   1, 3(5) ;  Load return value into R1
56 : LDC  5, 3(0) ;  Restore DMEM pointer to caller frame
...
75 : ST   1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='-', children=[Tree Node('IDENTIFIER', value='a',line=8), Tree Node('IDENTIFIER', value='b',line=8)],line=8)
76 : LD   1, 2(5) ;  Load parameter 'b' into R1
77 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=8)
78 : LDC  5, 3(0) ;  Set DMEM pointer to callee frame 'remainder'
79 : LDA  6, 2(7) ;  Compute return address
80 : ST   6, 0(5) ;  Store return address in frame
81 : LDA  7, 60(0) ;  Call remainder
82 : LD   1, 3(5) ;  Load return value into R1
83 : LDC  5, 3(0) ;  Restore DMEM pointer to caller frame
