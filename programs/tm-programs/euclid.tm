...
32 : LDC  3, 0(1) ; Store left operand into temporary register
33 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
34 : LDC  2, 0(3) ;  Restore left operand
...
74 : LDC  3, 0(1) ; Store left operand into temporary register
75 : LD   1, 2(5) ;  Load parameter 'b' into R1
76 : LDC  2, 0(3) ;  Restore left operand
