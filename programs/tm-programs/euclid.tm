...
14 : ST   1, 0(5) ;  Store argument Tree Node('IDENTIFIER', value='a',line=18)
15 : LD   1, 2(5) ;  Load parameter 'b' into R1
16 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=18)
...
25 : LD  6, 5(0) ;  Load return address for main function into register 6
