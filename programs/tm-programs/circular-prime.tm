...
45 : ST 1, 1(4) ; Store argument 0 in callee param slot
46 : LD 1, 2(5) ; Load parameter 'den' into R1
47 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
48 : ST 1, 2(4) ; Store argument 1 in callee param slot
...
61 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
62 : ST 1, 1(4) ; Store argument 0 in callee param slot
63 : LD 1, 1(5) ; Load parameter 'a' into R1
64 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
65 : ST 1, 2(4) ; Store argument 1 in callee param slot
...
96 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
97 : ST 1, 1(4) ; Store argument 0 in callee param slot
98 : LD 1, 2(5) ; Load parameter 'n' into R1
99 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
115 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
116 : ST 1, 1(4) ; Store argument 0 in callee param slot
117 : LD 1, 2(5) ; Load parameter 'n' into R1
118 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
119 : ST 1, 2(4) ; Store argument 1 in callee param slot
120 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
126 : LDC 2, 6(0) ; Caller frame size
...
136 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
137 : ST 1, 1(4) ; Store argument 0 in callee param slot
138 : LD 1, 1(5) ; Load parameter 'n' into R1
139 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
140 : ST 1, 2(4) ; Store argument 1 in callee param slot
141 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
175 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
182 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
183 : ST 1, 2(4) ; Store argument 1 in callee param slot
184 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
196 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
197 : ST 1, 1(4) ; Store argument 0 in callee param slot
198 : LDC 1, 0(0) ; Load integer-literal into R1
199 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
200 : ST 1, 2(4) ; Store argument 1 in callee param slot
201 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
207 : LDC 2, 3(0) ; Caller frame size
...
237 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
238 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
244 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
245 : ST 1, 2(4) ; Store argument 1 in callee param slot
...
251 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
252 : ST 1, 3(4) ; Store argument 2 in callee param slot
253 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
259 : LDC 2, 6(0) ; Caller frame size
...
265 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
266 : ST 1, 1(4) ; Store argument 0 in callee param slot
267 : LD 1, 2(5) ; Load parameter 'y' into R1
268 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
269 : ST 1, 2(4) ; Store argument 1 in callee param slot
270 : LD 1, 1(5) ; Load parameter 'x' into R1
271 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
272 : ST 1, 3(4) ; Store argument 2 in callee param slot
...
291 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
292 : ST 1, 1(4) ; Store argument 0 in callee param slot
293 : LDC 1, 10(0) ; Load integer-literal into R1
294 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
295 : ST 1, 2(4) ; Store argument 1 in callee param slot
296 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
302 : LDC 2, 5(0) ; Caller frame size
...
306 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
307 : ST 1, 1(4) ; Store argument 0 in callee param slot
308 : LD 1, 1(5) ; Load parameter 'x' into R1
309 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
310 : ST 1, 1(4) ; Store argument 0 in callee param slot
311 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
319 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
320 : ST 1, 2(4) ; Store argument 1 in callee param slot
321 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
327 : LDC 2, 5(0) ; Caller frame size
...
337 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
338 : LDA 6, 342(0) ; Return address
339 : ST 6, 0(4) ; Store return address in callee frame
340 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
...
361 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
362 : ST 1, 1(4) ; Store argument 0 in callee param slot
363 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
369 : LDC 2, 6(0) ; Caller frame size
...
373 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
374 : ST 1, 1(4) ; Store argument 0 in callee param slot
375 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
381 : LDC 2, 6(0) ; Caller frame size
382 : SUB 5, 5, 2 ; Pop callee frame back to caller
383 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
384 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
390 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
391 : ST 1, 2(4) ; Store argument 1 in callee param slot
392 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
398 : LDC 2, 6(0) ; Caller frame size
...
406 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
407 : ST 1, 1(4) ; Store argument 0 in callee param slot
408 : LD 1, 1(5) ; Load parameter 'x' into R1
409 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
410 : ST 1, 1(4) ; Store argument 0 in callee param slot
411 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
423 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
424 : ST 1, 2(4) ; Store argument 1 in callee param slot
425 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
435 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
461 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
462 : ST 1, 1(4) ; Store argument 0 in callee param slot
463 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
469 : LDC 2, 6(0) ; Caller frame size
...
473 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
474 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
480 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
481 : ST 1, 2(4) ; Store argument 1 in callee param slot
...
487 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
488 : ST 1, 3(4) ; Store argument 2 in callee param slot
489 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
495 : LDC 2, 6(0) ; Caller frame size
496 : SUB 5, 5, 2 ; Pop callee frame back to caller
497 : LDA 7, 519(0) ; Skip ELSE block
498 : LD 1, 1(5) ; Load parameter 'top' into R1
499 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
500 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
506 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
507 : ST 1, 2(4) ; Store argument 1 in callee param slot
508 : LD 1, 3(5) ; Load parameter 'count' into R1
509 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
510 : ST 1, 3(4) ; Store argument 2 in callee param slot
511 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
517 : LDC 2, 6(0) ; Caller frame size
...
529 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
530 : ST 1, 1(4) ; Store argument 0 in callee param slot
531 : LDC 1, 2(0) ; Load integer-literal into R1
532 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
533 : ST 1, 2(4) ; Store argument 1 in callee param slot
534 : LDC 1, 0(0) ; Load integer-literal into R1
535 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
536 : ST 1, 3(4) ; Store argument 2 in callee param slot
537 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
