...
64 : LDA 4, 5(4) ; Recompute callee base from callee size
...
96 : LDA 4, 6(4) ; Recompute callee base from callee size
97 : ST 1, 1(4) ; Store argument 0 in callee
98 : LD 1, 2(5) ; Load parameter 'n' into R1
99 : LDA 4, 6(4) ; Recompute callee base from callee size
100 : ST 1, 2(4) ; Store argument 1 in callee
101 : LDA 4, 6(4) ; Recompute callee base from callee size
...
115 : LDA 4, 6(4) ; Recompute callee base from callee size
116 : ST 1, 1(4) ; Store argument 0 in callee
117 : LD 1, 2(5) ; Load parameter 'n' into R1
118 : LDA 4, 6(4) ; Recompute callee base from callee size
119 : ST 1, 2(4) ; Store argument 1 in callee
120 : LDA 4, 6(4) ; Recompute callee base from callee size
...
136 : LDA 4, 3(4) ; Recompute callee base from callee size
137 : ST 1, 1(4) ; Store argument 0 in callee
138 : LD 1, 1(5) ; Load parameter 'n' into R1
139 : LDA 4, 3(4) ; Recompute callee base from callee size
140 : ST 1, 2(4) ; Store argument 1 in callee
141 : LDA 4, 3(4) ; Recompute callee base from callee size
...
175 : LDA 4, 5(4) ; Recompute callee base from callee size
...
182 : LDA 4, 5(4) ; Recompute callee base from callee size
183 : ST 1, 2(4) ; Store argument 1 in callee
184 : LDA 4, 5(4) ; Recompute callee base from callee size
...
196 : LDA 4, 3(4) ; Recompute callee base from callee size
197 : ST 1, 1(4) ; Store argument 0 in callee
198 : LDC 1, 0(0) ; Load integer-literal into R1
199 : LDA 4, 3(4) ; Recompute callee base from callee size
200 : ST 1, 2(4) ; Store argument 1 in callee
201 : LDA 4, 3(4) ; Recompute callee base from callee size
...
237 : LDA 4, 6(4) ; Recompute callee base from callee size
...
244 : LDA 4, 6(4) ; Recompute callee base from callee size
...
251 : LDA 4, 6(4) ; Recompute callee base from callee size
252 : ST 1, 3(4) ; Store argument 2 in callee
253 : LDA 4, 6(4) ; Recompute callee base from callee size
...
265 : LDA 4, 4(4) ; Recompute callee base from callee size
...
291 : LDA 4, 5(4) ; Recompute callee base from callee size
292 : ST 1, 1(4) ; Store argument 0 in callee
293 : LDC 1, 10(0) ; Load integer-literal into R1
294 : LDA 4, 5(4) ; Recompute callee base from callee size
295 : ST 1, 2(4) ; Store argument 1 in callee
296 : LDA 4, 5(4) ; Recompute callee base from callee size
...
306 : LDA 4, 5(4) ; Recompute callee base from callee size
307 : ST 1, 1(4) ; Store argument 0 in callee
308 : LD 1, 1(5) ; Load parameter 'x' into R1
309 : LDA 4, 5(4) ; Recompute callee base from callee size
310 : ST 1, 1(4) ; Store argument 0 in callee
311 : LDA 4, 5(4) ; Recompute callee base from callee size
...
319 : LDA 4, 5(4) ; Recompute callee base from callee size
320 : ST 1, 2(4) ; Store argument 1 in callee
321 : LDA 4, 5(4) ; Recompute callee base from callee size
...
337 : LDA 4, 3(4) ; Recompute callee base from caller size
...
361 : LDA 4, 6(4) ; Recompute callee base from callee size
362 : ST 1, 1(4) ; Store argument 0 in callee
363 : LDA 4, 6(4) ; Recompute callee base from callee size
...
373 : LDA 4, 6(4) ; Recompute callee base from callee size
374 : ST 1, 1(4) ; Store argument 0 in callee
375 : LDA 4, 6(4) ; Recompute callee base from callee size
...
383 : LDA 4, 6(4) ; Recompute callee base from callee size
...
390 : LDA 4, 6(4) ; Recompute callee base from callee size
391 : ST 1, 2(4) ; Store argument 1 in callee
392 : LDA 4, 6(4) ; Recompute callee base from callee size
...
406 : LDA 4, 4(4) ; Recompute callee base from callee size
407 : ST 1, 1(4) ; Store argument 0 in callee
408 : LD 1, 1(5) ; Load parameter 'x' into R1
409 : LDA 4, 4(4) ; Recompute callee base from callee size
410 : ST 1, 1(4) ; Store argument 0 in callee
411 : LDA 4, 4(4) ; Recompute callee base from callee size
...
423 : LDA 4, 4(4) ; Recompute callee base from callee size
424 : ST 1, 2(4) ; Store argument 1 in callee
425 : LDA 4, 4(4) ; Recompute callee base from callee size
...
435 : LDA 4, 4(4) ; Recompute callee base from callee size
...
461 : LDA 4, 6(4) ; Recompute callee base from callee size
462 : ST 1, 1(4) ; Store argument 0 in callee
463 : LDA 4, 6(4) ; Recompute callee base from callee size
...
473 : LDA 4, 6(4) ; Recompute callee base from callee size
...
480 : LDA 4, 6(4) ; Recompute callee base from callee size
...
487 : LDA 4, 6(4) ; Recompute callee base from callee size
488 : ST 1, 3(4) ; Store argument 2 in callee
489 : LDA 4, 6(4) ; Recompute callee base from callee size
...
499 : LDA 4, 6(4) ; Recompute callee base from callee size
...
506 : LDA 4, 6(4) ; Recompute callee base from callee size
507 : ST 1, 2(4) ; Store argument 1 in callee
508 : LD 1, 3(5) ; Load parameter 'count' into R1
509 : LDA 4, 6(4) ; Recompute callee base from callee size
510 : ST 1, 3(4) ; Store argument 2 in callee
511 : LDA 4, 6(4) ; Recompute callee base from callee size
...
529 : LDA 4, 4(4) ; Recompute callee base from callee size
530 : ST 1, 1(4) ; Store argument 0 in callee
531 : LDC 1, 2(0) ; Load integer-literal into R1
532 : LDA 4, 4(4) ; Recompute callee base from callee size
533 : ST 1, 2(4) ; Store argument 1 in callee
534 : LDC 1, 0(0) ; Load integer-literal into R1
535 : LDA 4, 4(4) ; Recompute callee base from callee size
536 : ST 1, 3(4) ; Store argument 2 in callee
537 : LDA 4, 4(4) ; Recompute callee base from callee size
