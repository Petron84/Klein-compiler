...
61 : LDA 4, 5(5) ; Compute callee base
...
99 : LDA 4, 5(5) ; Compute callee base
...
107 : LDC 2, 5(0) ; Caller frame size
...
139 : LDA 4, 6(5) ; Compute callee base
...
175 : LDA 4, 5(5) ; Compute callee base
...
237 : LDA 4, 6(5) ; Compute callee base
...
244 : LDA 4, 6(5) ; Compute callee base
...
251 : LDA 4, 6(5) ; Compute callee base
...
279 : LDC 2, 6(0) ; Caller frame size
...
319 : LDA 4, 4(5) ; Compute callee base
...
361 : LDA 4, 3(5) ; Compute callee base
...
373 : LDA 4, 5(5) ; Compute callee base
...
381 : LDC 2, 5(0) ; Caller frame size
382 : SUB 5, 5, 2 ; Pop back to caller
383 : LDA 4, 6(5) ; Compute callee base
...
390 : LDA 4, 6(5) ; Compute callee base
...
435 : LDA 4, 3(5) ; Compute callee base
...
461 : LDA 4, 4(5) ; Compute callee base
...
469 : LDC 2, 4(0) ; Caller frame size
...
473 : LDA 4, 6(5) ; Compute callee base
...
480 : LDA 4, 6(5) ; Compute callee base
...
487 : LDA 4, 6(5) ; Compute callee base
...
499 : LDA 4, 6(5) ; Compute callee base
