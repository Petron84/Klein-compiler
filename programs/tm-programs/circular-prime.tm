...
60 : LDA 4, 5(5) ; Compute future callee base using caller_size
61 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
62 : LDA 4, 5(5) ; Compute future callee base using caller_size
...
93 : LDA 4, 6(5) ; Compute future callee base using caller_size
94 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
95 : LDA 4, 6(5) ; Compute future callee base using caller_size
96 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
97 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
111 : LDA 4, 6(5) ; Compute future callee base using caller_size
112 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
113 : LD 1, 2(5) ; Load parameter 'n' into R1
114 : LDA 4, 6(5) ; Compute future callee base using caller_size
115 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
116 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
132 : LDA 4, 3(5) ; Compute future callee base using caller_size
...
136 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
137 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
171 : LDA 4, 5(5) ; Compute future callee base using caller_size
172 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
178 : LDA 4, 5(5) ; Compute future callee base using caller_size
179 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
180 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
192 : LDA 4, 3(5) ; Compute future callee base using caller_size
193 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
194 : LDC 1, 0(0) ; Load integer-literal into R1
195 : LDA 4, 3(5) ; Compute future callee base using caller_size
196 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
197 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
240 : LDA 4, 6(5) ; Compute future callee base using caller_size
241 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
...
247 : LDA 4, 6(5) ; Compute future callee base using caller_size
248 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
249 : LDA 4, 6(5) ; Compute future callee base (caller_size)
250 : LDA 6, 254(0) ; Return address
251 : ST 6, 0(4) ; Store return in callee frame
252 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
253 : LDA 7, 208(0) ; Call powHelper
254 : LD 1, 4(5) ; Load callee result into R1
255 : LDC 2, 6(0) ; Callee frame size
256 : SUB 5, 5, 2 ; Pop callee frame
257 : ST 1, 4(5) ; Store function result into frame return slot
258 : LD 6, 0(5) ; Load return address
259 : LDA 7, 0(6) ; Return to caller
260 : LDA 4, 4(5) ; Compute future callee base using caller_size
261 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
264 : LDA 4, 4(5) ; Compute future callee base using caller_size
265 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
266 : LDA 4, 4(5) ; Compute future callee base (caller_size)
267 : LDA 6, 271(0) ; Return address
268 : ST 6, 0(4) ; Store return in callee frame
269 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
270 : LDA 7, 208(0) ; Call powHelper
271 : LD 1, 4(5) ; Load callee result into R1
272 : LDC 2, 6(0) ; Callee frame size
273 : SUB 5, 5, 2 ; Pop callee frame
...
283 : LDA 4, 5(5) ; Compute future callee base using caller_size
284 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
285 : LDC 1, 10(0) ; Load integer-literal into R1
286 : LDA 4, 5(5) ; Compute future callee base using caller_size
287 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
288 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
301 : LDA 4, 4(5) ; Compute future callee base using caller_size
302 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
303 : LDA 4, 4(5) ; Compute future callee base (caller_size)
304 : LDA 6, 308(0) ; Return address
305 : ST 6, 0(4) ; Store return in callee frame
306 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
307 : LDA 7, 191(0) ; Call log10
308 : LD 1, 2(5) ; Load callee result into R1
309 : LDC 2, 3(0) ; Callee frame size
310 : SUB 5, 5, 2 ; Pop callee frame
311 : LDA 4, 5(5) ; Compute future callee base using caller_size
312 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
313 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
319 : LDC 2, 4(0) ; Callee frame size
...
329 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
352 : LDA 4, 6(5) ; Compute future callee base using caller_size
353 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
354 : LDA 4, 6(5) ; Compute future callee base (caller_size)
355 : LDA 6, 359(0) ; Return address
356 : ST 6, 0(4) ; Store return in callee frame
357 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
358 : LDA 7, 131(0) ; Call isPrime
359 : LD 1, 2(5) ; Load callee result into R1
360 : LDC 2, 3(0) ; Callee frame size
361 : SUB 5, 5, 2 ; Pop callee frame
362 : ST 1, 4(5) ; Spill left operand at depth 0
363 : LD 1, 1(5) ; Load parameter 'x' into R1
364 : LDA 4, 6(5) ; Compute future callee base using caller_size
365 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
366 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
372 : LDC 2, 5(0) ; Callee frame size
373 : SUB 5, 5, 2 ; Pop callee frame
374 : LDA 4, 6(5) ; Compute future callee base using caller_size
...
381 : LDA 4, 6(5) ; Compute future callee base using caller_size
382 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
383 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
389 : LDC 2, 6(0) ; Callee frame size
...
397 : LDA 4, 4(5) ; Compute future callee base using caller_size
398 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
399 : LD 1, 1(5) ; Load parameter 'x' into R1
400 : LDA 4, 6(5) ; Compute future callee base using caller_size
401 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
402 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
408 : LDC 2, 3(0) ; Callee frame size
...
414 : LDA 4, 4(5) ; Compute future callee base using caller_size
415 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
416 : LDA 4, 4(5) ; Compute future callee base (caller_size)
417 : LDA 6, 421(0) ; Return address
418 : ST 6, 0(4) ; Store return in callee frame
419 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
420 : LDA 7, 340(0) ; Call isCircularPrimeHelper
421 : LD 1, 3(5) ; Load callee result into R1
422 : LDC 2, 6(0) ; Callee frame size
423 : SUB 5, 5, 2 ; Pop callee frame
424 : JEQ 1, 437(0) ; If condition is false, jump to ELSE
425 : LD 1, 1(5) ; Load parameter 'x' into R1
426 : LDA 4, 4(5) ; Compute future callee base using caller_size
427 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
428 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
434 : LDC 2, 3(0) ; Callee frame size
...
452 : LDA 4, 6(5) ; Compute future callee base using caller_size
453 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
454 : LDA 4, 6(5) ; Compute future callee base (caller_size)
455 : LDA 6, 459(0) ; Return address
456 : ST 6, 0(4) ; Store return in callee frame
457 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
458 : LDA 7, 396(0) ; Call isCircularPrime
459 : LD 1, 2(5) ; Load callee result into R1
460 : LDC 2, 4(0) ; Callee frame size
461 : SUB 5, 5, 2 ; Pop callee frame
462 : JEQ 1, 489(0) ; If condition is false, jump to ELSE
463 : LD 1, 1(5) ; Load parameter 'top' into R1
464 : LDA 4, 6(5) ; Compute future callee base using caller_size
465 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
471 : LDA 4, 6(5) ; Compute future callee base using caller_size
472 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
...
479 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
...
490 : LDA 4, 6(5) ; Compute future callee base using caller_size
...
497 : LDA 4, 6(5) ; Compute future callee base using caller_size
498 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
499 : LD 1, 3(5) ; Load parameter 'count' into R1
500 : LDA 4, 6(5) ; Compute future callee base using caller_size
501 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
502 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
508 : LDC 2, 6(0) ; Callee frame size
...
520 : LDA 4, 4(5) ; Compute future callee base using caller_size
521 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
522 : LDC 1, 2(0) ; Load integer-literal into R1
523 : LDA 4, 4(5) ; Compute future callee base using caller_size
524 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
525 : LDC 1, 0(0) ; Load integer-literal into R1
526 : LDA 4, 4(5) ; Compute future callee base using caller_size
527 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
