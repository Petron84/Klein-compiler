...
31 : SUB 1, 2, 1 ; Compute left - right for less-than
32 : JLT 1, 2(7) ; If < 0, jump to true
33 : LDC 1, 0(0) ; false
34 : LDA 7, 1(7) ; skip true assignment
35 : LDC 1, 1(0) ; true
36 : JEQ 1, 39(0) ; If condition false jump to ELSE
...
44 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
45 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
46 : LD 1, 2(5) ; Load parameter 'den' into R1
47 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
48 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
49 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
61 : LDA 4, 5(5) ; Compute future callee base (caller_size)
62 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
63 : LD 1, 1(5) ; Load parameter 'a' into R1
64 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
73 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
77 : SUB 1, 2, 1 ; Compute left - right for equality
78 : JEQ 1, 2(7) ; If zero, jump to true
79 : LDC 1, 0(0) ; false
80 : LDA 7, 1(7) ; skip true assignment
81 : LDC 1, 1(0) ; true
...
89 : SUB 1, 2, 1 ; Compute left - right for less-than
90 : JLT 1, 2(7) ; If < 0, jump to true
91 : LDC 1, 0(0) ; false
92 : LDA 7, 1(7) ; skip true assignment
93 : LDC 1, 1(0) ; true
94 : JEQ 1, 131(0) ; If condition false jump to ELSE
95 : LD 1, 1(5) ; Load parameter 'i' into R1
96 : LDA 4, 6(5) ; Compute future callee base (caller_size)
97 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
98 : LD 1, 2(5) ; Load parameter 'n' into R1
99 : LDA 4, 6(5) ; Compute future callee base (caller_size)
100 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
101 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
115 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
116 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
117 : LD 1, 2(5) ; Load parameter 'n' into R1
118 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
119 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
120 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
121 : LDA 6, 125(0) ; Return address
122 : ST 6, 0(4) ; Store return address in callee frame
...
127 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
136 : LDA 4, 3(5) ; Compute future callee base (caller_size)
137 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
138 : LD 1, 1(5) ; Load parameter 'n' into R1
139 : LDA 4, 3(5) ; Compute future callee base (caller_size)
140 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
141 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
162 : SUB 1, 2, 1 ; Compute left - right for equality
163 : JEQ 1, 2(7) ; If zero, jump to true
164 : LDC 1, 0(0) ; false
165 : LDA 7, 1(7) ; skip true assignment
166 : LDC 1, 1(0) ; true
167 : JEQ 1, 170(0) ; If condition false jump to ELSE
...
175 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
182 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
183 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
184 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
191 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
196 : LDA 4, 3(5) ; Compute future callee base (caller_size)
197 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
198 : LDC 1, 0(0) ; Load integer literal into R1
199 : LDA 4, 3(5) ; Compute future callee base (caller_size)
200 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
201 : LDA 4, 3(5) ; Compute future callee base (caller_size)
202 : LDA 6, 206(0) ; Return address
203 : ST 6, 0(4) ; Store return address in callee frame
...
208 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
216 : SUB 1, 2, 1 ; Compute left - right for equality
217 : JEQ 1, 2(7) ; If zero, jump to true
218 : LDC 1, 0(0) ; false
219 : LDA 7, 1(7) ; skip true assignment
220 : LDC 1, 1(0) ; true
221 : JEQ 1, 224(0) ; If condition false jump to ELSE
...
228 : SUB 1, 2, 1 ; Compute left - right for equality
229 : JEQ 1, 2(7) ; If zero, jump to true
230 : LDC 1, 0(0) ; false
231 : LDA 7, 1(7) ; skip true assignment
232 : LDC 1, 1(0) ; true
233 : JEQ 1, 236(0) ; If condition false jump to ELSE
234 : LD 1, 3(5) ; Load parameter 'total' into R1
235 : LDA 7, 261(0) ; Skip ELSE block
236 : LD 1, 1(5) ; Load parameter 'base' into R1
237 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
238 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
244 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
245 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
...
251 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
252 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
253 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
254 : LDA 6, 258(0) ; Return address
255 : ST 6, 0(4) ; Store return address in callee frame
...
260 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
265 : LDA 4, 4(5) ; Compute future callee base (caller_size)
266 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
267 : LD 1, 2(5) ; Load parameter 'y' into R1
268 : LDA 4, 4(5) ; Compute future callee base (caller_size)
269 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
270 : LD 1, 1(5) ; Load parameter 'x' into R1
271 : LDA 4, 4(5) ; Compute future callee base (caller_size)
272 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
...
291 : LDA 4, 5(5) ; Compute future callee base (caller_size)
292 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
293 : LDC 1, 10(0) ; Load integer literal into R1
294 : LDA 4, 5(5) ; Compute future callee base (caller_size)
295 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
296 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
303 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
304 : ST 1, 4(5) ; Spill left operand at depth 1
305 : LDC 1, 10(0) ; Load integer literal into R1
306 : LDA 4, 5(5) ; Compute future callee base (caller_size)
307 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
308 : LD 1, 1(5) ; Load parameter 'x' into R1
309 : LDA 4, 5(5) ; Compute future callee base (caller_size)
310 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
311 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
318 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
319 : LDA 4, 5(5) ; Compute future callee base (caller_size)
320 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
321 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
328 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
337 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
352 : SUB 1, 2, 1 ; Compute left - right for equality
353 : JEQ 1, 2(7) ; If zero, jump to true
354 : LDC 1, 0(0) ; false
355 : LDA 7, 1(7) ; skip true assignment
356 : LDC 1, 1(0) ; true
357 : JEQ 1, 360(0) ; If condition false jump to ELSE
358 : LDC 1, 1(0) ; Load boolean literal into R1
359 : LDA 7, 402(0) ; Skip ELSE block
360 : LD 1, 1(5) ; Load parameter 'x' into R1
361 : LDA 4, 6(5) ; Compute future callee base (caller_size)
362 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
363 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
370 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
371 : ST 1, 4(5) ; Spill left operand at depth 0
372 : LD 1, 1(5) ; Load parameter 'x' into R1
373 : LDA 4, 6(5) ; Compute future callee base (caller_size)
374 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
375 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
382 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
383 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
384 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
390 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
391 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
392 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
399 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
406 : LDA 4, 4(5) ; Compute future callee base (caller_size)
407 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
408 : LD 1, 1(5) ; Load parameter 'x' into R1
409 : LDA 4, 4(5) ; Compute future callee base (caller_size)
410 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
411 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
418 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
423 : LDA 4, 4(5) ; Compute future callee base (caller_size)
424 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
425 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
433 : JEQ 1, 446(0) ; If condition false jump to ELSE
434 : LD 1, 1(5) ; Load parameter 'x' into R1
435 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
454 : SUB 1, 2, 1 ; Compute left - right for less-than
455 : JLT 1, 2(7) ; If < 0, jump to true
456 : LDC 1, 0(0) ; false
457 : LDA 7, 1(7) ; skip true assignment
458 : LDC 1, 1(0) ; true
459 : JEQ 1, 520(0) ; If condition false jump to ELSE
460 : LD 1, 2(5) ; Load parameter 'x' into R1
461 : LDA 4, 6(5) ; Compute future callee base (caller_size)
462 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
463 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
470 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
471 : JEQ 1, 498(0) ; If condition false jump to ELSE
472 : LD 1, 1(5) ; Load parameter 'top' into R1
473 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
474 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
480 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
481 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
...
487 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
488 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
489 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
499 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
500 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
506 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
507 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
508 : LD 1, 3(5) ; Load parameter 'count' into R1
509 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
510 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
511 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
518 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
529 : LDA 4, 4(5) ; Compute future callee base (caller_size)
530 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
531 : LDC 1, 2(0) ; Load integer literal into R1
532 : LDA 4, 4(5) ; Compute future callee base (caller_size)
533 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
534 : LDC 1, 0(0) ; Load integer literal into R1
535 : LDA 4, 4(5) ; Compute future callee base (caller_size)
536 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
537 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
544 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
