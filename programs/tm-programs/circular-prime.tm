...
9 : LD   1, 1(5) ;  Load parameter 'x' into R1
10 : ST   1, 0(5) ;  Store argument Tree Node('IDENTIFIER', value='x',line=4)
11 : LDC  5, 4(0) ;  Set DMEM pointer to callee frame 'circularPrimesTo'
12 : LDA  6, 2(7) ;  Compute return address
13 : ST   6, 0(5) ;  Store return address in frame
14 : LDA  7, -1(0) ;  Call circularPrimesTo
15 : LD   1, 2(5) ;  Load return value into R1
16 : LDC  5, 1(0) ;  Restore DMEM pointer to caller frame
17 : ST   1, 3(0) ;  Store function-call result into caller's return slot
18 : LD   1, 3(0) ;  Load return value into register 1
19 : LD  6, 1(0) ;  Load return address for main function into register 6
