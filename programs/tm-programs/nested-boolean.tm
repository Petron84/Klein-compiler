...
17 : SUB 1, 2, 1 ;  R1 = 1 - R1 (logical NOT)
18 : LDC 2, 1(0) ;  Load 1 into R2
19 : SUB 1, 2, 1 ;  R1 = 1 - R1 (logical NOT)
20 : ST 1, 2(4) ;  Store into current frame's return slot (via FP)
21 : LD 1, 2(4) ;  Load main return value (via FP)
22 : LD 6, 0(4) ;  Load return address (via FP)
