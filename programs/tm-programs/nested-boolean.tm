...
12 : LDC  2, 1(0) ;  Load value 1 into register 2
13 : SUB  1, 2, 1 ;  Flip boolean value
14 : LDC  2, 1(0) ;  Load value 1 into register 2
15 : SUB  1, 2, 1 ;  Flip boolean value
16 : LDC  2, 1(0) ;  Load value 1 into register 2
17 : SUB  1, 2, 1 ;  Flip boolean value
18 : LDC  5, 1021(0) ;  Store the memory location of main return value
19 : ST   1, 0(5) ;  Store return value of into DMEM
20 : LDC  5, 1021(0) ;  Store the memory location of main return value
21 : ST   1, 0(5) ;  Store return value of into DMEM
22 : LD   1, 0(5) ;  Load Return Value from DMEM
23 : OUT  1, 0, 0 ;  Output value from register 1.
24 : HALT 0, 0, 0 ;  Terminate program execution.
