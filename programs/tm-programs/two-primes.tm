...
48 : LDA 4, 6(5) ; Recompute callee base from callee size
...
71 : LDA 4, 4(5) ; Recompute callee base from callee size
...
130 : LDA 4, 7(5) ; Recompute callee base from callee size
...
162 : LDA 4, 6(5) ; Recompute callee base from callee size
...
176 : LDA 4, 7(5) ; Recompute callee base from callee size
177 : ST 1, 1(4) ; Store argument 0 in callee
178 : LD 1, 1(5) ; Load parameter 'a' into R1
179 : LDA 4, 7(5) ; Recompute callee base from callee size
...
230 : LDA 4, 7(5) ; Recompute callee base from callee size
231 : ST 1, 1(4) ; Store argument 0 in callee
232 : LD 1, 2(5) ; Load parameter 'n' into R1
233 : LDA 4, 7(5) ; Recompute callee base from callee size
...
251 : LDA 4, 7(5) ; Recompute callee base from callee size
252 : ST 1, 1(4) ; Store argument 0 in callee
253 : LD 1, 1(5) ; Load parameter 'n' into R1
254 : LDA 4, 7(5) ; Recompute callee base from callee size
...
270 : LDA 4, 5(5) ; Recompute callee base from callee size
...
288 : LDA 4, 6(5) ; Recompute callee base from callee size
...
302 : LDA 4, 4(5) ; Recompute callee base from callee size
...
330 : LDA 4, 4(5) ; Recompute callee base from callee size
