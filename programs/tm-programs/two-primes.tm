...
26 : ST 1, 1(4) ; Store argument 0 in callee param slot
27 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
33 : LDC 2, 5(0) ; Caller frame size
34 : SUB 5, 5, 2 ; Pop callee frame back to caller
35 : ST 1, 3(5) ; Store result into caller’s frame return slot
...
48 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
49 : ST 1, 1(4) ; Store argument 0 in callee param slot
50 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
57 : SUB 5, 5, 2 ; Pop callee frame back to caller
58 : ST 1, 3(5) ; Store result into caller’s frame return slot
...
71 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
72 : ST 1, 1(4) ; Store argument 0 in callee param slot
73 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
79 : LDC 2, 5(0) ; Caller frame size
80 : SUB 5, 5, 2 ; Pop callee frame back to caller
81 : ST 1, 3(5) ; Store result into caller’s frame return slot
...
121 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
130 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
131 : ST 1, 1(4) ; Store argument 0 in callee param slot
132 : LDC 1, 10(0) ; Load integer-literal into R1
133 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
134 : ST 1, 2(4) ; Store argument 1 in callee param slot
135 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
142 : SUB 5, 5, 2 ; Pop callee frame back to caller
143 : LD 2, 4(5) ; Restore left operand from depth 0
144 : ADD 1, 2, 1 ; R1 = left + right
145 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
146 : ST 1, 2(4) ; Store argument 1 in callee param slot
147 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
159 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
160 : ST 1, 1(4) ; Store argument 0 in callee param slot
161 : LDC 1, 0(0) ; Load integer-literal into R1
162 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
163 : ST 1, 2(4) ; Store argument 1 in callee param slot
164 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
171 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
176 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
177 : ST 1, 1(4) ; Store argument 0 in callee param slot
178 : LD 1, 1(5) ; Load parameter 'a' into R1
179 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
180 : ST 1, 2(4) ; Store argument 1 in callee param slot
181 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
188 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
211 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
212 : ST 1, 1(4) ; Store argument 0 in callee param slot
213 : LD 1, 2(5) ; Load parameter 'n' into R1
214 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
215 : ST 1, 2(4) ; Store argument 1 in callee param slot
216 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
222 : LDC 2, 6(0) ; Caller frame size
223 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
230 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
231 : ST 1, 1(4) ; Store argument 0 in callee param slot
232 : LD 1, 2(5) ; Load parameter 'n' into R1
233 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
234 : ST 1, 2(4) ; Store argument 1 in callee param slot
235 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
242 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
251 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
252 : ST 1, 1(4) ; Store argument 0 in callee param slot
253 : LD 1, 1(5) ; Load parameter 'n' into R1
254 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
255 : ST 1, 2(4) ; Store argument 1 in callee param slot
256 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
262 : LDC 2, 3(0) ; Caller frame size
263 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
270 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
271 : ST 1, 1(4) ; Store argument 0 in callee param slot
272 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
279 : SUB 5, 5, 2 ; Pop callee frame back to caller
280 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
288 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
289 : ST 1, 1(4) ; Store argument 0 in callee param slot
290 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
302 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
303 : ST 1, 1(4) ; Store argument 0 in callee param slot
304 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
310 : LDC 2, 5(0) ; Caller frame size
311 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
330 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
331 : ST 1, 1(4) ; Store argument 0 in callee param slot
332 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
338 : LDC 2, 5(0) ; Caller frame size
339 : SUB 5, 5, 2 ; Pop callee frame back to caller
...
347 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
359 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
368 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
369 : ST 1, 1(4) ; Store argument 0 in callee param slot
370 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
377 : SUB 5, 5, 2 ; Pop callee frame back to caller
