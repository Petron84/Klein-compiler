...
11 : OUT 1, 0, 0 ; Built-in print: output R1
12 : LD 6, 0(5) ; Load return address from current frame
13 : LDA 7, 0(6) ; Return to caller
...
18 : SUB 1, 2, 1 ; Compute left - right for equality
19 : JEQ 1, 2(7) ; If zero, jump to true
20 : LDC 1, 0(0) ; false
21 : LDA 7, 1(7) ; skip true assignment
22 : LDC 1, 1(0) ; true
23 : JEQ 1, 37(0) ; If condition false jump to ELSE
...
41 : SUB 1, 2, 1 ; Compute left - right for equality
42 : JEQ 1, 2(7) ; If zero, jump to true
43 : LDC 1, 0(0) ; false
44 : LDA 7, 1(7) ; skip true assignment
45 : LDC 1, 1(0) ; true
46 : JEQ 1, 60(0) ; If condition false jump to ELSE
47 : LD 1, 1(5) ; Load parameter 'n' into R1
48 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
64 : SUB 1, 2, 1 ; Compute left - right for equality
65 : JEQ 1, 2(7) ; If zero, jump to true
66 : LDC 1, 0(0) ; false
67 : LDA 7, 1(7) ; skip true assignment
68 : LDC 1, 1(0) ; true
69 : JEQ 1, 83(0) ; If condition false jump to ELSE
...
84 : ST 1, 3(5) ; Store boolean into return slot
...
108 : SUB 1, 2, 1 ; Compute left - right for equality
109 : JEQ 1, 2(7) ; If zero, jump to true
110 : LDC 1, 0(0) ; false
111 : LDA 7, 1(7) ; skip true assignment
112 : LDC 1, 1(0) ; true
113 : JEQ 1, 116(0) ; If condition false jump to ELSE
...
121 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
130 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
145 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
146 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
147 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
166 : ST 6, 0(4) ; Store return address in callee frame
...
204 : SUB 1, 2, 1 ; Compute left - right for less-than
205 : JLT 1, 2(7) ; If < 0, jump to true
206 : LDC 1, 0(0) ; false
207 : LDA 7, 1(7) ; skip true assignment
208 : LDC 1, 1(0) ; true
209 : JEQ 1, 246(0) ; If condition false jump to ELSE
210 : LD 1, 1(5) ; Load parameter 'i' into R1
211 : LDA 4, 6(5) ; Compute future callee base (caller_size)
212 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
213 : LD 1, 2(5) ; Load parameter 'n' into R1
214 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
218 : ST 6, 0(4) ; Store return address in callee frame
...
230 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
231 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
232 : LD 1, 2(5) ; Load parameter 'n' into R1
233 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
234 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
235 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
236 : LDA 6, 240(0) ; Return address
237 : ST 6, 0(4) ; Store return address in callee frame
...
251 : LDA 4, 3(5) ; Compute future callee base (caller_size)
252 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
253 : LD 1, 1(5) ; Load parameter 'n' into R1
254 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
258 : ST 6, 0(4) ; Store return address in callee frame
...
270 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
288 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
302 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
317 : SUB 1, 2, 1 ; Compute left - right for less-than
318 : JLT 1, 2(7) ; If < 0, jump to true
319 : LDC 1, 0(0) ; false
320 : LDA 7, 1(7) ; skip true assignment
321 : LDC 1, 1(0) ; true
322 : JEQ 1, 325(0) ; If condition false jump to ELSE
...
330 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
368 : LDA 4, 4(5) ; Compute future callee base (caller_size)
