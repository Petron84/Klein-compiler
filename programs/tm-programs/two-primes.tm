...
88 : ADD  3, 1, 0 ;  Save left operand
89 : LD   1, 1(5) ;  Load parameter 'm' into R1
90 : ADD  3, 1, 0 ;  Save left operand
...
116 : ADD  3, 1, 0 ;  Save left operand
...
142 : LD   2, 4(5) ;  Restore Temporary
...
175 : ADD  3, 1, 0 ;  Save right operand
176 : LD   1, 2(5) ;  Load parameter 'b' into R1
177 : LDA  4, 4(5) ; Restore Callee frame base
...
223 : ST   1, 4(5) ;  Spill Temporary
224 : LD   1, 1(5) ;  Load parameter 'i' into R1
225 : ADD  3, 1, 0 ;  Save left operand
...
242 : LD   2, 4(5) ;  Restore Temporary
...
312 : ST   1, 3(5) ;  Spill Temporary
313 : LD   1, 1(5) ;  Load parameter 'n' into R1
314 : ADD  3, 1, 0 ;  Save left operand
...
340 : LD   2, 3(5) ;  Restore Temporary
...
378 : LD   2, 3(5) ;  Restore Temporary
