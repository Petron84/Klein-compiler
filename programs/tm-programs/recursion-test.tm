...
48 : LDC 1, 1(0) ; true
49 : JEQ 1, 52(0) ; If condition false jump to ELSE
...
57 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
58 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
59 : LD 1, 2(5) ; Load parameter 'b' into R1
60 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
61 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
62 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
69 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
