...
58 : LDA 4, 5(5) ; Compute future callee base using caller_size
...
72 : LDA 4, 5(5) ; Compute future callee base using caller_size
...
134 : ST 1, 4(5) ; Store function result into frame return slot
