...
31 : LDA 4, 5(4) ; Recompute callee base from callee size
...
58 : LDA 4, 5(4) ; Recompute callee base from callee size
...
72 : LDA 4, 5(4) ; Recompute callee base from callee size
...
103 : LDA 4, 6(4) ; Recompute callee base from caller size
...
119 : LDA 4, 6(4) ; Recompute callee base from callee size
...
126 : LDA 4, 6(4) ; Recompute callee base from callee size
