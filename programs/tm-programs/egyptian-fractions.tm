...
30 : LDA  3, 4(5) ; Restore Callee frame base
31 : ST 1, 2(3) ;  Store argument 1 into callee frame
32 : LDA  3, 4(5) ; Restore Call frame base
...
40 : ST  1, 3(5) ;  Store left operand into return slot. Safeguard for recursion
...
63 : ST  1, 3(5) ;  Store left operand into return slot. Safeguard for recursion
64 : LD   1, 1(5) ;  Load parameter 'm' into R1
65 : LD  2, 3(5) ;  Restore left operand
66 : DIV  1, 2, 1 ;  R1 = left / right
67 : ST  1, 3(5) ;  Store left operand into return slot. Safeguard for recursion
...
72 : ST 1, 3(3) ;  Store argument 2 into callee frame
73 : LDA  3, 4(5) ; Restore Call frame base
...
86 : ST  1, 3(5) ;  Store left operand into return slot. Safeguard for recursion
...
92 : ST  1, 3(5) ;  Store left operand into return slot. Safeguard for recursion
...
102 : LDA  3, 5(5) ;  Update DMEM pointer
103 : LDA 6, 107(0) ;  Compute return address
104 : ST   6, 0(3) ;  Store return address
105 : ADD  5, 3, 0 ;  Updated Pointer
106 : LDA  7, 10(0) ; Call print
107 : LDC  4, 5(0) ;  Load frame size
108 : SUB  5, 5, 4 ;  Restore pointer
109 : ST   1, 4(5) ;  Store function result into stack frame
110 : LD   1, 3(5) ;  Load parameter 'unit' into R1
111 : ST  1, 4(5) ;  Store left operand into return slot. Safeguard for recursion
...
122 : ST  1, 4(5) ;  Store left operand into return slot. Safeguard for recursion
