...
31 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
57 : LDA  4, 4(5) ; Restore Callee frame base
58 : ST 1, 1(5) ;  Store argument 0 into callee frame
59 : LD   1, 2(5) ;  Load parameter 'n' into R1
60 : LDA  4, 4(5) ; Restore Callee frame base
61 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
72 : ST 1, 3(5) ;  Store argument 2 into callee frame
...
102 : LDA  4, 5(5) ;  Update DMEM pointer
