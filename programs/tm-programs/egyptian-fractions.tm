...
72 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
73 : ST 1, 3(4) ; Store argument 2 in callee param slot
74 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
119 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
120 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
126 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
127 : ST 1, 2(4) ; Store argument 1 in callee param slot
128 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
