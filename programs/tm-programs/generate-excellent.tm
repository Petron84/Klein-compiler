...
47 : ST 1, 4(0) ;  Store function-call result into caller's return slot
48 : LD   1, 4(0) ;  Load return value into register 1
49 : LD  6, 2(0) ;  Load return address for main function into register 6
