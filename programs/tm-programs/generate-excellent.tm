...
48 : LDC  4_original, 4(0) ;  Load frame size
...
55 : LDA  4, 5(5) ; Restore Callee frame base
56 : ST 1, 1(4) ;  Store argument 0 into callee frame
57 : LD   1, 2(5) ;  Load parameter 'n' into R1
58 : LDA  4, 5(5) ; Restore Callee frame base
59 : ST 1, 2(4) ;  Store argument 1 into callee frame
...
65 : LDA  4, 5(5) ; Restore Callee frame base
66 : ST 1, 3(4) ;  Store argument 2 into callee frame
67 : LDA  4, 5(5) ; Restore Call frame base
...
73 : LDC  4_original, 5(0) ;  Load frame size
...
79 : LDC  3, 1(0) ;  Store left operand into temporary register
...
100 : LDA  4, 4(5) ; Restore Callee frame base
...
105 : LDA  4, 4(5) ; Restore Call frame base
...
111 : LDC  4_original, 4(0) ;  Load frame size
112 : SUB  5, 5, 4_original ;  Restore pointer
113 : LDC  2, 3(0) ;  Restore left operand
114 : MUL  1, 2, 1 ;  R1 = left * right
115 : LDC  3, 1(0) ;  Store left operand into temporary register
116 : LDC  1, 4(0) ;  Load boolean-literal value into register 1
117 : LDC  3, 1(0) ;  Store left operand into temporary register
...
122 : LDA  4, 4(5) ; Restore Callee frame base
123 : ST 1, 2(4) ;  Store argument 1 into callee frame
124 : LDA  4, 4(5) ; Restore Call frame base
125 : LDA 6, 129(0) ;  Compute return address
126 : ST 6, 0(4) ;  Store return address in callee frame
127 : ADD  5, 4, 0 ;  Update pointer
128 : LDA 7, 858(0) ;  Call EXP
129 : LD 1, 3(5) ;  Load callee return value into R1
130 : LDC  4_original, 4(0) ;  Load frame size
131 : SUB  5, 5, 4_original ;  Restore pointer
132 : LDC  2, 3(0) ;  Restore left operand
133 : MUL  1, 2, 1 ;  R1 = left * right
134 : LDC  3, 1(0) ;  Store left operand into temporary register
135 : LD   1, 1(5) ;  Load parameter 'a' into R1
136 : LDC  2, 3(0) ;  Restore left operand
137 : MUL  1, 2, 1 ;  R1 = left * right
138 : LDC  2, 3(0) ;  Restore left operand
139 : ADD  1, 2, 1 ;  R1 = left + right
140 : LDC  3, 1(0) ;  Store left operand into temporary register
141 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
142 : LDC  2, 3(0) ;  Restore left operand
143 : ADD  1, 2, 1 ;  R1 = left + right
144 : LDA  4, 6(5) ; Restore Callee frame base
145 : ST 1, 4(4) ;  Store argument 3 into callee frame
146 : LDA  4, 6(5) ; Restore Call frame base
...
152 : LDC  4_original, 6(0) ;  Load frame size
153 : SUB  5, 5, 4_original ;  Restore pointer
...
160 : LDA  4, 7(5) ; Restore Callee frame base
161 : ST 1, 1(4) ;  Store argument 0 into callee frame
162 : LD   1, 2(5) ;  Load parameter 'n' into R1
163 : LDA  4, 7(5) ; Restore Callee frame base
164 : ST 1, 2(4) ;  Store argument 1 into callee frame
165 : LD   1, 3(5) ;  Load parameter 'upper' into R1
166 : LDA  4, 7(5) ; Restore Callee frame base
167 : ST 1, 3(4) ;  Store argument 2 into callee frame
168 : LD   1, 4(5) ;  Load parameter 'det' into R1
169 : LDA  4, 7(5) ; Restore Callee frame base
170 : ST 1, 4(4) ;  Store argument 3 into callee frame
171 : LD   1, 4(5) ;  Load parameter 'det' into R1
172 : LDA  4, 3(5) ; Restore Callee frame base
173 : ST 1, 1(4) ;  Store argument 0 into callee frame
174 : LDA  4, 3(5) ; Restore Call frame base
...
180 : LDC  4_original, 3(0) ;  Load frame size
181 : SUB  5, 5, 4_original ;  Restore pointer
182 : LDA  4, 7(5) ; Restore Callee frame base
183 : ST 1, 5(4) ;  Store argument 4 into callee frame
184 : LDA  4, 7(5) ; Restore Call frame base
...
190 : LDC  4_original, 7(0) ;  Load frame size
191 : SUB  5, 5, 4_original ;  Restore pointer
...
196 : LDA  4, 8(5) ; Restore Callee frame base
197 : ST 1, 1(4) ;  Store argument 0 into callee frame
198 : LD   1, 2(5) ;  Load parameter 'n' into R1
199 : LDA  4, 8(5) ; Restore Callee frame base
200 : ST 1, 2(4) ;  Store argument 1 into callee frame
201 : LD   1, 3(5) ;  Load parameter 'upper' into R1
202 : LDA  4, 8(5) ; Restore Callee frame base
203 : ST 1, 3(4) ;  Store argument 2 into callee frame
204 : LD   1, 4(5) ;  Load parameter 'det' into R1
205 : LDA  4, 8(5) ; Restore Callee frame base
206 : ST 1, 4(4) ;  Store argument 3 into callee frame
207 : LD   1, 5(5) ;  Load parameter 'root' into R1
208 : LDA  4, 8(5) ; Restore Callee frame base
209 : ST 1, 5(4) ;  Store argument 4 into callee frame
210 : LD   1, 1(5) ;  Load parameter 'a' into R1
211 : LDC  3, 1(0) ;  Store left operand into temporary register
...
228 : LDC  3, 1(0) ;  Store left operand into temporary register
229 : LD   1, 5(5) ;  Load parameter 'root' into R1
230 : LDC  3, 1(0) ;  Store left operand into temporary register
231 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
232 : LDC  2, 3(0) ;  Restore left operand
233 : ADD  1, 2, 1 ;  R1 = left + right
234 : LDC  3, 1(0) ;  Store left operand into temporary register
235 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
236 : LDC  2, 3(0) ;  Restore left operand
237 : DIV  1, 2, 1 ;  R1 = left / right
238 : LDC  2, 3(0) ;  Restore left operand
239 : ADD  1, 2, 1 ;  R1 = left + right
240 : LDA  4, 8(5) ; Restore Callee frame base
241 : ST 1, 6(4) ;  Store argument 5 into callee frame
242 : LDA  4, 8(5) ; Restore Call frame base
243 : LDA 6, 247(0) ;  Compute return address
244 : ST 6, 0(4) ;  Store return address in callee frame
245 : ADD  5, 4, 0 ;  Update pointer
246 : LDA 7, 253(0) ;  Call aLoop3
247 : LD 1, 7(5) ;  Load callee return value into R1
248 : LDC  4_original, 8(0) ;  Load frame size
249 : SUB  5, 5, 4_original ;  Restore pointer
...
254 : LDA  4, 4(5) ; Restore Callee frame base
255 : ST 1, 1(4) ;  Store argument 0 into callee frame
256 : LD   1, 4(5) ;  Load parameter 'det' into R1
257 : LDA  4, 4(5) ; Restore Callee frame base
258 : ST 1, 2(4) ;  Store argument 1 into callee frame
259 : LDA  4, 4(5) ; Restore Call frame base
...
265 : LDC  4_original, 4(0) ;  Load frame size
266 : SUB  5, 5, 4_original ;  Restore pointer
267 : LDC  3, 1(0) ;  Store left operand into temporary register
268 : LD   1, 5(5) ;  Load parameter 'root' into R1
269 : LDC  3, 1(0) ;  Store left operand into temporary register
270 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
271 : LDC  2, 3(0) ;  Restore left operand
272 : ADD  1, 2, 1 ;  R1 = left + right
273 : LDA  4, 3(5) ; Restore Callee frame base
274 : ST 1, 1(4) ;  Store argument 0 into callee frame
275 : LDA  4, 3(5) ; Restore Call frame base
276 : LDA 6, 280(0) ;  Compute return address
277 : ST 6, 0(4) ;  Store return address in callee frame
278 : ADD  5, 4, 0 ;  Update pointer
279 : LDA 7, 609(0) ;  Call EVEN
280 : LD 1, 2(5) ;  Load callee return value into R1
281 : LDC  4_original, 3(0) ;  Load frame size
282 : SUB  5, 5, 4_original ;  Restore pointer
283 : LDC  2, 3(0) ;  Restore left operand
284 : MUL  1, 2, 1 ;  R1 = left AND right
285 : LDC  3, 1(0) ;  Store left operand into temporary register
286 : LD   1, 6(5) ;  Load parameter 'candidate' into R1
287 : LDA  4, 3(5) ; Restore Callee frame base
288 : ST 1, 1(4) ;  Store argument 0 into callee frame
289 : LDA  4, 3(5) ; Restore Call frame base
290 : LDA 6, 294(0) ;  Compute return address
291 : ST 6, 0(4) ;  Store return address in callee frame
292 : ADD  5, 4, 0 ;  Update pointer
293 : LDA 7, 378(0) ;  Call isExcellent
294 : LD 1, 2(5) ;  Load callee return value into R1
295 : LDC  4_original, 3(0) ;  Load frame size
296 : SUB  5, 5, 4_original ;  Restore pointer
297 : LDC  2, 3(0) ;  Restore left operand
298 : MUL  1, 2, 1 ;  R1 = left AND right
299 : JEQ  1, 321(0) ;  If condition is false, jump to ELSE
300 : LD   1, 1(5) ;  Load parameter 'a' into R1
301 : LDA  4, 6(5) ; Restore Callee frame base
302 : ST 1, 1(4) ;  Store argument 0 into callee frame
303 : LD   1, 2(5) ;  Load parameter 'n' into R1
304 : LDA  4, 6(5) ; Restore Callee frame base
305 : ST 1, 2(4) ;  Store argument 1 into callee frame
306 : LD   1, 3(5) ;  Load parameter 'upper' into R1
307 : LDA  4, 6(5) ; Restore Callee frame base
308 : ST 1, 3(4) ;  Store argument 2 into callee frame
309 : LD   1, 6(5) ;  Load parameter 'candidate' into R1
310 : LDA  4, 6(5) ; Restore Callee frame base
311 : ST 1, 4(4) ;  Store argument 3 into callee frame
312 : LDA  4, 6(5) ; Restore Call frame base
313 : LDA 6, 317(0) ;  Compute return address
314 : ST 6, 0(4) ;  Store return address in callee frame
315 : ADD  5, 4, 0 ;  Update pointer
316 : LDA 7, 345(0) ;  Call printCandidateAndContinue
317 : LD 1, 5(5) ;  Load callee return value into R1
318 : LDC  4_original, 6(0) ;  Load frame size
319 : SUB  5, 5, 4_original ;  Restore pointer
320 : LDA  7, 342(0) ;  Skip ELSE block
321 : LD   1, 1(5) ;  Load parameter 'a' into R1
322 : LDC  3, 1(0) ;  Store left operand into temporary register
323 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
324 : LDC  2, 3(0) ;  Restore left operand
325 : ADD  1, 2, 1 ;  R1 = left + right
326 : LDA  4, 5(5) ; Restore Callee frame base
327 : ST 1, 1(4) ;  Store argument 0 into callee frame
328 : LD   1, 2(5) ;  Load parameter 'n' into R1
329 : LDA  4, 5(5) ; Restore Callee frame base
330 : ST 1, 2(4) ;  Store argument 1 into callee frame
331 : LD   1, 3(5) ;  Load parameter 'upper' into R1
332 : LDA  4, 5(5) ; Restore Callee frame base
333 : ST 1, 3(4) ;  Store argument 2 into callee frame
334 : LDA  4, 5(5) ; Restore Call frame base
...
340 : LDC  4_original, 5(0) ;  Load frame size
341 : SUB  5, 5, 4_original ;  Restore pointer
...
346 : LDA  4, 3(5) ;  Update DMEM pointer
347 : LDA 6, 351(0) ;  Compute return address
348 : ST   6, 0(4) ;  Store return address
349 : ADD  5, 4, 0 ;  Updated Pointer
350 : LDA  7, 8(0) ; Call print
351 : LDC  4_original, 3(0) ;  Load frame size
...
355 : LDC  3, 1(0) ;  Store left operand into temporary register
356 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
357 : LDC  2, 3(0) ;  Restore left operand
358 : ADD  1, 2, 1 ;  R1 = left + right
359 : LDA  4, 5(5) ; Restore Callee frame base
360 : ST 1, 1(4) ;  Store argument 0 into callee frame
361 : LD   1, 2(5) ;  Load parameter 'n' into R1
362 : LDA  4, 5(5) ; Restore Callee frame base
363 : ST 1, 2(4) ;  Store argument 1 into callee frame
364 : LD   1, 3(5) ;  Load parameter 'upper' into R1
365 : LDA  4, 5(5) ; Restore Callee frame base
366 : ST 1, 3(4) ;  Store argument 2 into callee frame
367 : LDA  4, 5(5) ; Restore Call frame base
...
373 : LDC  4_original, 5(0) ;  Load frame size
374 : SUB  5, 5, 4_original ;  Restore pointer
...
379 : LDA  4, 4(5) ; Restore Callee frame base
...
383 : ST 1, 1(4) ;  Store argument 0 into callee frame
384 : LDA  4, 3(5) ; Restore Call frame base
385 : LDA 6, 389(0) ;  Compute return address
386 : ST 6, 0(4) ;  Store return address in callee frame
387 : ADD  5, 4, 0 ;  Update pointer
388 : LDA 7, 559(0) ;  Call length
389 : LD 1, 2(5) ;  Load callee return value into R1
390 : LDC  4_original, 3(0) ;  Load frame size
391 : SUB  5, 5, 4_original ;  Restore pointer
...
400 : LDC  4_original, 4(0) ;  Load frame size
401 : SUB  5, 5, 4_original ;  Restore pointer
...
406 : LDA  4, 3(5) ; Restore Callee frame base
407 : ST 1, 1(4) ;  Store argument 0 into callee frame
408 : LDA  4, 3(5) ; Restore Call frame base
409 : LDA 6, 413(0) ;  Compute return address
410 : ST 6, 0(4) ;  Store return address in callee frame
411 : ADD  5, 4, 0 ;  Update pointer
412 : LDA 7, 815(0) ;  Call ODD
413 : LD 1, 2(5) ;  Load callee return value into R1
414 : LDC  4_original, 3(0) ;  Load frame size
415 : SUB  5, 5, 4_original ;  Restore pointer
...
420 : LDC  3, 1(0) ;  Store left operand into temporary register
421 : LD   1, 1(5) ;  Load parameter 'n' into R1
422 : LDA  4, 3(5) ; Restore Callee frame base
423 : ST 1, 1(4) ;  Store argument 0 into callee frame
424 : LDA  4, 3(5) ; Restore Call frame base
...
430 : LDC  4_original, 3(0) ;  Load frame size
431 : SUB  5, 5, 4_original ;  Restore pointer
432 : LDA  4, 4(5) ; Restore Callee frame base
...
445 : LDA  4, 4(5) ; Restore Callee frame base
446 : ST 1, 2(4) ;  Store argument 1 into callee frame
447 : LDA  4, 4(5) ; Restore Call frame base
448 : LDA 6, 452(0) ;  Compute return address
449 : ST 6, 0(4) ;  Store return address in callee frame
450 : ADD  5, 4, 0 ;  Update pointer
451 : LDA 7, 464(0) ;  Call excellentDiff
452 : LD 1, 3(5) ;  Load callee return value into R1
453 : LDC  4_original, 4(0) ;  Load frame size
454 : SUB  5, 5, 4_original ;  Restore pointer
455 : LDC  2, 3(0) ;  Restore left operand
...
465 : LDC  3, 1(0) ;  Store left operand into temporary register
466 : LD   1, 2(5) ;  Load parameter 'b' into R1
467 : LDC  2, 3(0) ;  Restore left operand
468 : MUL  1, 2, 1 ;  R1 = left * right
469 : LDC  3, 1(0) ;  Store left operand into temporary register
470 : LD   1, 1(5) ;  Load parameter 'a' into R1
471 : LDC  3, 1(0) ;  Store left operand into temporary register
472 : LD   1, 1(5) ;  Load parameter 'a' into R1
473 : LDC  2, 3(0) ;  Restore left operand
474 : MUL  1, 2, 1 ;  R1 = left * right
475 : LDC  2, 3(0) ;  Restore left operand
...
481 : LDA  4, 4(5) ; Restore Callee frame base
482 : ST 1, 1(4) ;  Store argument 0 into callee frame
483 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
484 : LDA  4, 4(5) ; Restore Callee frame base
485 : ST 1, 1(4) ;  Store argument 0 into callee frame
486 : LD   1, 1(5) ;  Load parameter 'n' into R1
487 : LDA  4, 3(5) ; Restore Callee frame base
488 : ST 1, 1(4) ;  Store argument 0 into callee frame
489 : LDA  4, 3(5) ; Restore Call frame base
...
495 : LDC  4_original, 3(0) ;  Load frame size
496 : SUB  5, 5, 4_original ;  Restore pointer
497 : LDC  3, 1(0) ;  Store left operand into temporary register
498 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
499 : LDC  2, 3(0) ;  Restore left operand
500 : DIV  1, 2, 1 ;  R1 = left / right
501 : LDA  4, 4(5) ; Restore Callee frame base
502 : ST 1, 2(4) ;  Store argument 1 into callee frame
503 : LDA  4, 4(5) ; Restore Call frame base
504 : LDA 6, 508(0) ;  Compute return address
505 : ST 6, 0(4) ;  Store return address in callee frame
506 : ADD  5, 4, 0 ;  Update pointer
507 : LDA 7, 858(0) ;  Call EXP
508 : LD 1, 3(5) ;  Load callee return value into R1
509 : LDC  4_original, 4(0) ;  Load frame size
510 : SUB  5, 5, 4_original ;  Restore pointer
511 : LDA  4, 4(5) ; Restore Callee frame base
512 : ST 1, 2(4) ;  Store argument 1 into callee frame
513 : LDA  4, 4(5) ; Restore Call frame base
514 : LDA 6, 518(0) ;  Compute return address
515 : ST 6, 0(4) ;  Store return address in callee frame
516 : ADD  5, 4, 0 ;  Update pointer
517 : LDA 7, 895(0) ;  Call MOD
518 : LD 1, 3(5) ;  Load callee return value into R1
519 : LDC  4_original, 4(0) ;  Load frame size
520 : SUB  5, 5, 4_original ;  Restore pointer
...
527 : LDA  4, 4(5) ; Restore Callee frame base
528 : ST 1, 1(4) ;  Store argument 0 into callee frame
529 : LD   1, 1(5) ;  Load parameter 'n' into R1
530 : LDA  4, 3(5) ; Restore Callee frame base
531 : ST 1, 1(4) ;  Store argument 0 into callee frame
532 : LDA  4, 3(5) ; Restore Call frame base
533 : LDA 6, 537(0) ;  Compute return address
534 : ST 6, 0(4) ;  Store return address in callee frame
535 : ADD  5, 4, 0 ;  Update pointer
536 : LDA 7, 559(0) ;  Call length
537 : LD 1, 2(5) ;  Load callee return value into R1
538 : LDC  4_original, 3(0) ;  Load frame size
539 : SUB  5, 5, 4_original ;  Restore pointer
540 : LDC  3, 1(0) ;  Store left operand into temporary register
541 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
542 : LDC  2, 3(0) ;  Restore left operand
...
552 : LDC  4_original, 4(0) ;  Load frame size
553 : SUB  5, 5, 4_original ;  Restore pointer
554 : LDC  2, 3(0) ;  Restore left operand
...
560 : LDC  3, 1(0) ;  Store left operand into temporary register
561 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
562 : LDC  2, 3(0) ;  Restore left operand
...
572 : LDC  3, 1(0) ;  Store left operand into temporary register
573 : LD   1, 1(5) ;  Load parameter 'n' into R1
574 : LDC  3, 1(0) ;  Store left operand into temporary register
575 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
576 : LDC  2, 3(0) ;  Restore left operand
577 : DIV  1, 2, 1 ;  R1 = left / right
578 : LDA  4, 3(5) ; Restore Callee frame base
579 : ST 1, 1(4) ;  Store argument 0 into callee frame
580 : LDA  4, 3(5) ; Restore Call frame base
...
586 : LDC  4_original, 3(0) ;  Load frame size
587 : SUB  5, 5, 4_original ;  Restore pointer
588 : LDC  2, 3(0) ;  Restore left operand
...
594 : LDC  3, 1(0) ;  Store left operand into temporary register
595 : LD   1, 1(5) ;  Load parameter 'r' into R1
596 : LDC  3, 1(0) ;  Store left operand into temporary register
597 : LD   1, 1(5) ;  Load parameter 'r' into R1
598 : LDC  2, 3(0) ;  Restore left operand
599 : MUL  1, 2, 1 ;  R1 = left * right
600 : LDC  2, 3(0) ;  Restore left operand
...
610 : LDC  3, 1(0) ;  Store left operand into temporary register
611 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
612 : LDC  3, 1(0) ;  Store left operand into temporary register
613 : LD   1, 1(5) ;  Load parameter 'n' into R1
614 : LDC  3, 1(0) ;  Store left operand into temporary register
615 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
616 : LDC  2, 3(0) ;  Restore left operand
617 : DIV  1, 2, 1 ;  R1 = left / right
618 : LDC  2, 3(0) ;  Restore left operand
619 : MUL  1, 2, 1 ;  R1 = left * right
620 : LDC  2, 3(0) ;  Restore left operand
...
630 : LDC  3, 1(0) ;  Store left operand into temporary register
631 : LD   1, 4(5) ;  Load parameter 'mid' into R1
632 : LDC  2, 3(0) ;  Restore left operand
633 : MUL  1, 2, 1 ;  R1 = left * right
634 : LDA  4, 4(5) ; Restore Callee frame base
635 : ST 1, 1(4) ;  Store argument 0 into callee frame
636 : LD   1, 1(5) ;  Load parameter 'n' into R1
637 : LDA  4, 4(5) ; Restore Callee frame base
638 : ST 1, 2(4) ;  Store argument 1 into callee frame
639 : LDA  4, 4(5) ; Restore Call frame base
640 : LDA 6, 644(0) ;  Compute return address
641 : ST 6, 0(4) ;  Store return address in callee frame
642 : ADD  5, 4, 0 ;  Update pointer
643 : LDA 7, 791(0) ;  Call LE
644 : LD 1, 3(5) ;  Load callee return value into R1
645 : LDC  4_original, 4(0) ;  Load frame size
646 : SUB  5, 5, 4_original ;  Restore pointer
647 : JEQ  1, 666(0) ;  If condition is false, jump to ELSE
648 : LD   1, 1(5) ;  Load parameter 'n' into R1
649 : LDA  4, 5(5) ; Restore Callee frame base
650 : ST 1, 1(4) ;  Store argument 0 into callee frame
651 : LD   1, 4(5) ;  Load parameter 'mid' into R1
652 : LDA  4, 5(5) ; Restore Callee frame base
653 : ST 1, 2(4) ;  Store argument 1 into callee frame
654 : LD   1, 3(5) ;  Load parameter 'high' into R1
655 : LDA  4, 5(5) ; Restore Callee frame base
656 : ST 1, 3(4) ;  Store argument 2 into callee frame
657 : LDA  4, 5(5) ; Restore Call frame base
658 : LDA 6, 662(0) ;  Compute return address
659 : ST 6, 0(4) ;  Store return address in callee frame
660 : ADD  5, 4, 0 ;  Update pointer
661 : LDA 7, 686(0) ;  Call SQRTSEARCH
662 : LD 1, 4(5) ;  Load callee return value into R1
663 : LDC  4_original, 5(0) ;  Load frame size
664 : SUB  5, 5, 4_original ;  Restore pointer
665 : LDA  7, 683(0) ;  Skip ELSE block
666 : LD   1, 1(5) ;  Load parameter 'n' into R1
667 : LDA  4, 5(5) ; Restore Callee frame base
668 : ST 1, 1(4) ;  Store argument 0 into callee frame
669 : LD   1, 2(5) ;  Load parameter 'low' into R1
670 : LDA  4, 5(5) ; Restore Callee frame base
671 : ST 1, 2(4) ;  Store argument 1 into callee frame
672 : LD   1, 4(5) ;  Load parameter 'mid' into R1
673 : LDA  4, 5(5) ; Restore Callee frame base
674 : ST 1, 3(4) ;  Store argument 2 into callee frame
675 : LDA  4, 5(5) ; Restore Call frame base
676 : LDA 6, 680(0) ;  Compute return address
677 : ST 6, 0(4) ;  Store return address in callee frame
678 : ADD  5, 4, 0 ;  Update pointer
679 : LDA 7, 686(0) ;  Call SQRTSEARCH
680 : LD 1, 4(5) ;  Load callee return value into R1
681 : LDC  4_original, 5(0) ;  Load frame size
682 : SUB  5, 5, 4_original ;  Restore pointer
...
687 : LDA  4, 4(5) ; Restore Callee frame base
688 : ST 1, 1(4) ;  Store argument 0 into callee frame
689 : LD   1, 2(5) ;  Load parameter 'low' into R1
690 : LDC  3, 1(0) ;  Store left operand into temporary register
691 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
692 : LDC  2, 3(0) ;  Restore left operand
693 : ADD  1, 2, 1 ;  R1 = left + right
694 : LDA  4, 4(5) ; Restore Callee frame base
695 : ST 1, 2(4) ;  Store argument 1 into callee frame
696 : LDA  4, 4(5) ; Restore Call frame base
697 : LDA 6, 701(0) ;  Compute return address
698 : ST 6, 0(4) ;  Store return address in callee frame
699 : ADD  5, 4, 0 ;  Update pointer
700 : LDA 7, 791(0) ;  Call LE
701 : LD 1, 3(5) ;  Load callee return value into R1
702 : LDC  4_original, 4(0) ;  Load frame size
703 : SUB  5, 5, 4_original ;  Restore pointer
704 : JEQ  1, 740(0) ;  If condition is false, jump to ELSE
705 : LD   1, 1(5) ;  Load parameter 'n' into R1
706 : LDC  3, 1(0) ;  Store left operand into temporary register
707 : LD   1, 2(5) ;  Load parameter 'low' into R1
708 : LDC  3, 1(0) ;  Store left operand into temporary register
709 : LD   1, 2(5) ;  Load parameter 'low' into R1
710 : LDC  2, 3(0) ;  Restore left operand
711 : MUL  1, 2, 1 ;  R1 = left * right
712 : LDC  2, 3(0) ;  Restore left operand
713 : SUB  1, 2, 1 ;  R1 = left - right
714 : LDA  4, 4(5) ; Restore Callee frame base
715 : ST 1, 1(4) ;  Store argument 0 into callee frame
716 : LD   1, 3(5) ;  Load parameter 'high' into R1
717 : LDC  3, 1(0) ;  Store left operand into temporary register
718 : LD   1, 3(5) ;  Load parameter 'high' into R1
719 : LDC  2, 3(0) ;  Restore left operand
720 : MUL  1, 2, 1 ;  R1 = left * right
721 : LDC  3, 1(0) ;  Store left operand into temporary register
722 : LD   1, 1(5) ;  Load parameter 'n' into R1
723 : LDC  2, 3(0) ;  Restore left operand
724 : SUB  1, 2, 1 ;  R1 = left - right
725 : LDA  4, 4(5) ; Restore Callee frame base
726 : ST 1, 2(4) ;  Store argument 1 into callee frame
727 : LDA  4, 4(5) ; Restore Call frame base
728 : LDA 6, 732(0) ;  Compute return address
729 : ST 6, 0(4) ;  Store return address in callee frame
730 : ADD  5, 4, 0 ;  Update pointer
731 : LDA 7, 791(0) ;  Call LE
732 : LD 1, 3(5) ;  Load callee return value into R1
733 : LDC  4_original, 4(0) ;  Load frame size
734 : SUB  5, 5, 4_original ;  Restore pointer
...
741 : LDA  4, 6(5) ; Restore Callee frame base
742 : ST 1, 1(4) ;  Store argument 0 into callee frame
743 : LD   1, 2(5) ;  Load parameter 'low' into R1
744 : LDA  4, 6(5) ; Restore Callee frame base
745 : ST 1, 2(4) ;  Store argument 1 into callee frame
746 : LD   1, 3(5) ;  Load parameter 'high' into R1
747 : LDA  4, 6(5) ; Restore Callee frame base
748 : ST 1, 3(4) ;  Store argument 2 into callee frame
749 : LD   1, 2(5) ;  Load parameter 'low' into R1
750 : LDC  3, 1(0) ;  Store left operand into temporary register
751 : LD   1, 3(5) ;  Load parameter 'high' into R1
752 : LDC  2, 3(0) ;  Restore left operand
753 : ADD  1, 2, 1 ;  R1 = left + right
754 : LDC  3, 1(0) ;  Store left operand into temporary register
755 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
756 : LDC  2, 3(0) ;  Restore left operand
757 : DIV  1, 2, 1 ;  R1 = left / right
758 : LDA  4, 6(5) ; Restore Callee frame base
759 : ST 1, 4(4) ;  Store argument 3 into callee frame
760 : LDA  4, 6(5) ; Restore Call frame base
761 : LDA 6, 765(0) ;  Compute return address
762 : ST 6, 0(4) ;  Store return address in callee frame
763 : ADD  5, 4, 0 ;  Update pointer
764 : LDA 7, 629(0) ;  Call SQRTSPLIT
765 : LD 1, 5(5) ;  Load callee return value into R1
766 : LDC  4_original, 6(0) ;  Load frame size
767 : SUB  5, 5, 4_original ;  Restore pointer
...
772 : LDA  4, 5(5) ; Restore Callee frame base
773 : ST 1, 1(4) ;  Store argument 0 into callee frame
774 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
775 : LDA  4, 5(5) ; Restore Callee frame base
776 : ST 1, 2(4) ;  Store argument 1 into callee frame
777 : LD   1, 1(5) ;  Load parameter 'n' into R1
778 : LDA  4, 5(5) ; Restore Callee frame base
779 : ST 1, 3(4) ;  Store argument 2 into callee frame
780 : LDA  4, 5(5) ; Restore Call frame base
781 : LDA 6, 785(0) ;  Compute return address
782 : ST 6, 0(4) ;  Store return address in callee frame
783 : ADD  5, 4, 0 ;  Update pointer
784 : LDA 7, 686(0) ;  Call SQRTSEARCH
785 : LD 1, 4(5) ;  Load callee return value into R1
786 : LDC  4_original, 5(0) ;  Load frame size
787 : SUB  5, 5, 4_original ;  Restore pointer
...
816 : LDC  3, 1(0) ;  Store left operand into temporary register
817 : LD   1, 1(5) ;  Load parameter 'n' into R1
818 : LDC  2, 3(0) ;  Restore left operand
...
826 : LDC  3, 1(0) ;  Store left operand into temporary register
827 : LD   1, 1(5) ;  Load parameter 'n' into R1
828 : LDC  3, 1(0) ;  Store left operand into temporary register
829 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
830 : LDC  2, 3(0) ;  Restore left operand
831 : DIV  1, 2, 1 ;  R1 = left / right
832 : LDC  2, 3(0) ;  Restore left operand
833 : MUL  1, 2, 1 ;  R1 = left * right
834 : LDC  3, 1(0) ;  Store left operand into temporary register
835 : LD   1, 1(5) ;  Load parameter 'n' into R1
836 : LDC  2, 3(0) ;  Restore left operand
...
845 : LDA  4, 3(5) ; Restore Callee frame base
846 : ST 1, 1(4) ;  Store argument 0 into callee frame
847 : LDA  4, 3(5) ; Restore Call frame base
848 : LDA 6, 852(0) ;  Compute return address
849 : ST 6, 0(4) ;  Store return address in callee frame
850 : ADD  5, 4, 0 ;  Update pointer
851 : LDA 7, 815(0) ;  Call ODD
852 : LD 1, 2(5) ;  Load callee return value into R1
853 : LDC  4_original, 3(0) ;  Load frame size
854 : SUB  5, 5, 4_original ;  Restore pointer
...
859 : LDC  3, 1(0) ;  Store left operand into temporary register
860 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
861 : LDC  2, 3(0) ;  Restore left operand
...
871 : LDC  3, 1(0) ;  Store left operand into temporary register
872 : LD   1, 1(5) ;  Load parameter 'm' into R1
873 : LDA  4, 4(5) ; Restore Callee frame base
874 : ST 1, 1(4) ;  Store argument 0 into callee frame
875 : LD   1, 2(5) ;  Load parameter 'n' into R1
876 : LDC  3, 1(0) ;  Store left operand into temporary register
877 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
878 : LDC  2, 3(0) ;  Restore left operand
879 : SUB  1, 2, 1 ;  R1 = left - right
880 : LDA  4, 4(5) ; Restore Callee frame base
881 : ST 1, 2(4) ;  Store argument 1 into callee frame
882 : LDA  4, 4(5) ; Restore Call frame base
883 : LDA 6, 887(0) ;  Compute return address
884 : ST 6, 0(4) ;  Store return address in callee frame
885 : ADD  5, 4, 0 ;  Update pointer
886 : LDA 7, 858(0) ;  Call EXP
887 : LD 1, 3(5) ;  Load callee return value into R1
888 : LDC  4_original, 4(0) ;  Load frame size
889 : SUB  5, 5, 4_original ;  Restore pointer
890 : LDC  2, 3(0) ;  Restore left operand
...
896 : LDC  3, 1(0) ;  Store left operand into temporary register
897 : LD   1, 2(5) ;  Load parameter 'n' into R1
898 : LDC  3, 1(0) ;  Store left operand into temporary register
899 : LD   1, 1(5) ;  Load parameter 'm' into R1
900 : LDC  3, 1(0) ;  Store left operand into temporary register
901 : LD   1, 2(5) ;  Load parameter 'n' into R1
902 : LDC  2, 3(0) ;  Restore left operand
903 : DIV  1, 2, 1 ;  R1 = left / right
904 : LDC  2, 3(0) ;  Restore left operand
905 : MUL  1, 2, 1 ;  R1 = left * right
906 : LDC  2, 3(0) ;  Restore left operand
