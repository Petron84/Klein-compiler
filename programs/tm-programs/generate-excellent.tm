...
13 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
23 : LDA  4, 3(5) ; Restore Callee frame base
24 : ST 1, 2(5) ;  Store argument 1 into callee frame
25 : LDA  4, 3(5) ; Restore Call frame base
...
34 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
40 : LDA  4, 3(5) ; Restore Callee frame base
41 : ST 1, 2(5) ;  Store argument 1 into callee frame
42 : LDA  4, 3(5) ; Restore Call frame base
...
55 : LDA  4, 4(5) ; Restore Callee frame base
56 : ST 1, 1(5) ;  Store argument 0 into callee frame
57 : LD   1, 2(5) ;  Load parameter 'n' into R1
58 : LDA  4, 4(5) ; Restore Callee frame base
59 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
66 : ST 1, 3(5) ;  Store argument 2 into callee frame
...
89 : LDA  4, 5(5) ; Restore Callee frame base
90 : ST 1, 1(5) ;  Store argument 0 into callee frame
91 : LD   1, 2(5) ;  Load parameter 'n' into R1
92 : LDA  4, 5(5) ; Restore Callee frame base
93 : ST 1, 2(5) ;  Store argument 1 into callee frame
94 : LD   1, 3(5) ;  Load parameter 'upper' into R1
95 : LDA  4, 5(5) ; Restore Callee frame base
96 : ST 1, 3(5) ;  Store argument 2 into callee frame
...
119 : LDA  4, 5(5) ; Restore Callee frame base
120 : ST 1, 1(5) ;  Store argument 0 into callee frame
121 : LD   1, 2(5) ;  Load parameter 'n' into R1
122 : LDA  4, 5(5) ; Restore Callee frame base
123 : ST 1, 2(5) ;  Store argument 1 into callee frame
124 : LDA  4, 5(5) ; Restore Call frame base
...
144 : LDA  4, 5(5) ; Restore Callee frame base
145 : ST 1, 4(5) ;  Store argument 3 into callee frame
146 : LDA  4, 5(5) ; Restore Call frame base
...
160 : LDA  4, 6(5) ; Restore Callee frame base
161 : ST 1, 1(5) ;  Store argument 0 into callee frame
162 : LD   1, 2(5) ;  Load parameter 'n' into R1
163 : LDA  4, 6(5) ; Restore Callee frame base
164 : ST 1, 2(5) ;  Store argument 1 into callee frame
165 : LD   1, 3(5) ;  Load parameter 'upper' into R1
166 : LDA  4, 6(5) ; Restore Callee frame base
167 : ST 1, 3(5) ;  Store argument 2 into callee frame
168 : LD   1, 4(5) ;  Load parameter 'det' into R1
169 : LDA  4, 6(5) ; Restore Callee frame base
170 : ST 1, 4(5) ;  Store argument 3 into callee frame
171 : LD   1, 4(5) ;  Load parameter 'det' into R1
172 : LDA  4, 6(5) ; Restore Callee frame base
173 : ST 1, 1(5) ;  Store argument 0 into callee frame
174 : LDA  4, 6(5) ; Restore Call frame base
...
182 : LDA  4, 6(5) ; Restore Callee frame base
183 : ST 1, 5(5) ;  Store argument 4 into callee frame
184 : LDA  4, 6(5) ; Restore Call frame base
...
196 : LDA  4, 7(5) ; Restore Callee frame base
197 : ST 1, 1(5) ;  Store argument 0 into callee frame
198 : LD   1, 2(5) ;  Load parameter 'n' into R1
199 : LDA  4, 7(5) ; Restore Callee frame base
200 : ST 1, 2(5) ;  Store argument 1 into callee frame
201 : LD   1, 3(5) ;  Load parameter 'upper' into R1
202 : LDA  4, 7(5) ; Restore Callee frame base
203 : ST 1, 3(5) ;  Store argument 2 into callee frame
204 : LD   1, 4(5) ;  Load parameter 'det' into R1
205 : LDA  4, 7(5) ; Restore Callee frame base
206 : ST 1, 4(5) ;  Store argument 3 into callee frame
207 : LD   1, 5(5) ;  Load parameter 'root' into R1
208 : LDA  4, 7(5) ; Restore Callee frame base
209 : ST 1, 5(5) ;  Store argument 4 into callee frame
...
213 : LDA  4, 7(5) ; Restore Callee frame base
214 : ST 1, 1(5) ;  Store argument 0 into callee frame
215 : LD   1, 2(5) ;  Load parameter 'n' into R1
216 : LDA  4, 7(5) ; Restore Callee frame base
217 : ST 1, 2(5) ;  Store argument 1 into callee frame
218 : LDA  4, 7(5) ; Restore Call frame base
...
240 : LDA  4, 7(5) ; Restore Callee frame base
241 : ST 1, 6(5) ;  Store argument 5 into callee frame
242 : LDA  4, 7(5) ; Restore Call frame base
...
254 : LDA  4, 8(5) ; Restore Callee frame base
255 : ST 1, 1(5) ;  Store argument 0 into callee frame
256 : LD   1, 4(5) ;  Load parameter 'det' into R1
257 : LDA  4, 8(5) ; Restore Callee frame base
258 : ST 1, 2(5) ;  Store argument 1 into callee frame
259 : LDA  4, 8(5) ; Restore Call frame base
...
273 : LDA  4, 8(5) ; Restore Callee frame base
274 : ST 1, 1(5) ;  Store argument 0 into callee frame
275 : LDA  4, 8(5) ; Restore Call frame base
...
287 : LDA  4, 8(5) ; Restore Callee frame base
288 : ST 1, 1(5) ;  Store argument 0 into callee frame
289 : LDA  4, 8(5) ; Restore Call frame base
...
301 : LDA  4, 8(5) ; Restore Callee frame base
302 : ST 1, 1(5) ;  Store argument 0 into callee frame
303 : LD   1, 2(5) ;  Load parameter 'n' into R1
304 : LDA  4, 8(5) ; Restore Callee frame base
305 : ST 1, 2(5) ;  Store argument 1 into callee frame
306 : LD   1, 3(5) ;  Load parameter 'upper' into R1
307 : LDA  4, 8(5) ; Restore Callee frame base
308 : ST 1, 3(5) ;  Store argument 2 into callee frame
309 : LD   1, 6(5) ;  Load parameter 'candidate' into R1
310 : LDA  4, 8(5) ; Restore Callee frame base
311 : ST 1, 4(5) ;  Store argument 3 into callee frame
312 : LDA  4, 8(5) ; Restore Call frame base
...
326 : LDA  4, 8(5) ; Restore Callee frame base
327 : ST 1, 1(5) ;  Store argument 0 into callee frame
328 : LD   1, 2(5) ;  Load parameter 'n' into R1
329 : LDA  4, 8(5) ; Restore Callee frame base
330 : ST 1, 2(5) ;  Store argument 1 into callee frame
331 : LD   1, 3(5) ;  Load parameter 'upper' into R1
332 : LDA  4, 8(5) ; Restore Callee frame base
333 : ST 1, 3(5) ;  Store argument 2 into callee frame
334 : LDA  4, 8(5) ; Restore Call frame base
...
346 : LDA  4, 6(5) ;  Update DMEM pointer
...
359 : LDA  4, 6(5) ; Restore Callee frame base
360 : ST 1, 1(5) ;  Store argument 0 into callee frame
361 : LD   1, 2(5) ;  Load parameter 'n' into R1
362 : LDA  4, 6(5) ; Restore Callee frame base
363 : ST 1, 2(5) ;  Store argument 1 into callee frame
364 : LD   1, 3(5) ;  Load parameter 'upper' into R1
365 : LDA  4, 6(5) ; Restore Callee frame base
366 : ST 1, 3(5) ;  Store argument 2 into callee frame
367 : LDA  4, 6(5) ; Restore Call frame base
...
379 : LDA  4, 3(5) ; Restore Callee frame base
380 : ST 1, 1(5) ;  Store argument 0 into callee frame
381 : LD   1, 1(5) ;  Load parameter 'n' into R1
382 : LDA  4, 3(5) ; Restore Callee frame base
383 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
392 : LDA  4, 3(5) ; Restore Callee frame base
393 : ST 1, 2(5) ;  Store argument 1 into callee frame
394 : LDA  4, 3(5) ; Restore Call frame base
...
407 : ST 1, 1(5) ;  Store argument 0 into callee frame
408 : LDA  4, 4(5) ; Restore Call frame base
...
423 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
433 : ST 1, 1(5) ;  Store argument 0 into callee frame
434 : LD   1, 1(5) ;  Load parameter 'n' into R1
435 : LDA  4, 4(5) ; Restore Callee frame base
436 : ST 1, 1(5) ;  Store argument 0 into callee frame
437 : LDA  4, 4(5) ; Restore Call frame base
...
446 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
481 : LDA  4, 3(5) ; Restore Callee frame base
482 : ST 1, 1(5) ;  Store argument 0 into callee frame
483 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
484 : LDA  4, 3(5) ; Restore Callee frame base
485 : ST 1, 1(5) ;  Store argument 0 into callee frame
486 : LD   1, 1(5) ;  Load parameter 'n' into R1
487 : LDA  4, 3(5) ; Restore Callee frame base
488 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
501 : LDA  4, 3(5) ; Restore Callee frame base
502 : ST 1, 2(5) ;  Store argument 1 into callee frame
503 : LDA  4, 3(5) ; Restore Call frame base
...
511 : LDA  4, 3(5) ; Restore Callee frame base
512 : ST 1, 2(5) ;  Store argument 1 into callee frame
513 : LDA  4, 3(5) ; Restore Call frame base
...
527 : LDA  4, 3(5) ; Restore Callee frame base
528 : ST 1, 1(5) ;  Store argument 0 into callee frame
529 : LD   1, 1(5) ;  Load parameter 'n' into R1
530 : LDA  4, 3(5) ; Restore Callee frame base
531 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
544 : LDA  4, 3(5) ; Restore Callee frame base
545 : ST 1, 2(5) ;  Store argument 1 into callee frame
546 : LDA  4, 3(5) ; Restore Call frame base
...
579 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
634 : LDA  4, 6(5) ; Restore Callee frame base
635 : ST 1, 1(5) ;  Store argument 0 into callee frame
636 : LD   1, 1(5) ;  Load parameter 'n' into R1
637 : LDA  4, 6(5) ; Restore Callee frame base
638 : ST 1, 2(5) ;  Store argument 1 into callee frame
639 : LDA  4, 6(5) ; Restore Call frame base
...
649 : LDA  4, 6(5) ; Restore Callee frame base
650 : ST 1, 1(5) ;  Store argument 0 into callee frame
651 : LD   1, 4(5) ;  Load parameter 'mid' into R1
652 : LDA  4, 6(5) ; Restore Callee frame base
653 : ST 1, 2(5) ;  Store argument 1 into callee frame
654 : LD   1, 3(5) ;  Load parameter 'high' into R1
655 : LDA  4, 6(5) ; Restore Callee frame base
656 : ST 1, 3(5) ;  Store argument 2 into callee frame
657 : LDA  4, 6(5) ; Restore Call frame base
...
667 : LDA  4, 6(5) ; Restore Callee frame base
668 : ST 1, 1(5) ;  Store argument 0 into callee frame
669 : LD   1, 2(5) ;  Load parameter 'low' into R1
670 : LDA  4, 6(5) ; Restore Callee frame base
671 : ST 1, 2(5) ;  Store argument 1 into callee frame
672 : LD   1, 4(5) ;  Load parameter 'mid' into R1
673 : LDA  4, 6(5) ; Restore Callee frame base
674 : ST 1, 3(5) ;  Store argument 2 into callee frame
675 : LDA  4, 6(5) ; Restore Call frame base
...
687 : LDA  4, 5(5) ; Restore Callee frame base
688 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
694 : LDA  4, 5(5) ; Restore Callee frame base
695 : ST 1, 2(5) ;  Store argument 1 into callee frame
696 : LDA  4, 5(5) ; Restore Call frame base
...
714 : LDA  4, 5(5) ; Restore Callee frame base
715 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
725 : LDA  4, 5(5) ; Restore Callee frame base
726 : ST 1, 2(5) ;  Store argument 1 into callee frame
727 : LDA  4, 5(5) ; Restore Call frame base
...
741 : LDA  4, 5(5) ; Restore Callee frame base
742 : ST 1, 1(5) ;  Store argument 0 into callee frame
743 : LD   1, 2(5) ;  Load parameter 'low' into R1
744 : LDA  4, 5(5) ; Restore Callee frame base
745 : ST 1, 2(5) ;  Store argument 1 into callee frame
746 : LD   1, 3(5) ;  Load parameter 'high' into R1
747 : LDA  4, 5(5) ; Restore Callee frame base
748 : ST 1, 3(5) ;  Store argument 2 into callee frame
...
758 : LDA  4, 5(5) ; Restore Callee frame base
759 : ST 1, 4(5) ;  Store argument 3 into callee frame
760 : LDA  4, 5(5) ; Restore Call frame base
...
772 : LDA  4, 3(5) ; Restore Callee frame base
773 : ST 1, 1(5) ;  Store argument 0 into callee frame
774 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
775 : LDA  4, 3(5) ; Restore Callee frame base
776 : ST 1, 2(5) ;  Store argument 1 into callee frame
777 : LD   1, 1(5) ;  Load parameter 'n' into R1
778 : LDA  4, 3(5) ; Restore Callee frame base
779 : ST 1, 3(5) ;  Store argument 2 into callee frame
780 : LDA  4, 3(5) ; Restore Call frame base
...
846 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
874 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
881 : ST 1, 2(5) ;  Store argument 1 into callee frame
