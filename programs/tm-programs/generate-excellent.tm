...
12 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
23 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
24 : ST 1, 2(4) ; Store argument 1 into callee frame
25 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
31 : LDC 2, 3(0) ; Load caller frame size
32 : SUB 5, 5, 2 ; Restore pointer (pop callee)
33 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
40 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
41 : ST 1, 2(4) ; Store argument 1 into callee frame
42 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
48 : LDC 2, 3(0) ; Load caller frame size
49 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
55 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
56 : ST 1, 1(4) ; Store argument 0 into callee frame
57 : LD   1, 2(5) ;  Load parameter 'n' into R1
58 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
65 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
66 : ST 1, 3(4) ; Store argument 2 into callee frame
67 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
73 : LDC 2, 4(0) ; Load caller frame size
74 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
100 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
101 : ST 1, 1(4) ; Store argument 0 into callee frame
102 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
103 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
104 : ST 1, 2(4) ; Store argument 1 into callee frame
105 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
...
111 : LDC 2, 5(0) ; Load caller frame size
112 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
119 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
120 : ST 1, 1(4) ; Store argument 0 into callee frame
121 : LD   1, 2(5) ;  Load parameter 'n' into R1
122 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
123 : ST 1, 2(4) ; Store argument 1 into callee frame
124 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
...
130 : LDC 2, 5(0) ; Load caller frame size
131 : SUB 5, 5, 2 ; Restore pointer (pop callee)
132 : ADD  2, 3, 0 ;  Restore left operand
133 : MUL  1, 2, 1 ;  R1 = left * right
134 : ADD  3, 1, 0 ;  Store left operand into temporary register
...
144 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
145 : ST 1, 4(4) ; Store argument 3 into callee frame
146 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
...
152 : LDC 2, 5(0) ; Load caller frame size
153 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
180 : LDC 2, 6(0) ; Load caller frame size
181 : SUB 5, 5, 2 ; Restore pointer (pop callee)
182 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
183 : ST 1, 5(4) ; Store argument 4 into callee frame
184 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
...
190 : LDC 2, 6(0) ; Load caller frame size
...
224 : LDC 2, 7(0) ; Load caller frame size
225 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
240 : LDA 4, 7(5) ; Callee frame base = caller base + caller size
241 : ST 1, 6(4) ; Store argument 5 into callee frame
242 : LDA 4, 7(5) ; Callee frame base = caller base + caller size
...
248 : LDC 2, 7(0) ; Load caller frame size
249 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
254 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
255 : ST 1, 1(4) ; Store argument 0 into callee frame
256 : LD   1, 4(5) ;  Load parameter 'det' into R1
257 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
258 : ST 1, 2(4) ; Store argument 1 into callee frame
259 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
...
265 : LDC 2, 8(0) ; Load caller frame size
266 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
273 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
274 : ST 1, 1(4) ; Store argument 0 into callee frame
275 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
...
281 : LDC 2, 8(0) ; Load caller frame size
282 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
287 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
288 : ST 1, 1(4) ; Store argument 0 into callee frame
289 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
...
295 : LDC 2, 8(0) ; Load caller frame size
296 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
318 : LDC 2, 8(0) ; Load caller frame size
319 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
326 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
327 : ST 1, 1(4) ; Store argument 0 into callee frame
328 : LD   1, 2(5) ;  Load parameter 'n' into R1
329 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
330 : ST 1, 2(4) ; Store argument 1 into callee frame
331 : LD   1, 3(5) ;  Load parameter 'upper' into R1
332 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
333 : ST 1, 3(4) ; Store argument 2 into callee frame
334 : LDA 4, 8(5) ; Callee frame base = caller base + caller size
...
340 : LDC 2, 8(0) ; Load caller frame size
341 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
346 : LDA 4, 6(5) ; Callee frame base from caller base
...
373 : LDC 2, 6(0) ; Load caller frame size
374 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
379 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
380 : ST 1, 1(4) ; Store argument 0 into callee frame
381 : LD   1, 1(5) ;  Load parameter 'n' into R1
382 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
383 : ST 1, 1(4) ; Store argument 0 into callee frame
384 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
390 : LDC 2, 3(0) ; Load caller frame size
391 : SUB 5, 5, 2 ; Restore pointer (pop callee)
392 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
393 : ST 1, 2(4) ; Store argument 1 into callee frame
394 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
400 : LDC 2, 3(0) ; Load caller frame size
401 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
406 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
407 : ST 1, 1(4) ; Store argument 0 into callee frame
408 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
414 : LDC 2, 4(0) ; Load caller frame size
415 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
422 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
423 : ST 1, 1(4) ; Store argument 0 into callee frame
424 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
430 : LDC 2, 4(0) ; Load caller frame size
431 : SUB 5, 5, 2 ; Restore pointer (pop callee)
432 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
433 : ST 1, 1(4) ; Store argument 0 into callee frame
434 : LD   1, 1(5) ;  Load parameter 'n' into R1
435 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
436 : ST 1, 1(4) ; Store argument 0 into callee frame
437 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
443 : LDC 2, 4(0) ; Load caller frame size
444 : SUB 5, 5, 2 ; Restore pointer (pop callee)
445 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
446 : ST 1, 2(4) ; Store argument 1 into callee frame
447 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
453 : LDC 2, 4(0) ; Load caller frame size
454 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
465 : ADD  3, 1, 0 ;  Store left operand into temporary register
466 : LD   1, 2(5) ;  Load parameter 'b' into R1
467 : ADD  2, 3, 0 ;  Restore left operand
...
495 : LDC 2, 3(0) ; Load caller frame size
496 : SUB 5, 5, 2 ; Restore pointer (pop callee)
497 : ADD  3, 1, 0 ;  Store left operand into temporary register
498 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
499 : ADD  2, 3, 0 ;  Restore left operand
500 : DIV  1, 2, 1 ;  R1 = left / right
501 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
502 : ST 1, 2(4) ; Store argument 1 into callee frame
503 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
509 : LDC 2, 3(0) ; Load caller frame size
510 : SUB 5, 5, 2 ; Restore pointer (pop callee)
511 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
512 : ST 1, 2(4) ; Store argument 1 into callee frame
513 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
519 : LDC 2, 3(0) ; Load caller frame size
520 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
527 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
528 : ST 1, 1(4) ; Store argument 0 into callee frame
529 : LD   1, 1(5) ;  Load parameter 'n' into R1
530 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
531 : ST 1, 1(4) ; Store argument 0 into callee frame
532 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
538 : LDC 2, 3(0) ; Load caller frame size
539 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
544 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
545 : ST 1, 2(4) ; Store argument 1 into callee frame
546 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
547 : LDA 6, 551(0) ; Compute return address
548 : ST 6, 0(4) ; Store return address in callee frame
549 : ADD 5, 4, 0 ; Push callee frame
550 : LDA 7, 858(0) ; Call EXP
551 : LD 1, 3(5) ; Load callee return value into R1
552 : LDC 2, 3(0) ; Load caller frame size
553 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
572 : ADD  3, 1, 0 ;  Store left operand into temporary register
...
578 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
579 : ST 1, 1(4) ; Store argument 0 into callee frame
580 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
586 : LDC 2, 3(0) ; Load caller frame size
587 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
630 : ADD  3, 1, 0 ;  Store left operand into temporary register
631 : LD   1, 4(5) ;  Load parameter 'mid' into R1
632 : ADD  2, 3, 0 ;  Restore left operand
633 : MUL  1, 2, 1 ;  R1 = left * right
634 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
635 : ST 1, 1(4) ; Store argument 0 into callee frame
636 : LD   1, 1(5) ;  Load parameter 'n' into R1
637 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
638 : ST 1, 2(4) ; Store argument 1 into callee frame
639 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
...
725 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
726 : ST 1, 2(4) ; Store argument 1 into callee frame
727 : LDA 4, 5(5) ; Callee frame base = caller base + caller size
...
733 : LDC 2, 5(0) ; Load caller frame size
734 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
792 : ADD  3, 1, 0 ;  Store left operand into temporary register
793 : LD   1, 2(5) ;  Load parameter 'q' into R1
794 : ADD  2, 3, 0 ;  Restore left operand
795 : SUB  1, 2, 1 ;  left - right for less-than check
796 : JLT  1, 2(7) ;  If R1 < 0, jump to true
797 : LDC  1, 0(0) ;  false
798 : LDA  7, 1(7) ;  skip setting true
799 : LDC  1, 1(0) ;  true
800 : ADD  3, 1, 0 ;  Store left operand into temporary register
...
809 : LDC  1, 1(0) ;  true
810 : ADD  2, 3, 0 ;  Restore left operand
...
818 : ADD  2, 3, 0 ;  Restore left operand
...
826 : ADD  3, 1, 0 ;  Store left operand into temporary register
827 : LD   1, 1(5) ;  Load parameter 'n' into R1
828 : ADD  3, 1, 0 ;  Store left operand into temporary register
829 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
830 : ADD  2, 3, 0 ;  Restore left operand
831 : DIV  1, 2, 1 ;  R1 = left / right
832 : ADD  2, 3, 0 ;  Restore left operand
833 : MUL  1, 2, 1 ;  R1 = left * right
834 : ADD  3, 1, 0 ;  Store left operand into temporary register
835 : LD   1, 1(5) ;  Load parameter 'n' into R1
836 : ADD  2, 3, 0 ;  Restore left operand
...
845 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
846 : ST 1, 1(4) ; Store argument 0 into callee frame
847 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
853 : LDC 2, 3(0) ; Load caller frame size
854 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
859 : ADD  3, 1, 0 ;  Store left operand into temporary register
...
871 : ADD  3, 1, 0 ;  Store left operand into temporary register
872 : LD   1, 1(5) ;  Load parameter 'm' into R1
873 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
874 : ST 1, 1(4) ; Store argument 0 into callee frame
875 : LD   1, 2(5) ;  Load parameter 'n' into R1
876 : ADD  3, 1, 0 ;  Store left operand into temporary register
877 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
878 : ADD  2, 3, 0 ;  Restore left operand
879 : SUB  1, 2, 1 ;  R1 = left - right
880 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
881 : ST 1, 2(4) ; Store argument 1 into callee frame
882 : LDA 4, 4(5) ; Callee frame base = caller base + caller size
...
888 : LDC 2, 4(0) ; Load caller frame size
889 : SUB 5, 5, 2 ; Restore pointer (pop callee)
890 : ADD  2, 3, 0 ;  Restore left operand
...
896 : ADD  3, 1, 0 ;  Store left operand into temporary register
897 : LD   1, 2(5) ;  Load parameter 'n' into R1
898 : ADD  3, 1, 0 ;  Store left operand into temporary register
899 : LD   1, 1(5) ;  Load parameter 'm' into R1
900 : ADD  3, 1, 0 ;  Store left operand into temporary register
901 : LD   1, 2(5) ;  Load parameter 'n' into R1
902 : ADD  2, 3, 0 ;  Restore left operand
903 : DIV  1, 2, 1 ;  R1 = left / right
904 : ADD  2, 3, 0 ;  Restore left operand
905 : MUL  1, 2, 1 ;  R1 = left * right
906 : ADD  2, 3, 0 ;  Restore left operand
