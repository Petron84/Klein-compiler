...
13 : LDA 4, 4(4) ; Recompute callee base from callee size
...
24 : LDA 4, 4(4) ; Recompute callee base from callee size
25 : ST 1, 2(4) ; Store argument 1 in callee
26 : LDA 4, 4(4) ; Recompute callee base from callee size
...
32 : LDC 2, 4(0) ; Callee frame size
33 : SUB 5, 5, 2 ; Pop callee frame
34 : LDA 4, 4(4) ; Recompute callee base from callee size
...
41 : LDA 4, 4(4) ; Recompute callee base from callee size
42 : ST 1, 2(4) ; Store argument 1 in callee
43 : LDA 4, 4(4) ; Recompute callee base from callee size
...
56 : LDA 4, 5(4) ; Recompute callee base from callee size
57 : ST 1, 1(4) ; Store argument 0 in callee
58 : LD 1, 2(5) ; Load parameter 'n' into R1
59 : LDA 4, 5(4) ; Recompute callee base from callee size
...
66 : LDA 4, 5(4) ; Recompute callee base from callee size
67 : ST 1, 3(4) ; Store argument 2 in callee
68 : LDA 4, 5(4) ; Recompute callee base from callee size
...
74 : LDC 2, 5(0) ; Callee frame size
...
90 : LDA 4, 7(4) ; Recompute callee base from callee size
91 : ST 1, 1(4) ; Store argument 0 in callee
92 : LD 1, 2(5) ; Load parameter 'n' into R1
93 : LDA 4, 7(4) ; Recompute callee base from callee size
94 : ST 1, 2(4) ; Store argument 1 in callee
95 : LD 1, 3(5) ; Load parameter 'upper' into R1
96 : LDA 4, 7(4) ; Recompute callee base from callee size
...
104 : LDA 4, 7(4) ; Recompute callee base from callee size
105 : ST 1, 2(4) ; Store argument 1 in callee
106 : LDA 4, 7(4) ; Recompute callee base from callee size
...
112 : LDC 2, 7(0) ; Callee frame size
...
120 : LDA 4, 7(4) ; Recompute callee base from callee size
121 : ST 1, 1(4) ; Store argument 0 in callee
122 : LD 1, 2(5) ; Load parameter 'n' into R1
123 : LDA 4, 7(4) ; Recompute callee base from callee size
124 : ST 1, 2(4) ; Store argument 1 in callee
125 : LDA 4, 7(4) ; Recompute callee base from callee size
...
131 : LDC 2, 7(0) ; Callee frame size
...
145 : LDA 4, 7(4) ; Recompute callee base from callee size
146 : ST 1, 4(4) ; Store argument 3 in callee
147 : LDA 4, 7(4) ; Recompute callee base from callee size
...
153 : LDC 2, 7(0) ; Callee frame size
...
181 : LDC 2, 6(0) ; Callee frame size
182 : SUB 5, 5, 2 ; Pop callee frame
183 : LDA 4, 6(4) ; Recompute callee base from callee size
184 : ST 1, 5(4) ; Store argument 4 in callee
185 : LDA 4, 6(4) ; Recompute callee base from callee size
...
191 : LDC 2, 6(0) ; Callee frame size
...
214 : LDA 4, 9(4) ; Recompute callee base from callee size
215 : ST 1, 1(4) ; Store argument 0 in callee
216 : LD 1, 2(5) ; Load parameter 'n' into R1
217 : LDA 4, 9(4) ; Recompute callee base from callee size
218 : ST 1, 2(4) ; Store argument 1 in callee
219 : LDA 4, 9(4) ; Recompute callee base from callee size
...
225 : LDC 2, 9(0) ; Callee frame size
...
241 : LDA 4, 9(4) ; Recompute callee base from callee size
242 : ST 1, 6(4) ; Store argument 5 in callee
243 : LDA 4, 9(4) ; Recompute callee base from callee size
...
249 : LDC 2, 9(0) ; Callee frame size
...
255 : LDA 4, 10(4) ; Recompute callee base from callee size
256 : ST 1, 1(4) ; Store argument 0 in callee
257 : LD 1, 4(5) ; Load parameter 'det' into R1
258 : LDA 4, 10(4) ; Recompute callee base from callee size
259 : ST 1, 2(4) ; Store argument 1 in callee
260 : LDA 4, 10(4) ; Recompute callee base from callee size
...
266 : LDC 2, 10(0) ; Callee frame size
...
274 : LDA 4, 10(4) ; Recompute callee base from callee size
275 : ST 1, 1(4) ; Store argument 0 in callee
276 : LDA 4, 10(4) ; Recompute callee base from callee size
...
282 : LDC 2, 10(0) ; Callee frame size
...
288 : LDA 4, 10(4) ; Recompute callee base from callee size
289 : ST 1, 1(4) ; Store argument 0 in callee
290 : LDA 4, 10(4) ; Recompute callee base from callee size
...
296 : LDC 2, 10(0) ; Callee frame size
...
319 : LDC 2, 10(0) ; Callee frame size
...
327 : LDA 4, 10(4) ; Recompute callee base from callee size
328 : ST 1, 1(4) ; Store argument 0 in callee
329 : LD 1, 2(5) ; Load parameter 'n' into R1
330 : LDA 4, 10(4) ; Recompute callee base from callee size
331 : ST 1, 2(4) ; Store argument 1 in callee
332 : LD 1, 3(5) ; Load parameter 'upper' into R1
333 : LDA 4, 10(4) ; Recompute callee base from callee size
334 : ST 1, 3(4) ; Store argument 2 in callee
335 : LDA 4, 10(4) ; Recompute callee base from callee size
...
341 : LDC 2, 10(0) ; Callee frame size
...
347 : LDA 4, 7(4) ; Recompute callee base from caller size
...
359 : LDA 4, 7(4) ; Recompute callee base from callee size
360 : ST 1, 1(4) ; Store argument 0 in callee
361 : LD 1, 2(5) ; Load parameter 'n' into R1
362 : LDA 4, 7(4) ; Recompute callee base from callee size
363 : ST 1, 2(4) ; Store argument 1 in callee
364 : LD 1, 3(5) ; Load parameter 'upper' into R1
365 : LDA 4, 7(4) ; Recompute callee base from callee size
366 : ST 1, 3(4) ; Store argument 2 in callee
367 : LDA 4, 7(4) ; Recompute callee base from callee size
...
379 : LDA 4, 3(4) ; Recompute callee base from callee size
380 : ST 1, 1(4) ; Store argument 0 in callee
381 : LD 1, 1(5) ; Load parameter 'n' into R1
382 : LDA 4, 3(4) ; Recompute callee base from callee size
383 : ST 1, 1(4) ; Store argument 0 in callee
384 : LDA 4, 3(4) ; Recompute callee base from callee size
...
390 : LDC 2, 3(0) ; Callee frame size
391 : SUB 5, 5, 2 ; Pop callee frame
392 : LDA 4, 3(4) ; Recompute callee base from callee size
393 : ST 1, 2(4) ; Store argument 1 in callee
394 : LDA 4, 3(4) ; Recompute callee base from callee size
...
400 : LDC 2, 3(0) ; Callee frame size
...
406 : LDA 4, 5(4) ; Recompute callee base from callee size
407 : ST 1, 1(4) ; Store argument 0 in callee
408 : LDA 4, 5(4) ; Recompute callee base from callee size
...
422 : LDA 4, 5(4) ; Recompute callee base from callee size
423 : ST 1, 1(4) ; Store argument 0 in callee
424 : LDA 4, 5(4) ; Recompute callee base from callee size
...
432 : LDA 4, 5(4) ; Recompute callee base from callee size
433 : ST 1, 1(4) ; Store argument 0 in callee
434 : LD 1, 1(5) ; Load parameter 'n' into R1
435 : LDA 4, 5(4) ; Recompute callee base from callee size
436 : ST 1, 1(4) ; Store argument 0 in callee
437 : LDA 4, 5(4) ; Recompute callee base from callee size
...
443 : LDC 2, 5(0) ; Callee frame size
444 : SUB 5, 5, 2 ; Pop callee frame
445 : LDA 4, 5(4) ; Recompute callee base from callee size
...
453 : LDC 2, 5(0) ; Callee frame size
...
481 : LDA 4, 4(4) ; Recompute callee base from callee size
482 : ST 1, 1(4) ; Store argument 0 in callee
483 : LDC 1, 10(0) ; Load integer-literal into R1
484 : LDA 4, 4(4) ; Recompute callee base from callee size
485 : ST 1, 1(4) ; Store argument 0 in callee
486 : LD 1, 1(5) ; Load parameter 'n' into R1
487 : LDA 4, 4(4) ; Recompute callee base from callee size
488 : ST 1, 1(4) ; Store argument 0 in callee
489 : LDA 4, 4(4) ; Recompute callee base from callee size
...
495 : LDC 2, 4(0) ; Callee frame size
...
501 : LDA 4, 4(4) ; Recompute callee base from callee size
502 : ST 1, 2(4) ; Store argument 1 in callee
503 : LDA 4, 4(4) ; Recompute callee base from callee size
...
509 : LDC 2, 4(0) ; Callee frame size
510 : SUB 5, 5, 2 ; Pop callee frame
511 : LDA 4, 4(4) ; Recompute callee base from callee size
512 : ST 1, 2(4) ; Store argument 1 in callee
513 : LDA 4, 4(4) ; Recompute callee base from callee size
...
519 : LDC 2, 4(0) ; Callee frame size
...
532 : LDA 4, 5(4) ; Recompute callee base from callee size
...
544 : LDA 4, 5(4) ; Recompute callee base from callee size
...
552 : LDC 2, 5(0) ; Callee frame size
...
578 : LDA 4, 5(4) ; Recompute callee base from callee size
579 : ST 1, 1(4) ; Store argument 0 in callee
580 : LDA 4, 5(4) ; Recompute callee base from callee size
...
634 : LDA 4, 7(4) ; Recompute callee base from callee size
635 : ST 1, 1(4) ; Store argument 0 in callee
636 : LD 1, 1(5) ; Load parameter 'n' into R1
637 : LDA 4, 7(4) ; Recompute callee base from callee size
638 : ST 1, 2(4) ; Store argument 1 in callee
639 : LDA 4, 7(4) ; Recompute callee base from callee size
...
667 : LDA 4, 7(4) ; Recompute callee base from callee size
668 : ST 1, 1(4) ; Store argument 0 in callee
669 : LD 1, 2(5) ; Load parameter 'low' into R1
670 : LDA 4, 7(4) ; Recompute callee base from callee size
671 : ST 1, 2(4) ; Store argument 1 in callee
672 : LD 1, 4(5) ; Load parameter 'mid' into R1
673 : LDA 4, 7(4) ; Recompute callee base from callee size
674 : ST 1, 3(4) ; Store argument 2 in callee
675 : LDA 4, 7(4) ; Recompute callee base from callee size
...
687 : LDA 4, 7(4) ; Recompute callee base from callee size
...
694 : LDA 4, 7(4) ; Recompute callee base from callee size
695 : ST 1, 2(4) ; Store argument 1 in callee
696 : LDA 4, 7(4) ; Recompute callee base from callee size
...
702 : LDC 2, 7(0) ; Callee frame size
...
714 : LDA 4, 7(4) ; Recompute callee base from callee size
...
725 : LDA 4, 7(4) ; Recompute callee base from callee size
726 : ST 1, 2(4) ; Store argument 1 in callee
727 : LDA 4, 7(4) ; Recompute callee base from callee size
...
733 : LDC 2, 7(0) ; Callee frame size
...
758 : LDA 4, 7(4) ; Recompute callee base from callee size
759 : ST 1, 4(4) ; Store argument 3 in callee
760 : LDA 4, 7(4) ; Recompute callee base from callee size
...
772 : LDA 4, 3(4) ; Recompute callee base from callee size
773 : ST 1, 1(4) ; Store argument 0 in callee
774 : LDC 1, 0(0) ; Load integer-literal into R1
775 : LDA 4, 3(4) ; Recompute callee base from callee size
776 : ST 1, 2(4) ; Store argument 1 in callee
777 : LD 1, 1(5) ; Load parameter 'n' into R1
778 : LDA 4, 3(4) ; Recompute callee base from callee size
779 : ST 1, 3(4) ; Store argument 2 in callee
780 : LDA 4, 3(4) ; Recompute callee base from callee size
...
786 : LDC 2, 3(0) ; Callee frame size
...
845 : LDA 4, 5(4) ; Recompute callee base from callee size
846 : ST 1, 1(4) ; Store argument 0 in callee
847 : LDA 4, 5(4) ; Recompute callee base from callee size
...
873 : LDA 4, 6(4) ; Recompute callee base from callee size
...
880 : LDA 4, 6(4) ; Recompute callee base from callee size
881 : ST 1, 2(4) ; Store argument 1 in callee
882 : LDA 4, 6(4) ; Recompute callee base from callee size
