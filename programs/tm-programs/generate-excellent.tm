...
13 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
24 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
59 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
83 : SUB 1, 2, 1 ; Compute left - right for less-than
84 : JLT 1, 2(7) ; If < 0, jump to true
85 : LDC 1, 0(0) ; false
86 : LDA 7, 1(7) ; skip true assignment
87 : LDC 1, 1(0) ; true
88 : JEQ 1, 156(0) ; If condition false jump to ELSE
89 : LD 1, 1(5) ; Load parameter 'a' into R1
90 : LDA 4, 7(5) ; Compute future callee base (caller_size)
91 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
92 : LD 1, 2(5) ; Load parameter 'n' into R1
93 : LDA 4, 7(5) ; Compute future callee base (caller_size)
94 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
95 : LD 1, 3(5) ; Load parameter 'upper' into R1
96 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
104 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
120 : LDA 4, 7(5) ; Compute future callee base (caller_size)
121 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
122 : LD 1, 2(5) ; Load parameter 'n' into R1
123 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
145 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
183 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
214 : LDA 4, 9(5) ; Compute future callee base (caller_size)
215 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
216 : LD 1, 2(5) ; Load parameter 'n' into R1
217 : LDA 4, 9(5) ; Compute future callee base (caller_size)
...
221 : ST 6, 0(4) ; Store return address in callee frame
...
241 : LDA 4, 9(5) ; Compute future callee base (caller_size)
...
255 : LDA 4, 10(5) ; Compute future callee base (caller_size)
256 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
257 : LD 1, 4(5) ; Load parameter 'det' into R1
258 : LDA 4, 10(5) ; Compute future callee base (caller_size)
...
274 : LDA 4, 10(5) ; Compute future callee base (caller_size)
...
288 : LDA 4, 10(5) ; Compute future callee base (caller_size)
...
300 : JEQ 1, 322(0) ; If condition false jump to ELSE
301 : LD 1, 1(5) ; Load parameter 'a' into R1
302 : LDA 4, 10(5) ; Compute future callee base (caller_size)
...
315 : ST 6, 0(4) ; Store return address in callee frame
...
379 : LDA 4, 3(5) ; Compute future callee base (caller_size)
380 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
381 : LD 1, 1(5) ; Load parameter 'n' into R1
382 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
392 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
406 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
416 : JEQ 1, 419(0) ; If condition false jump to ELSE
...
422 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
432 : LDA 4, 5(5) ; Compute future callee base (caller_size)
433 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
434 : LD 1, 1(5) ; Load parameter 'n' into R1
435 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
445 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
456 : SUB 1, 2, 1 ; Compute left - right for equality
457 : JEQ 1, 2(7) ; If zero, jump to true
458 : LDC 1, 0(0) ; false
459 : LDA 7, 1(7) ; skip true assignment
460 : LDC 1, 1(0) ; true
...
501 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
511 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
544 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
563 : SUB 1, 2, 1 ; Compute left - right for less-than
564 : JLT 1, 2(7) ; If < 0, jump to true
565 : LDC 1, 0(0) ; false
566 : LDA 7, 1(7) ; skip true assignment
567 : LDC 1, 1(0) ; true
568 : JEQ 1, 571(0) ; If condition false jump to ELSE
...
578 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
579 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
580 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
601 : SUB 1, 2, 1 ; Compute left - right for equality
602 : JEQ 1, 2(7) ; If zero, jump to true
603 : LDC 1, 0(0) ; false
604 : LDA 7, 1(7) ; skip true assignment
605 : LDC 1, 1(0) ; true
...
621 : SUB 1, 2, 1 ; Compute left - right for equality
622 : JEQ 1, 2(7) ; If zero, jump to true
623 : LDC 1, 0(0) ; false
624 : LDA 7, 1(7) ; skip true assignment
625 : LDC 1, 1(0) ; true
...
634 : LDA 4, 7(5) ; Compute future callee base (caller_size)
635 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
636 : LD 1, 1(5) ; Load parameter 'n' into R1
637 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
687 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
694 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
704 : JEQ 1, 740(0) ; If condition false jump to ELSE
...
714 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
725 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
735 : JEQ 1, 738(0) ; If condition false jump to ELSE
...
758 : LDA 4, 7(5) ; Compute future callee base (caller_size)
...
795 : SUB 1, 2, 1 ; Compute left - right for less-than
796 : JLT 1, 2(7) ; If < 0, jump to true
797 : LDC 1, 0(0) ; false
798 : LDA 7, 1(7) ; skip true assignment
799 : LDC 1, 1(0) ; true
...
805 : SUB 1, 2, 1 ; Compute left - right for equality
806 : JEQ 1, 2(7) ; If zero, jump to true
807 : LDC 1, 0(0) ; false
808 : LDA 7, 1(7) ; skip true assignment
809 : LDC 1, 1(0) ; true
...
819 : SUB 1, 2, 1 ; Compute left - right for less-than
820 : JLT 1, 2(7) ; If < 0, jump to true
821 : LDC 1, 0(0) ; false
822 : LDA 7, 1(7) ; skip true assignment
823 : LDC 1, 1(0) ; true
824 : JEQ 1, 843(0) ; If condition false jump to ELSE
...
837 : SUB 1, 2, 1 ; Compute left - right for less-than
838 : JLT 1, 2(7) ; If < 0, jump to true
839 : LDC 1, 0(0) ; false
840 : LDA 7, 1(7) ; skip true assignment
841 : LDC 1, 1(0) ; true
842 : LDA 7, 855(0) ; Skip ELSE block
843 : LD 1, 1(5) ; Load parameter 'n' into R1
844 : SUB 1, 0, 1 ; Negate R1
845 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
846 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
847 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
862 : SUB 1, 2, 1 ; Compute left - right for equality
863 : JEQ 1, 2(7) ; If zero, jump to true
864 : LDC 1, 0(0) ; false
865 : LDA 7, 1(7) ; skip true assignment
866 : LDC 1, 1(0) ; true
867 : JEQ 1, 870(0) ; If condition false jump to ELSE
...
873 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
880 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
881 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
882 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
