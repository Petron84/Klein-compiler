...
45 : LDC  3, 0(1) ; Store left operand into temporary register
46 : LD   1, 4(5) ;  Load parameter 'mid' into R1
47 : LDC  2, 0(3) ;  Restore left operand
...
196 : LDC  3, 0(1) ; Store left operand into temporary register
197 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
198 : LDC  2, 0(3) ;  Restore left operand
...
265 : LDC  3, 0(1) ; Store left operand into temporary register
...
280 : LDC  2, 0(3) ;  Restore left operand
...
330 : LDC  3, 0(1) ; Store left operand into temporary register
...
355 : LDC  2, 0(3) ;  Restore left operand
...
373 : LDC  2, 0(3) ;  Restore left operand
...
383 : LDC  3, 0(1) ; Store left operand into temporary register
...
388 : LDC  3, 0(1) ; Store left operand into temporary register
389 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
390 : LDC  2, 0(3) ;  Restore left operand
...
402 : LDC  2, 0(3) ;  Restore left operand
...
408 : LDC  3, 0(1) ; Store left operand into temporary register
409 : LD   1, 1(5) ;  Load parameter 'm' into R1
410 : LDC  3, 0(1) ; Store left operand into temporary register
411 : LD   1, 2(5) ;  Load parameter 'n' into R1
412 : LDC  2, 0(3) ;  Restore left operand
413 : DIV  1, 2, 1 ;  R1 = left / right
414 : LDC  3, 0(1) ; Store left operand into temporary register
415 : LD   1, 2(5) ;  Load parameter 'n' into R1
416 : LDC  2, 0(3) ;  Restore left operand
417 : MUL  1, 2, 1 ;  R1 = left * right
418 : LDC  2, 0(3) ;  Restore left operand
...
424 : LDC  3, 0(1) ; Store left operand into temporary register
425 : LD   1, 1(5) ;  Load parameter 'n' into R1
426 : LDC  2, 0(3) ;  Restore left operand
...
455 : LDC  3, 0(1) ; Store left operand into temporary register
456 : LD   1, 2(5) ;  Load parameter 'q' into R1
457 : LDC  2, 0(3) ;  Restore left operand
...
463 : LDC  3, 0(1) ; Store left operand into temporary register
464 : LD   1, 2(5) ;  Load parameter 'q' into R1
465 : LDC  2, 0(3) ;  Restore left operand
...
479 : LDC  3, 0(1) ; Store left operand into temporary register
480 : LD   1, 2(5) ;  Load parameter 'q' into R1
481 : LDC  2, 0(3) ;  Restore left operand
...
495 : LDC  3, 0(1) ; Store left operand into temporary register
496 : LD   1, 2(5) ;  Load parameter 'q' into R1
497 : LDC  2, 0(3) ;  Restore left operand
...
554 : LDC  3, 0(1) ; Store left operand into temporary register
...
569 : LDC  2, 0(3) ;  Restore left operand
...
596 : LDC  2, 0(3) ;  Restore left operand
...
606 : LDC  3, 0(1) ; Store left operand into temporary register
607 : LD   1, 2(5) ;  Load parameter 'q' into R1
608 : LDC  2, 0(3) ;  Restore left operand
...
619 : LDC  3, 0(1) ; Store left operand into temporary register
620 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
621 : LDC  2, 0(3) ;  Restore left operand
