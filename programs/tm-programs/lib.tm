...
12 : LDA 4, 3(5) ; Compute callee base
13 : ST 1, 1(4) ; Store argument 0 in callee frame
14 : LDA 4, 3(5) ; Recompute callee base from callee size
...
22 : LDA 4, 3(5) ; Recompute callee base from caller size
...
29 : LDA 4, 4(5) ; Compute callee base
...
48 : LDA 4, 5(5) ; Compute callee base
...
77 : LDA 4, 6(5) ; Compute callee base
78 : ST 1, 1(4) ; Store argument 0 in callee frame
79 : LD 1, 2(5) ; Load parameter 'low' into R1
80 : LDA 4, 6(5) ; Compute callee base
81 : ST 1, 2(4) ; Store argument 1 in callee frame
82 : LDA 4, 6(5) ; Compute callee base
83 : ST 1, 3(4) ; Store argument 2 in callee frame
84 : LDA 4, 6(5) ; Recompute callee base from callee size
85 : LDA 6, 89(0) ; Return address
86 : ST 6, 0(4) ; Store return address into callee frame
87 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
...
101 : LDA 4, 5(5) ; Compute callee base
...
109 : LDC 2, 5(0) ; Caller frame size
...
113 : LDA 4, 5(5) ; Compute callee base
...
117 : LDA 4, 5(5) ; Recompute callee base from callee size
...
131 : LDA 4, 5(5) ; Compute callee base
...
135 : ST 6, 0(4) ; Store return address into callee frame
136 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
137 : LDA 7, 442(0) ; Call TIMES
138 : LD 1, 3(5) ; Load callee result into R1
139 : LDC 2, 5(0) ; Caller frame size
...
146 : LDA 4, 5(5) ; Recompute callee base from callee size
147 : LDA 6, 151(0) ; Return address
148 : ST 6, 0(4) ; Store return address into callee frame
149 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
...
160 : LDA 4, 7(5) ; Compute callee base
161 : ST 1, 1(4) ; Store argument 0 in callee frame
162 : LD 1, 2(5) ; Load parameter 'low' into R1
163 : LDA 4, 7(5) ; Compute callee base
164 : ST 1, 2(4) ; Store argument 1 in callee frame
165 : LD 1, 3(5) ; Load parameter 'high' into R1
166 : LDA 4, 7(5) ; Compute callee base
167 : ST 1, 3(4) ; Store argument 2 in callee frame
168 : LDA 4, 5(5) ; Compute callee base
169 : ST 1, 1(4) ; Store argument 0 in callee frame
170 : LDA 4, 5(5) ; Compute callee base
171 : ST 1, 2(4) ; Store argument 1 in callee frame
172 : LDA 4, 5(5) ; Recompute callee base from callee size
173 : LDA 6, 177(0) ; Return address
174 : ST 6, 0(4) ; Store return address into callee frame
175 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
176 : LDA 7, 458(0) ; Call PLUS
177 : LD 1, 3(5) ; Load callee result into R1
178 : LDC 2, 5(0) ; Caller frame size
...
184 : LDA 4, 7(5) ; Compute callee base
185 : ST 1, 4(4) ; Store argument 3 in callee frame
186 : LDA 4, 7(5) ; Recompute callee base from callee size
...
192 : LDC 2, 7(0) ; Caller frame size
...
212 : LDC 2, 6(0) ; Caller frame size
...
218 : LDA 4, 5(5) ; Compute callee base
219 : ST 1, 1(4) ; Store argument 0 in callee frame
220 : LDA 4, 5(5) ; Compute callee base
221 : ST 1, 2(4) ; Store argument 1 in callee frame
222 : LDA 4, 5(5) ; Recompute callee base from callee size
...
244 : LDC 2, 5(0) ; Caller frame size
245 : SUB 5, 5, 2 ; Pop back to caller
246 : ST 1, 4(5) ; Spill left operand at depth 0
247 : LDA 4, 5(5) ; Compute callee base
248 : ST 1, 1(4) ; Store argument 0 in callee frame
249 : LDC 1, 2(0) ; Load integer-literal into R1
250 : LDA 4, 5(5) ; Compute callee base
251 : ST 1, 2(4) ; Store argument 1 in callee frame
252 : LDA 4, 5(5) ; Recompute callee base from callee size
...
262 : LDA 4, 4(5) ; Compute callee base
263 : ST 1, 2(4) ; Store argument 1 in callee frame
264 : LDA 4, 4(5) ; Recompute callee base from callee size
265 : LDA 6, 269(0) ; Return address
266 : ST 6, 0(4) ; Store return address into callee frame
267 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
...
274 : LDA 4, 3(5) ; Compute callee base
275 : ST 1, 1(4) ; Store argument 0 in callee frame
276 : LDA 4, 3(5) ; Recompute callee base from callee size
...
284 : LDA 4, 4(5) ; Compute callee base
285 : ST 1, 1(4) ; Store argument 0 in callee frame
286 : LD 1, 1(5) ; Load parameter 'n' into R1
287 : LDA 4, 3(5) ; Compute callee base
288 : ST 1, 1(4) ; Store argument 0 in callee frame
289 : LDA 4, 3(5) ; Recompute callee base from callee size
290 : LDA 6, 294(0) ; Return address
291 : ST 6, 0(4) ; Store return address into callee frame
292 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
...
322 : LDA 4, 5(5) ; Compute callee base
323 : ST 1, 1(4) ; Store argument 0 in callee frame
324 : LDC 1, 2(0) ; Load integer-literal into R1
325 : LDA 4, 5(5) ; Compute callee base
326 : ST 1, 2(4) ; Store argument 1 in callee frame
327 : LDA 4, 5(5) ; Recompute callee base from callee size
...
337 : LDA 4, 4(5) ; Compute callee base
338 : ST 1, 2(4) ; Store argument 1 in callee frame
339 : LDA 4, 4(5) ; Recompute callee base from callee size
340 : LDA 6, 344(0) ; Return address
341 : ST 6, 0(4) ; Store return address into callee frame
342 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
343 : LDA 7, 482(0) ; Call GT
344 : LD 1, 3(5) ; Load callee result into R1
345 : LDC 2, 4(0) ; Caller frame size
...
365 : LDA 4, 6(5) ; Compute callee base
366 : ST 1, 1(4) ; Store argument 0 in callee frame
...
372 : LDA 4, 6(5) ; Compute callee base
373 : ST 1, 2(4) ; Store argument 1 in callee frame
374 : LDA 4, 6(5) ; Recompute callee base from callee size
375 : LDA 6, 379(0) ; Return address
376 : ST 6, 0(4) ; Store return address into callee frame
377 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
378 : LDA 7, 350(0) ; Call EXP
379 : LD 1, 3(5) ; Load callee result into R1
380 : LDC 2, 6(0) ; Caller frame size
...
416 : LDA 4, 3(5) ; Compute callee base
417 : ST 1, 1(4) ; Store argument 0 in callee frame
418 : LDA 4, 3(5) ; Recompute callee base from callee size
419 : LDA 6, 423(0) ; Return address
420 : ST 6, 0(4) ; Store return address into callee frame
421 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
...
483 : LDA 4, 5(5) ; Compute callee base
484 : ST 1, 1(4) ; Store argument 0 in callee frame
485 : LD 1, 2(5) ; Load parameter 'q' into R1
486 : LDA 4, 5(5) ; Compute callee base
487 : ST 1, 2(4) ; Store argument 1 in callee frame
488 : LDA 4, 5(5) ; Recompute callee base from callee size
489 : LDA 6, 493(0) ; Return address
490 : ST 6, 0(4) ; Store return address into callee frame
491 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
492 : LDA 7, 520(0) ; Call LE
493 : LD 1, 3(5) ; Load callee result into R1
494 : LDC 2, 5(0) ; Caller frame size
...
502 : LDA 4, 5(5) ; Compute callee base
503 : ST 1, 1(4) ; Store argument 0 in callee frame
504 : LD 1, 2(5) ; Load parameter 'q' into R1
505 : LDA 4, 5(5) ; Compute callee base
506 : ST 1, 2(4) ; Store argument 1 in callee frame
...
524 : LDA 4, 5(5) ; Compute callee base
525 : ST 1, 2(4) ; Store argument 1 in callee frame
526 : LDA 4, 5(5) ; Recompute callee base from callee size
527 : LDA 6, 531(0) ; Return address
528 : ST 6, 0(4) ; Store return address into callee frame
529 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
530 : LDA 7, 585(0) ; Call LT
531 : LD 1, 3(5) ; Load callee result into R1
532 : LDC 2, 5(0) ; Caller frame size
533 : SUB 5, 5, 2 ; Pop back to caller
534 : ST 1, 4(5) ; Spill left operand at depth 0
535 : LD 1, 1(5) ; Load parameter 'p' into R1
536 : LDA 4, 5(5) ; Compute callee base
537 : ST 1, 1(4) ; Store argument 0 in callee frame
538 : LD 1, 2(5) ; Load parameter 'q' into R1
539 : LDA 4, 5(5) ; Compute callee base
540 : ST 1, 2(4) ; Store argument 1 in callee frame
541 : LDA 4, 5(5) ; Recompute callee base from callee size
542 : LDA 6, 546(0) ; Return address
543 : ST 6, 0(4) ; Store return address into callee frame
544 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
545 : LDA 7, 573(0) ; Call EQ
546 : LD 1, 3(5) ; Load callee result into R1
547 : LDC 2, 5(0) ; Caller frame size
548 : SUB 5, 5, 2 ; Pop back to caller
...
555 : LDA 4, 5(5) ; Compute callee base
556 : ST 1, 1(4) ; Store argument 0 in callee frame
557 : LD 1, 2(5) ; Load parameter 'q' into R1
558 : LDA 4, 5(5) ; Compute callee base
559 : ST 1, 2(4) ; Store argument 1 in callee frame
560 : LDA 4, 5(5) ; Recompute callee base from callee size
561 : LDA 6, 565(0) ; Return address
562 : ST 6, 0(4) ; Store return address into callee frame
563 : ADD 5, 4, 0 ; Push callee frame (R5 := callee base)
564 : LDA 7, 573(0) ; Call EQ
565 : LD 1, 3(5) ; Load callee result into R1
566 : LDC 2, 5(0) ; Caller frame size
