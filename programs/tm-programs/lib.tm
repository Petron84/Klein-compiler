...
136 : LD   2, 5(5) ;  Restore Temporary
...
141 : ADD  3, 1, 0 ;  Save right operand
142 : LD   1, 3(5) ;  Load parameter 'high' into R1
143 : LDA  4, 4(5) ; Restore Callee frame base
...
147 : ST 1, 2(4) ;  Store argument 1 into callee frame
148 : LDA  4, 4(5) ; Restore Call frame base
149 : LDA 6, 153(0) ;  Compute return address
150 : ST 6, 0(4) ;  Store return address in callee frame
151 : ADD  5, 4, 0 ;  Update pointer
152 : LDA 7, 462(0) ;  Call TIMES
153 : LD 1, 3(5) ;  Load callee return value into R1
154 : LDC  4, 4(0) ;  Load frame size
155 : SUB  5, 5, 4 ;  Restore pointer
156 : ADD  2, 3, 0 ;  Restore right operand
...
183 : ADD  3, 1, 0 ;  Save right operand
...
188 : LDA  4, 4(5) ; Restore Callee frame base
189 : ST 1, 2(4) ;  Store argument 1 into callee frame
...
280 : LD   2, 3(5) ;  Restore Temporary
...
355 : LD   2, 3(5) ;  Restore Temporary
...
371 : ADD  3, 1, 0 ;  Save left operand
...
402 : LD   2, 4(5) ;  Restore Temporary
...
408 : ADD  3, 1, 0 ;  Save left operand
...
414 : ADD  3, 1, 0 ;  Save left operand
...
424 : ADD  3, 1, 0 ;  Save left operand
...
455 : ADD  3, 1, 0 ;  Save left operand
...
463 : ADD  3, 1, 0 ;  Save left operand
...
495 : ADD  3, 1, 0 ;  Save left operand
...
569 : LD   2, 4(5) ;  Restore Temporary
...
606 : ADD  3, 1, 0 ;  Save left operand
...
619 : ADD  3, 1, 0 ;  Save left operand
