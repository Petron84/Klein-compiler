...
31 : LDA 6, 2(7) ;  Compute return address
...
50 : LDA 6, 2(7) ;  Compute return address
...
65 : LDA 6, 2(7) ;  Compute return address
...
80 : LDA 6, 2(7) ;  Compute return address
...
128 : LDA 6, 2(7) ;  Compute return address
...
163 : LDA 6, 2(7) ;  Compute return address
...
174 : LDA 6, 2(7) ;  Compute return address
...
206 : LDA 6, 2(7) ;  Compute return address
...
235 : LDA 6, 2(7) ;  Compute return address
...
278 : LDA 6, 2(7) ;  Compute return address
...
309 : LDA 6, 2(7) ;  Compute return address
...
340 : LDA 6, 2(7) ;  Compute return address
...
441 : LDA 6, 2(7) ;  Compute return address
...
458 : LDA 6, 2(7) ;  Compute return address
...
488 : LDA 6, 2(7) ;  Compute return address
...
504 : LDA 6, 2(7) ;  Compute return address
