...
15 : LDA 4, 3(5) ; Compute future callee base using caller_size
16 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
17 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
23 : LDC 2, 5(0) ; Callee frame size
...
46 : LDA 4, 5(5) ; Compute future callee base using caller_size
47 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
48 : LD 1, 2(5) ; Load parameter 'den' into R1
49 : LDA 4, 5(5) ; Compute future callee base using caller_size
50 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
51 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
63 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
97 : LDA 4, 6(5) ; Compute future callee base using caller_size
...
113 : LDA 4, 6(5) ; Compute future callee base using caller_size
114 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
115 : LD 1, 2(5) ; Load parameter 'n' into R1
116 : LDA 4, 6(5) ; Compute future callee base using caller_size
117 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
118 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
124 : LDC 2, 6(0) ; Callee frame size
...
134 : LDA 4, 3(5) ; Compute future callee base using caller_size
135 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
136 : LD 1, 2(5) ; Load parameter 'n' into R1
137 : LDA 4, 3(5) ; Compute future callee base using caller_size
...
152 : LDA 4, 5(5) ; Compute future callee base using caller_size
153 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
154 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
160 : LDC 2, 3(0) ; Callee frame size
...
166 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
181 : LDA 4, 5(5) ; Compute future callee base using caller_size
182 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
183 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
207 : LDA 4, 5(5) ; Compute future callee base using caller_size
208 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
209 : LD 1, 2(5) ; Load parameter 'max' into R1
210 : LDA 4, 5(5) ; Compute future callee base using caller_size
211 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
212 : LDA 4, 5(5) ; Compute future callee base (caller_size)
