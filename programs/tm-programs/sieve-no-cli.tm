...
12 : ST   1, 1(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='2',line=4)
13 : LDC  1, 40(0) ;  Load boolean-literal value into register 1
14 : ST   1, 2(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='40',line=4)
15 : LDC  5, 5(0) ;  Set DMEM pointer to callee frame 'sieveAt'
...
40 : ST   1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='-', children=[Tree Node('IDENTIFIER', value='num',line=34), Tree Node('IDENTIFIER', value='den',line=34)],line=34)
41 : LD   1, 2(5) ;  Load parameter 'den' into R1
42 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='den',line=34)
43 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'rem'
...
53 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='b',line=28)
54 : LD   1, 1(5) ;  Load parameter 'a' into R1
55 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='a',line=28)
56 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'rem'
...
82 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='i',line=23)
83 : LD   1, 2(5) ;  Load parameter 'n' into R1
84 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='n',line=23)
85 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'divides'
...
96 : ST   1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='+', children=[Tree Node('IDENTIFIER', value='i',line=23), Tree Node('INTEGER-LITERAL', value='1',line=23)],line=23)
97 : LD   1, 2(5) ;  Load parameter 'n' into R1
98 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='n',line=23)
99 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'hasDivisorFrom'
...
111 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
112 : ST   1, 1(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='2',line=19)
113 : LD   1, 1(5) ;  Load parameter 'n' into R1
114 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='n',line=19)
115 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'hasDivisorFrom'
116 : LDA  6, 2(7) ;  Compute return address
117 : ST   6, 0(5) ;  Store return address in frame
118 : LDA  7, 72(0) ;  Call hasDivisorFrom
119 : LD   1, 3(5) ;  Load return value into R1
120 : LDC  5, 2(0) ;  Restore DMEM pointer to caller frame
...
126 : LD   1, 1(5) ;  Load parameter 'current' into R1
127 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='current',line=15)
128 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'isPrime'
129 : LDA  6, 2(7) ;  Compute return address
130 : ST   6, 0(5) ;  Store return address in frame
131 : LDA  7, 111(0) ;  Call isPrime
132 : LD   1, 2(5) ;  Load return value into R1
133 : LDC  5, 2(0) ;  Restore DMEM pointer to caller frame
...
148 : ST   1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='+', children=[Tree Node('IDENTIFIER', value='current',line=16), Tree Node('INTEGER-LITERAL', value='1',line=16)],line=16)
149 : LD   1, 2(5) ;  Load parameter 'max' into R1
150 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='max',line=16)
151 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'sieveAt'
152 : LDA  6, 2(7) ;  Compute return address
153 : ST   6, 0(5) ;  Store return address in frame
154 : LDA  7, 160(0) ;  Call sieveAt
155 : LD   1, 3(5) ;  Load return value into R1
...
172 : ST   1, 1(5) ;  Store argument Tree Node('IDENTIFIER', value='current',line=10)
173 : LD   1, 2(5) ;  Load parameter 'max' into R1
174 : ST   1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='max',line=10)
175 : LDC  5, 2(0) ;  Set DMEM pointer to callee frame 'doSieveAt'
176 : LDA  6, 2(7) ;  Compute return address
177 : ST   6, 0(5) ;  Store return address in frame
178 : LDA  7, 126(0) ;  Call doSieveAt
179 : LD   1, 3(5) ;  Load return value into R1
180 : LDC  5, 2(0) ;  Restore DMEM pointer to caller frame
