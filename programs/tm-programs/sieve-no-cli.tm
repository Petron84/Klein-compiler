...
10 : ST   1, 0(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='2',line=4)
11 : LDC  1, 40(0) ;  Load boolean-literal value into register 1
12 : ST   1, 1(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='40',line=4)
13 : LDC  5, 4(0) ;  Set DMEM pointer to callee frame 'sieveAt'
14 : LDA  6, 2(7) ;  Compute return address
15 : ST   6, 0(5) ;  Store return address in frame
16 : LDA  7, -1(0) ;  Call sieveAt
17 : LD   1, 3(5) ;  Load return value into R1
18 : LDC  5, 1(0) ;  Restore DMEM pointer to caller frame
19 : ST   1, 3(0) ;  Store function-call result into caller's return slot
20 : LD   1, 3(0) ;  Load return value into register 1
