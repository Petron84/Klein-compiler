...
16 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
25 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
26 : ST 1, 2(5) ; Store result into caller's frame return slot
...
34 : SUB 1, 2, 1 ; Compute left - right for less-than
35 : JLT 1, 2(7) ; If < 0, jump to true
36 : LDC 1, 0(0) ; false
37 : LDA 7, 1(7) ; skip true assignment
38 : LDC 1, 1(0) ; true
39 : JEQ 1, 42(0) ; If condition false jump to ELSE
...
50 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
51 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
52 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
59 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
65 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
66 : LD 1, 1(5) ; Load parameter 'a' into R1
67 : LDA 4, 5(5) ; Compute future callee base (caller_size)
68 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
69 : LDA 4, 5(5) ; Compute future callee base (caller_size)
70 : LDA 6, 74(0) ; Return address
71 : ST 6, 0(4) ; Store return address in callee frame
...
80 : SUB 1, 2, 1 ; Compute left - right for equality
81 : JEQ 1, 2(7) ; If zero, jump to true
82 : LDC 1, 0(0) ; false
83 : LDA 7, 1(7) ; skip true assignment
84 : LDC 1, 1(0) ; true
...
92 : SUB 1, 2, 1 ; Compute left - right for less-than
93 : JLT 1, 2(7) ; If < 0, jump to true
94 : LDC 1, 0(0) ; false
95 : LDA 7, 1(7) ; skip true assignment
96 : LDC 1, 1(0) ; true
97 : JEQ 1, 134(0) ; If condition false jump to ELSE
98 : LD 1, 1(5) ; Load parameter 'i' into R1
99 : LDA 4, 6(5) ; Compute future callee base (caller_size)
100 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
101 : LD 1, 2(5) ; Load parameter 'n' into R1
102 : LDA 4, 6(5) ; Compute future callee base (caller_size)
103 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
104 : LDA 4, 6(5) ; Compute future callee base (caller_size)
...
111 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
119 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
120 : LD 1, 2(5) ; Load parameter 'n' into R1
121 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
122 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
123 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
130 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
142 : LDA 4, 3(5) ; Compute future callee base (caller_size)
143 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
144 : LDA 4, 3(5) ; Compute future callee base (caller_size)
145 : LDA 6, 149(0) ; Return address
146 : ST 6, 0(4) ; Store return address in callee frame
...
151 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
158 : LDA 4, 5(5) ; Compute future callee base (caller_size)
159 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
160 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
167 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
168 : JEQ 1, 171(0) ; If condition false jump to ELSE
169 : LD 1, 1(5) ; Load parameter 'current' into R1
170 : LDA 7, 172(0) ; Skip ELSE block
171 : LDC 1, 0(0) ; Load integer literal into R1
172 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
187 : LDA 4, 5(5) ; Compute future callee base (caller_size)
188 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
189 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
208 : LDC 1, 1(0) ; true
209 : JEQ 1, 212(0) ; If condition false jump to ELSE
...
214 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
215 : LD 1, 2(5) ; Load parameter 'max' into R1
216 : LDA 4, 5(5) ; Compute future callee base (caller_size)
217 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
218 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
225 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
