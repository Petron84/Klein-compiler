...
62 : LDC  4_original, 3(0) ;  Load frame size
63 : SUB  5, 5, 4_original ;  Restore pointer
...
68 : LDC  3, 1(0) ;  Store left operand into temporary register
...
91 : LDC  4_original, 3(0) ;  Load frame size
92 : SUB  5, 5, 4_original ;  Restore pointer
...
101 : LDC  4_original, 4(0) ;  Load frame size
102 : SUB  5, 5, 4_original ;  Restore pointer
103 : LDC  2, 3(0) ;  Restore left operand
...
119 : LDC  3, 1(0) ;  Store left operand into temporary register
120 : LD   1, 1(5) ;  Load parameter 'a' into R1
121 : LDC  2, 3(0) ;  Restore left operand
122 : MUL  1, 2, 1 ;  R1 = left * right
123 : LDC  2, 3(0) ;  Restore left operand
...
143 : LDC  4_original, 3(0) ;  Load frame size
...
147 : LDC  2, 3(0) ;  Restore left operand
...
157 : LDC  4_original, 4(0) ;  Load frame size
158 : SUB  5, 5, 4_original ;  Restore pointer
...
167 : LDC  4_original, 4(0) ;  Load frame size
168 : SUB  5, 5, 4_original ;  Restore pointer
...
173 : LDC  3, 1(0) ;  Store left operand into temporary register
...
186 : LDC  4_original, 3(0) ;  Load frame size
...
200 : LDC  4_original, 4(0) ;  Load frame size
201 : SUB  5, 5, 4_original ;  Restore pointer
...
220 : LDC  3, 1(0) ;  Store left operand into temporary register
221 : LD   1, 1(5) ;  Load parameter 'n' into R1
222 : LDC  3, 1(0) ;  Store left operand into temporary register
223 : LDC  1, 10(0) ;  Load boolean-literal value into register 1
224 : LDC  2, 3(0) ;  Restore left operand
...
234 : LDC  4_original, 3(0) ;  Load frame size
235 : SUB  5, 5, 4_original ;  Restore pointer
...
242 : LDC  3, 1(0) ;  Store left operand into temporary register
243 : LD   1, 1(5) ;  Load parameter 'n' into R1
244 : LDC  2, 3(0) ;  Restore left operand
...
252 : LDC  3, 1(0) ;  Store left operand into temporary register
253 : LD   1, 1(5) ;  Load parameter 'n' into R1
254 : LDC  3, 1(0) ;  Store left operand into temporary register
255 : LDC  1, 2(0) ;  Load boolean-literal value into register 1
256 : LDC  2, 3(0) ;  Restore left operand
257 : DIV  1, 2, 1 ;  R1 = left / right
258 : LDC  2, 3(0) ;  Restore left operand
259 : MUL  1, 2, 1 ;  R1 = left * right
260 : LDC  3, 1(0) ;  Store left operand into temporary register
261 : LD   1, 1(5) ;  Load parameter 'n' into R1
262 : LDC  2, 3(0) ;  Restore left operand
...
279 : LDC  4_original, 3(0) ;  Load frame size
280 : SUB  5, 5, 4_original ;  Restore pointer
...
287 : LDC  2, 3(0) ;  Restore left operand
...
297 : LDC  3, 1(0) ;  Store left operand into temporary register
...
302 : LDC  3, 1(0) ;  Store left operand into temporary register
303 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
304 : LDC  2, 3(0) ;  Restore left operand
...
314 : LDC  4_original, 4(0) ;  Load frame size
315 : SUB  5, 5, 4_original ;  Restore pointer
...
324 : LDC  3, 1(0) ;  Store left operand into temporary register
...
332 : LDC  2, 3(0) ;  Restore left operand
