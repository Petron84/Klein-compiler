...
28 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
41 : LDA 4, 3(5) ; Compute future callee base (caller_size)
...
55 : LDA 4, 5(5) ; Compute future callee base (caller_size)
56 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
57 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
64 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
65 : JEQ 1, 68(0) ; If condition false jump to ELSE
...
71 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
81 : LDA 4, 5(5) ; Compute future callee base (caller_size)
82 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
83 : LD 1, 1(5) ; Load parameter 'n' into R1
84 : LDA 4, 5(5) ; Compute future callee base (caller_size)
85 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
86 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
92 : LDC 2, 4(0) ; Callee frame size
93 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
94 : LDA 4, 5(5) ; Compute future callee base (caller_size)
95 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
96 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
102 : LDC 2, 6(0) ; Callee frame size
103 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
104 : LD 2, 4(5) ; Restore left operand from depth 0
105 : SUB 1, 2, 1 ; Compute left - right for equality
106 : JEQ 1, 2(7) ; If zero, jump to true
107 : LDC 1, 0(0) ; false
108 : LDA 7, 1(7) ; skip true assignment
109 : LDC 1, 1(0) ; true
...
150 : LDA 4, 4(5) ; Compute future callee base (caller_size)
151 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
152 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
159 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
160 : LDA 4, 4(5) ; Compute future callee base (caller_size)
161 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
162 : LDA 4, 4(5) ; Compute future callee base (caller_size)
163 : LDA 6, 167(0) ; Return address
164 : ST 6, 0(4) ; Store return address in callee frame
165 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
166 : LDA 7, 322(0) ; Call MOD
167 : LD 1, 3(5) ; Load callee result into R1
168 : LDC 2, 7(0) ; Callee frame size
169 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
176 : LDA 4, 5(5) ; Compute future callee base (caller_size)
...
193 : LDA 4, 5(5) ; Compute future callee base (caller_size)
194 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
195 : LDA 4, 5(5) ; Compute future callee base (caller_size)
196 : LDA 6, 200(0) ; Return address
197 : ST 6, 0(4) ; Store return address in callee frame
198 : ADD 5, 4, 0 ; Push callee frame (FP := callee base)
199 : LDA 7, 285(0) ; Call EXP
200 : LD 1, 3(5) ; Load callee result into R1
201 : LDC 2, 6(0) ; Callee frame size
202 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
212 : SUB 1, 2, 1 ; Compute left - right for less-than
213 : JLT 1, 2(7) ; If < 0, jump to true
214 : LDC 1, 0(0) ; false
215 : LDA 7, 1(7) ; skip true assignment
216 : LDC 1, 1(0) ; true
217 : JEQ 1, 220(0) ; If condition false jump to ELSE
...
227 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
228 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
229 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
236 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
246 : SUB 1, 2, 1 ; Compute left - right for less-than
247 : JLT 1, 2(7) ; If < 0, jump to true
248 : LDC 1, 0(0) ; false
249 : LDA 7, 1(7) ; skip true assignment
250 : LDC 1, 1(0) ; true
251 : JEQ 1, 270(0) ; If condition false jump to ELSE
...
264 : SUB 1, 2, 1 ; Compute left - right for less-than
265 : JLT 1, 2(7) ; If < 0, jump to true
266 : LDC 1, 0(0) ; false
267 : LDA 7, 1(7) ; skip true assignment
268 : LDC 1, 1(0) ; true
269 : LDA 7, 282(0) ; Skip ELSE block
270 : LD 1, 1(5) ; Load parameter 'n' into R1
271 : SUB 1, 0, 1 ; Negate R1
272 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
273 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
274 : LDA 4, 5(5) ; Compute future callee base (callee_size) for recursive call
...
281 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
...
289 : SUB 1, 2, 1 ; Compute left - right for equality
290 : JEQ 1, 2(7) ; If zero, jump to true
291 : LDC 1, 0(0) ; false
292 : LDA 7, 1(7) ; skip true assignment
293 : LDC 1, 1(0) ; true
294 : JEQ 1, 297(0) ; If condition false jump to ELSE
...
300 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
301 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
...
307 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
308 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
309 : LDA 4, 6(5) ; Compute future callee base (callee_size) for recursive call
...
316 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
