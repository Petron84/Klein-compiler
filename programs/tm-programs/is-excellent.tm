...
28 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
41 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
42 : ST 1, 2(4) ; Store argument 1 in callee param slot
43 : LDA 4, 3(5) ; Compute callee base = FP + caller_size
...
55 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
56 : ST 1, 1(4) ; Store argument 0 in callee param slot
57 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
81 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
82 : ST 1, 1(4) ; Store argument 0 in callee param slot
83 : LD 1, 1(5) ; Load parameter 'n' into R1
84 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
85 : ST 1, 1(4) ; Store argument 0 in callee param slot
86 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
94 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
95 : ST 1, 2(4) ; Store argument 1 in callee param slot
96 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
130 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
131 : ST 1, 1(4) ; Store argument 0 in callee param slot
132 : LDC 1, 10(0) ; Load integer-literal into R1
133 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
138 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
150 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
151 : ST 1, 2(4) ; Store argument 1 in callee param slot
152 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
160 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
161 : ST 1, 2(4) ; Store argument 1 in callee param slot
162 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
...
168 : LDC 2, 4(0) ; Caller frame size
...
180 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
193 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
194 : ST 1, 2(4) ; Store argument 1 in callee param slot
195 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
201 : LDC 2, 5(0) ; Caller frame size
...
227 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
228 : ST 1, 1(4) ; Store argument 0 in callee param slot
229 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
235 : LDC 2, 5(0) ; Caller frame size
...
272 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
273 : ST 1, 1(4) ; Store argument 0 in callee param slot
274 : LDA 4, 5(5) ; Compute callee base = FP + caller_size
...
280 : LDC 2, 5(0) ; Caller frame size
...
300 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
301 : ST 1, 1(4) ; Store argument 0 in callee param slot
...
307 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
308 : ST 1, 2(4) ; Store argument 1 in callee param slot
309 : LDA 4, 6(5) ; Compute callee base = FP + caller_size
...
315 : LDC 2, 6(0) ; Caller frame size
