...
27 : LDA  4, 3(5) ; Restore Callee frame base
28 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
54 : LDA  4, 4(5) ; Restore Callee frame base
55 : ST 1, 1(5) ;  Store argument 0 into callee frame
56 : LDA  4, 4(5) ; Restore Call frame base
...
71 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
81 : ST 1, 1(5) ;  Store argument 0 into callee frame
82 : LD   1, 1(5) ;  Load parameter 'n' into R1
83 : LDA  4, 4(5) ; Restore Callee frame base
84 : ST 1, 1(5) ;  Store argument 0 into callee frame
85 : LDA  4, 4(5) ; Restore Call frame base
...
94 : ST 1, 2(5) ;  Store argument 1 into callee frame
...
129 : LDA  4, 3(5) ; Restore Callee frame base
130 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
149 : LDA  4, 3(5) ; Restore Callee frame base
150 : ST 1, 2(5) ;  Store argument 1 into callee frame
151 : LDA  4, 3(5) ; Restore Call frame base
...
159 : LDA  4, 3(5) ; Restore Callee frame base
160 : ST 1, 2(5) ;  Store argument 1 into callee frame
161 : LDA  4, 3(5) ; Restore Call frame base
...
175 : LDA  4, 3(5) ; Restore Callee frame base
176 : ST 1, 1(5) ;  Store argument 0 into callee frame
177 : LD   1, 1(5) ;  Load parameter 'n' into R1
178 : LDA  4, 3(5) ; Restore Callee frame base
179 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
192 : LDA  4, 3(5) ; Restore Callee frame base
193 : ST 1, 2(5) ;  Store argument 1 into callee frame
194 : LDA  4, 3(5) ; Restore Call frame base
...
227 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
272 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
300 : ST 1, 1(5) ;  Store argument 0 into callee frame
...
307 : ST 1, 2(5) ;  Store argument 1 into callee frame
