...
55 : LDA 4, 6(5) ; Recompute callee base from callee size
...
94 : LDA 4, 7(5) ; Recompute callee base from callee size
...
130 : LDA 4, 8(5) ; Recompute callee base from callee size
...
150 : LDA 4, 7(5) ; Recompute callee base from callee size
...
160 : LDA 4, 8(5) ; Recompute callee base from callee size
...
193 : LDA 4, 7(5) ; Recompute callee base from callee size
...
227 : LDA 4, 6(5) ; Recompute callee base from callee size
...
272 : LDA 4, 6(5) ; Recompute callee base from callee size
...
300 : LDA 4, 7(5) ; Recompute callee base from callee size
...
307 : LDA 4, 7(5) ; Recompute callee base from callee size
