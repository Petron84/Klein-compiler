...
29 : LDA 4, 4(4) ; Recompute callee base from callee size
30 : ST 1, 2(4) ; Store argument 1 in callee
31 : LDC 1, 0(0) ; Load integer-literal into R1
32 : LDA 4, 4(4) ; Recompute callee base from callee size
...
79 : LDA 4, 7(4) ; Recompute callee base from callee size
