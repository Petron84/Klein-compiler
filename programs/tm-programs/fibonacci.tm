...
46 : LDC 5, 2(0) ; Anchor R5 to main frame base (DMEM[N+1])
47 : ST 1, 2(5) ; Store final result into MAIN frame's return slot
...
52 : LD 1, 2(5) ; Load parameter 'elementWanted' into R1
53 : ST 1, 6(5) ; Spill left operand at depth 0
54 : LD 1, 1(5) ; Load parameter 'currentElement' into R1
55 : LD 2, 6(5) ; Restore left operand from depth 0
56 : SUB 1, 2, 1 ; left - right for equality check
57 : JEQ 1, 2(7) ; If R1 == 0, jump to true
58 : LDC 1, 0(0) ; false
59 : LDA 7, 1(7) ; skip setting true
60 : LDC 1, 1(0) ; true
61 : JEQ 1, 64(0) ; If condition is false, jump to ELSE
62 : LD 1, 4(5) ; Load parameter 'currentSum' into R1
63 : LDA 7, 92(0) ; Skip ELSE block
64 : LD 1, 1(5) ; Load parameter 'currentElement' into R1
65 : ST 1, 6(5) ; Spill left operand at depth 0
66 : LDC 1, 1(0) ; Load integer-literal into R1
67 : LD 2, 6(5) ; Restore left operand from depth 0
...
73 : ST 1, 2(4) ; Store argument 1 in callee frame
74 : LD 1, 4(5) ; Load parameter 'currentSum' into R1
75 : LDA 4, 7(5) ; Recompute callee base from caller size
76 : ST 1, 3(4) ; Store argument 2 in callee frame
77 : LD 1, 3(5) ; Load parameter 'previousSum' into R1
78 : ST 1, 6(5) ; Spill left operand at depth 0
79 : LD 1, 4(5) ; Load parameter 'currentSum' into R1
...
83 : ST 1, 4(4) ; Store argument 3 in callee frame
...
88 : LDA 7, 52(0) ; Call addNext
89 : LD 1, 5(5) ; Load callee result into R1
90 : LDC 2, 7(0) ; Callee frame size
