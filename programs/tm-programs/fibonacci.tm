...
28 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
29 : ST 1, 2(4) ; Store argument 1 into callee frame
30 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
31 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
36 : LDA 4, 3(5) ; Callee frame base = caller base + caller size
...
42 : LDC 2, 3(0) ; Load caller frame size
43 : SUB 5, 5, 2 ; Restore pointer (pop callee)
...
78 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
79 : ST 1, 4(4) ; Store argument 3 into callee frame
80 : LDA 4, 6(5) ; Callee frame base = caller base + caller size
...
86 : LDC 2, 6(0) ; Load caller frame size
87 : SUB 5, 5, 2 ; Restore pointer (pop callee)
