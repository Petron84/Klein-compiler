...
23 : LDA 5, 3(5) ;  Advance DMEM pointer to callee frame 'addNext'
24 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
25 : ST 1, 1(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='1',line=7) into callee frame
26 : LD   1, 1(5) ;  Load parameter 'elementWanted' into R1
27 : ST 1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='elementWanted',line=7) into callee frame
28 : LDC  1, 0(0) ;  Load boolean-literal value into register 1
29 : ST 1, 3(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='0',line=7) into callee frame
30 : LDC  1, 1(0) ;  Load boolean-literal value into register 1
31 : ST 1, 4(5) ;  Store argument Tree Node('INTEGER-LITERAL', value='1',line=7) into callee frame
32 : LDA 6, 2(7) ;  Compute return address
33 : ST 6, 0(5) ;  Store return address in callee frame
34 : LDA 7, 41(0) ;  Call addNext
35 : LD 1, 5(5) ;  Load callee return value into R1
36 : LDA 5, -3(5) ;  Restore DMEM pointer to caller frame
...
52 : LDA 5, 6(5) ;  Advance DMEM pointer to callee frame 'addNext'
53 : LD   1, 1(5) ;  Load parameter 'currentElement' into R1
...
57 : ST 1, 1(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='+', children=[Tree Node('IDENTIFIER', value='currentElement',line=16), Tree Node('INTEGER-LITERAL', value='1',line=16)],line=16) into callee frame
58 : LD   1, 2(5) ;  Load parameter 'elementWanted' into R1
59 : ST 1, 2(5) ;  Store argument Tree Node('IDENTIFIER', value='elementWanted',line=16) into callee frame
60 : LD   1, 4(5) ;  Load parameter 'currentSum' into R1
61 : ST 1, 3(5) ;  Store argument Tree Node('IDENTIFIER', value='currentSum',line=17) into callee frame
62 : LD   1, 3(5) ;  Load parameter 'previousSum' into R1
63 : ADD  2, 1, 0 ;  Move left operand from R1 to R2
64 : LD   1, 4(5) ;  Load parameter 'currentSum' into R1
65 : ADD  1, 2, 1 ;  R1 = left + right
66 : ST 1, 4(5) ;  Store argument Tree Node('BINARY-EXPRESSION', value='+', children=[Tree Node('IDENTIFIER', value='previousSum',line=18), Tree Node('IDENTIFIER', value='currentSum',line=19)],line=19) into callee frame
67 : LDA 6, 2(7) ;  Compute return address
68 : ST 6, 0(5) ;  Store return address in callee frame
69 : LDA 7, 41(0) ;  Call addNext
70 : LD 1, 5(5) ;  Load callee return value into R1
71 : LDA 5, -6(5) ;  Restore DMEM pointer to caller frame
