...
20 : LDC 1, 1(0) ; true
21 : JEQ 1, 25(0) ; If condition false jump to ELSE
22 : LDC 1, 0(0) ; Load integer literal into R1
23 : ST 1, 2(5) ; Store literal result into current frame return slot
...
27 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
28 : LD 1, 1(5) ; Load parameter 'elementWanted' into R1
29 : LDA 4, 4(5) ; Compute future callee base (caller_size)
30 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
31 : LDC 1, 0(0) ; Load integer literal into R1
32 : LDA 4, 4(5) ; Compute future callee base (caller_size)
33 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
34 : LDC 1, 1(0) ; Load integer literal into R1
35 : LDA 4, 4(5) ; Compute future callee base (caller_size)
36 : ST 1, 4(4) ; Store argument 3 into callee's param slot (future frame)
37 : LDA 4, 4(5) ; Compute future callee base (caller_size)
...
44 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
45 : ST 1, 2(5) ; Store result into caller's frame return slot
...
53 : SUB 1, 2, 1 ; Compute left - right for equality
54 : JEQ 1, 2(7) ; If zero, jump to true
55 : LDC 1, 0(0) ; false
56 : LDA 7, 1(7) ; skip true assignment
57 : LDC 1, 1(0) ; true
58 : JEQ 1, 61(0) ; If condition false jump to ELSE
...
66 : LDA 4, 7(5) ; Compute future callee base (callee_size) for recursive call
67 : ST 1, 1(4) ; Store argument 0 into callee's param slot (future frame)
68 : LD 1, 2(5) ; Load parameter 'elementWanted' into R1
69 : LDA 4, 7(5) ; Compute future callee base (callee_size) for recursive call
70 : ST 1, 2(4) ; Store argument 1 into callee's param slot (future frame)
71 : LD 1, 4(5) ; Load parameter 'currentSum' into R1
72 : LDA 4, 7(5) ; Compute future callee base (callee_size) for recursive call
73 : ST 1, 3(4) ; Store argument 2 into callee's param slot (future frame)
...
79 : LDA 4, 7(5) ; Compute future callee base (callee_size) for recursive call
80 : ST 1, 4(4) ; Store argument 3 into callee's param slot (future frame)
81 : LDA 4, 7(5) ; Compute future callee base (callee_size) for recursive call
...
88 : SUB 5, 5, 2 ; Pop callee frame (back to caller)
