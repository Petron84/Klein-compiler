...
17 : LDA  4, 8(5) ; Restore Callee frame base
18 : ST 1, 2(4) ;  Store argument 1 into callee frame
19 : LDA  4, 12(5) ; Restore Call frame base
...
50 : LDA  4, 7(5) ; Restore Call frame base
...
63 : LDA  4, 7(5) ; Restore Call frame base
...
69 : LDC  4, 7(0) ;  Load frame size
70 : SUB  5, 5, 4 ;  Restore pointer
71 : LDA  4, 8(5) ; Restore Callee frame base
72 : ST 1, 2(4) ;  Store argument 1 into callee frame
73 : LDA  4, 12(5) ; Restore Call frame base
