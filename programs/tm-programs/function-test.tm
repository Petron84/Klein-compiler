...
15 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
16 : ST 1, 1(4) ;  Store argument 0 into callee frame
17 : LD 1, 2(5) ;  Load parameter 'b' into R1
18 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
...
48 : LDA 4, 4(5) ;  Base of callee frame (target)
49 : LD 1, 1(5) ;  Load parameter 'a' into R1
50 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
...
54 : ADD 5, 4, 0 ;  Switch frame pointer to callee
55 : LDA 7, 31(0) ;  Call square
56 : LD 1, 2(5) ;  Load callee return value into R1
57 : LDC 2, 4(0) ;  Load caller frame size
58 : SUB 5, 5, 2 ;  Restore frame pointer to caller base
59 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
60 : ST 1, 1(4) ;  Store argument 0 into callee frame
61 : LDA 4, 4(5) ;  Base of callee frame (target)
62 : LD 1, 2(5) ;  Load parameter 'b' into R1
63 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
...
67 : ADD 5, 4, 0 ;  Switch frame pointer to callee
68 : LDA 7, 31(0) ;  Call square
69 : LD 1, 2(5) ;  Load callee return value into R1
70 : LDC 2, 4(0) ;  Load caller frame size
71 : SUB 5, 5, 2 ;  Restore frame pointer to caller base
72 : LDA 4, 4(5) ;  Base of callee frame (recomputed)
73 : ST 1, 2(4) ;  Store argument 1 into callee frame
74 : LDA 6, 78(0) ;  Compute return address
75 : ST 6, 0(4) ;  Store return address in callee frame
76 : ADD 5, 4, 0 ;  Switch frame pointer to callee
77 : LDA 7, 39(0) ;  Call multiply
78 : LD 1, 3(5) ;  Load callee return value into R1
79 : LDC 2, 4(0) ;  Load caller frame size
80 : SUB 5, 5, 2 ;  Restore frame pointer to caller base
