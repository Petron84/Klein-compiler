...
19 : ST 1, 1(4) ; Store argument 0 in callee param slot
20 : LD 1, 1(5) ; Load parameter 'x' into R1
21 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
22 : ST 1, 2(4) ; Store argument 1 in callee param slot
...
30 : SUB 5, 5, 2 ; Pop callee frame back to caller
31 : LDA 4, 4(5) ; Compute callee base = FP + caller_size
